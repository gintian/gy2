...
{	
	...
	{
	   if((this.uid=="root"&&Global.showroot==true)||(this.uid!="root"))
	   {
	       var content="<input type='checkbox' name='";
		   if(Global.checkvalue.indexOf(this.uid+",")!=-1)           
	              content=content+"treeItem-check"+"' checked>";
	       else
	              content=content+"treeItem-check"+"'>";           	 		
		   var chkbox=document.createElement(content);
    ...
    {
           if(((this.uid=="UN"||this.uid=="root")&&Global.showroot==true)||(this.uid!="root"&&this.uid!="UN"))
           {
	            var content="<input type='radio' name='";
	      	   	if(Global.checkvalue==this.uid)
	      	  	{	  
	      	  	
	                    content=content+"treeItem-radio"+"' value='"+this.uid+"' title='"+this.title+"' checked>";
	            }
	            else
	            {
	                    content=content+"treeItem-radio"+"' value='"+this.uid+"' title='"+this.title+"'>";           	
	            }
