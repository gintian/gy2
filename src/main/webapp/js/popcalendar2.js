...
//	email :	fuushikaden@yahoo.com
    ...
    */
	...
	if (dom&&!document.getElementById("calendar"))
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' name=close WIDTH='15' HEIGHT='13' BORDER='0' ALT='" + altCloseCalendar + "'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='_content'></span></td></tr>")
	...
	function constructCalendar () {
		...
		for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
		{
			...
			{ 
			    ...
			    {
			    	sHTML += "<b><a "+dateMessage+" title=\"" + sfeast_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer+";closeCalendar();'><font color=#ff0000>&nbsp;" + datePointer + "</font>&nbsp;</a></b>"
			    }else
			    {
			...
			else if	(weekString.indexOf(now_week)!=-1)//休息日
			{
				if(!getWeek_date(yearSelected,monthSelected,datePointer))
				{
					if(getfeastStr(yearSelected,monthSelected,datePointer))
			                 {
			                     sHTML += "<a "+dateMessage+" title=\"" + sfeast_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendar();'>&nbsp;<font color=#3333FF>" + datePointer + "</font>&nbsp;</a>" 
			                 }else
			                 {
			                   sHTML += "<a "+dateMessage+" title=\"" + sweek_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendar();'>&nbsp;<font color=#909090>" + datePointer + "</font>&nbsp;</a>" 	
			                 }
					
			        }else
			        {
			        	sHTML += "<a "+dateMessage+" title=\"" + swork_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendar();'>&nbsp;" + datePointer + "&nbsp;</a>" 
			        }
			...
			{ 
			    ...
			    }else
			    {
			        ...
			        {
			            sHTML += "<a "+dateMessage+" title=\"" + sturn_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendar();'>&nbsp;<font color=#909090>" + datePointer + "</font>&nbsp;</a>" 
			        }else
			        {
			            sHTML += "<a "+dateMessage+" title=\"" + swork_Hit + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendar();'>&nbsp;" + datePointer + "&nbsp;</a>" 
			        }
