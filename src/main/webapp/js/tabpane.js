...
{	
	var w0 = "1px", w1 = "2px";	
	var str = '<table width="'+ this._width +'" height="'+ this._height + '" border="0" cellspacing="0" cellpadding="0">'+ 
		'<tr><td colspan="5"></td></tr>'+ '<tr><td colspan="5"><div style="width:100%;height:' + w0 + 
		';" class="tabpane-pane"></div></td></tr>'+'<tr><td rowspan="4"><div style="width:' + w0 + 
		';height:100%;" class="tabpane-pane"></div></td>'+'<td colspan="3"><div style="width:100%;height:' + w1 
		+ ';" class="tabpane-pane0"></div></td>'+ '<td rowspan="4"><div style="width:' + w0 + 
		';height:100%;" class="tabpane-pane"></div></td></tr>'+ '<tr height="100%"><td><div style="width:' + w1 + 
		';height:100%;" class="tabpane-pane0"></div></td>'+ '<td width="100%"></td>'+ '<td><div style="width:' + w1 
		+ ';height:100%;" class="tabpane-pane0"></div></td></tr>'+ '<tr><td  colspan="3"><div style="width:100%;height:' + w1 + 
		';" class="tabpane-pane0"></div></td></tr>'+ '<tr><td colspan="5"><div style="width:100%;height:' + w0 + 
		';" class="tabpane-pane"></div></td></tr>';
	//document.write(str);
	//alert(str);	
...
{	
	var str;	
	str = '<iframe name="'+ this._name + '" src="about:blank" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>';	
...
{	
	this.selectItemByNumber(this._items.indexOf(item));
};
...
{	
	...
	if(pitem != null)		
	 pitem.refresh();	
	item.refresh();	this._selectedItem = item;
};
/******************************    tab       item   *******************************/
...
{	
	var str;	
	str = '<iframe style="visibility:hidden;position:absolute;z-index:-10;" name="'+ this._name + 
		'" src="" scrolling="no" width="100%" height="100%" frameborder="0"></iframe>';	
	var ifr = tpCreateElementWithHTML(str);	
	this._iframe = ifr;	
	return ifr;
};
...
{	
	...
	this._object = obj;	/*if(this._url != null) this._pane.getTargetWindow().src = this._url;*/ 
