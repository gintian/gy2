...
function UnTip()
{
	...
	if(tt_aV[DURATION] < 0 && (tt_iState & 0x2))
		...
		tt_HideInit();
	//xyy 20141125 隐藏注释的
	var elem = document.getElementById("WzBoDy");
	if(elem!=null){
		document.getElementById("WzBoDy").style.display = "none";
	}
}
...
function tt_Tip(arg, t2t)
{
	...
	var next = function(){ tt_AdaptConfig2(); tt_OverInit(); tt_ShowInit(); tt_Move();};
	//暂停一下，否则鼠标坐标正好位于容器边框上时tip坐标失效
