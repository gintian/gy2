...
function CreatePopupMenu()
{
    ...
    oPopBody.innerHTML = "Click outside.";
...
function NodeMouseDown(p_oSrcElement)
{
	...
	{
		CreatePopupMenu();
		//document.title=p_oSrcElement.title;
		//alert(p_oSrcElement.title);
	}
...
/*
function DivMouseDown(p_oSrcElement)
{
	if(event.button==2)
	{
		alert(p_oSrcElement.innerHTML);
	}
}
function DivMouseOver(p_oSrcElement)
{

}

function DivMouseOut(p_oSrcElement)
{
