...
if ($.fn.validatebox){
	...
	$.fn.validatebox.defaults.rules.email.message = 'Bitte geben Sie eine g眉ltige E-Mail-Adresse.';
	$.fn.validatebox.defaults.rules.url.message = 'Bitte geben Sie eine g眉ltige URL.';
