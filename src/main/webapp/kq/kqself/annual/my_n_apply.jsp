...
int i=0;
%>
<html:form action="/kq/kqself/annual/my_n_apply">
...
<hrms:paginationdb id="element" name="myAnnualForm" sql_str="myAnnualForm.sql" table="" where_str="myAnnualForm.where" columns="${myAnnualForm.com}" page_id="pagination"  indexes="indexes">
          <%
          if(i%2==0)
          {
          %>
