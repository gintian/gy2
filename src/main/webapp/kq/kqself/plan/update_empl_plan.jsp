...
<script language="javascript">
 ...
 function getdate(tt,flag)
 {
   ...
   function getDays()
   {
	  ...
	  hashvo.setValue("q3101","${kqPlanInfoForm.apply_id}"); 	   
   	  var request=new Request({method:'post',onSuccess:showDays,functionId:'15502110017'},hashvo);
   }
</script>
<html:form action="/kq/kqself/plan/my_plan_info"  onsubmit="return validate()">
   <br><br>
     <table width="400" border="0" cellpadding="1" cellspacing="0" align="center">
          ...
          <td class="framestyle9">
            <table border="0" cellspacing="5"  class="DetailTable"  cellpadding="0" >   
                <tr><td height="20"></td><td height="20">
                
                <span id="days"></span></td></tr>   
                      ...
                      <logic:equal name="element" property="visible" value="true">
                           <tr> 
                              ...
                              <logic:equal name="element" property="itemtype" value="D">
                                 <td align="left" class="tdFontcolor" nowrap> 
                                     <logic:match name="element" property="itemid" value="05">           
                                      <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' disabled = "true" styleId='${element.itemid}' size="20" maxlength="20" onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,false,false);' styleClass="TEXT4"/>
                                     </logic:match>
                              	     <logic:match name="element" property="itemid" value="z1">
                              	       <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' styleId='${element.itemid}' size="20" maxlength="20" onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,false,false);' styleClass="TEXT4"/>
                              	     </logic:match>
                              ...
                              <logic:equal name="element" property="itemtype" value="M">
                                 <td align="left" class="tdFontcolor" nowrap>                
                                    <html:textarea name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' styleId='${element.itemid}' cols="35" rows="4" styleClass="text5"/>
                                 </td>                           
                              </logic:equal>
                              <!--字符型 -->                                                    
                              <logic:equal name="element" property="itemtype" value="A">
                                 <td align="left" class="tdFontcolor" nowrap>
                                    <logic:notEqual name="element" property="codesetid" value="0">
                                       ...
                                       <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].viewvalue"%>' styleId='${element.itemid}' size="20" maxlength="50" styleClass="TEXT4" onchange="fieldcode(this,2);"/>
                                       <img src="/images/code.gif" onclick='openInputCodeDialog("${element.codesetid}","<%="onelist["+index+"].viewvalue"%>");'/>
                                    </logic:notEqual> 
                                    <logic:equal name="element" property="codesetid" value="0">                                      
                                        <logic:equal name="element" property="itemid" value="q2903">
                                        <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' disabled = "true" styleId='${element.itemid}'  size="31" maxlength="${element.itemlength}" styleClass="TEXT4"/> 
                                       </logic:equal>
                                       <logic:notEqual name="element" property="itemid" value="q2903">
                                        <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>'  styleId='${element.itemid}'  size="31" maxlength="${element.itemlength}" styleClass="TEXT4"/> 
                                       </logic:notEqual>
                                    </logic:equal>                               
                                  </td>                           
                                </logic:equal> 
                                ...
                                <logic:equal name="element" property="itemtype" value="N">
                                   <td align="left" class="tdFontcolor" nowrap>                
                                       <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' size="31" styleId='${element.itemid}' maxlength="${element.itemlength}" styleClass="TEXT4"/>                               
                                   </td>                           
                                </logic:equal>                           
                              </tr>   
                        </logic:equal>  
