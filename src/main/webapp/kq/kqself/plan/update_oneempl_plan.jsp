...
<script language="javascript">
 function validate()
 {
       ...
       co=document.getElementById("a0101");       
       value_co=co.value;
       if(value_co=="")
       {
         alert("姓名不能为空！");
       ...
       co=document.getElementById("q31z7");       
       value_co=co.value;
       if(trim(value_co)=="")
       {
         alert("审批意见不能为空！");
...
<html:form action="/kq/kqself/plan/searchoneplan" onsubmit="return validate()">
   <br><br>
                              ...
                              <logic:equal name="element" property="itemtype" value="D">
                                 <td align="left" class="tdFontcolor" nowrap> 
                                     <logic:match name="element" property="itemid" value="05">           
                                      <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' styleId='${element.itemid}' disabled = "true"  size="20" maxlength="20" onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,true,false);' styleClass="TEXT4"/>
                                     </logic:match>
                              ...
                              <logic:equal name="element" property="itemtype" value="A">
                                 <td align="left" class="tdFontcolor" nowrap>
                                    <logic:notEqual name="element" property="codesetid" value="0">
                                       ...
                                       <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].viewvalue"%>' size="31" styleId='${element.itemid}' maxlength="50" styleClass="TEXT4" onchange="fieldcode(this,2);"/>
                                       <img src="/images/code.gif" onclick='openInputCodeDialog("${element.codesetid}","<%="onelist["+index+"].viewvalue"%>");'/>
                                    </logic:notEqual> 
                                    <logic:equal name="element" property="codesetid" value="0">
                                        <html:text name="kqPlanInfoForm" property='<%="onelist["+index+"].value"%>' disabled = "true" size="31" styleId='${element.itemid}' maxlength="${element.itemlength}" styleClass="TEXT4"/> 
                                    </logic:equal>                               
                                  </td>                           
                                </logic:equal> 
                                <!--数据值-->                            
