...
<SCRIPT LANGUAGE=javascript>
  ...
  var m_sXMLFile= "/kq/team/historical/group_list.jsp?params=gp&codetiem="+codetiem+"&straction=/kq/machine/historical/search_card_data.do";	
  var root=new xtreeItem("root","所有班组","/kq/machine/historical/search_card_data.do?b_search=link&group_id=&a_code=","mil_body","所有班组","/images/table.gif",m_sXMLFile);
