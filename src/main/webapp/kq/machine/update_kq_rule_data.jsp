...
<div class="fixedDiv3" style="padding-top: 5px">
<table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0">
          <tr> 
            
    <td align="center" valign="top" nowrap> 
      <table width="100%" border="0" style="border-collapse: collapse;"  cellpadding="0" cellspacing="0" align="center" class="ListTableF">
        <tr height="20"> 
          ...
          <td  class="framestyle9" > 
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr align="center" valign="bottom"> 
                <td height="30" colspan="4"> <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="120"><bean:message key="kq.rule.name"/>:</td>
                      <td align="left">
                      <bean:write name="kqRuleDataForm" property="kq_rule_vo.string(rule_name)" filter="true"/></a>&nbsp;
                      </td>
                    </tr>
                  </table></td>
              </tr>
              ...
              <tr> 
                <td nowrap class="RecordRow_lt" style="border-left: none" height="25">&nbsp;<bean:message key="kq.rule.card"/></td>
                <td nowrap class="RecordRow_lt"> 
                  <table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.from"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='card_s' property="kq_rule_vo.string(card_s)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                ...
                <td colspan="2" nowrap class="RecordRow_lt">
<table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.to"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='card_e' property="kq_rule_vo.string(card_e)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td nowrap class="RecordRow_lt"  style="border-left: none" >&nbsp;<bean:message key="kq.rule.year"/> </td>
                <td nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.from"/>&nbsp;</td>
                      <td valign="middle">                      
                       <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='year_s' property="kq_rule_vo.string(year_s)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
                ...
                <td colspan="2" nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.to"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='year_e' property="kq_rule_vo.string(year_e)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td nowrap class="RecordRow_lt"  style="border-left: none" >&nbsp;<bean:message key="kq.rule.hm"/> </td>
                <td nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.from"/>&nbsp;</td>
                       <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='md_s' property="kq_rule_vo.string(md_s)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
                ...
                <td colspan="2" nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.to"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='md_e' property="kq_rule_vo.string(md_e)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td nowrap class="RecordRow_lt"  style="border-left: none" >&nbsp;<bean:message key="kq.rule.md"/> </td>
                <td nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.from"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='hm_s' property="kq_rule_vo.string(hm_s)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
                ...
                <td colspan="2" nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.to"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='hm_e' property="kq_rule_vo.string(hm_e)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td nowrap class="RecordRow_lt"  style="border-left: none" >&nbsp;<bean:message key="kq.rule.machine"/> </td>
                <td nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.from"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='machine_s' property="kq_rule_vo.string(machine_s)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
                ...
                <td colspan="2" nowrap class="RecordRow_lt"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td align="right">&nbsp;<bean:message key="kq.rule.to"/>&nbsp;</td>
                      <td valign="middle"> 
                         <html:text styleClass="TEXT4" name="kqRuleDataForm" styleId='machine_e' property="kq_rule_vo.string(machine_e)" size="4"  onkeypress="event.returnValue=IsDigit();"/>&nbsp;                       
                      </td>
                      <td valign="middle" align="left">
                        <table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td colspan="4" nowrap class="RecordRow_lt"  style="border-left: none" >&nbsp;<bean:message key="kq.machine.num.place"/> 
                  <html:multibox name="kqRuleDataForm" property="kq_rule_vo.string(status)" styleId='status' value="1" onclick="no_disabled();"/>&nbsp;
