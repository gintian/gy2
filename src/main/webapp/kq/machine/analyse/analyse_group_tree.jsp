...
<SCRIPT LANGUAGE=javascript>
  ...
  var m_sXMLFile= "/kq/team/array/group_list.jsp?params="+params+"&codetiem="+codetiem+"&straction=/kq/machine/analyse/data_analyse_data.do";	
  var root=new xtreeItem("root","所有班组","/kq/machine/analyse/data_analyse_data.do?b_search=link&group_id=&a_code=","mil_body","所有班组","/images/table.gif",m_sXMLFile);
