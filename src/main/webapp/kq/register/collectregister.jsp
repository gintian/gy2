...
<html:form action="/kq/register/collect_registerdata">
<logic:equal name="dailyRegisterForm" property="error_flag" value="0">
<script language="javascript">
   function change()
   {
      dailyRegisterForm.action="/kq/register/collect_registerdata.do?b_search=link&code=${dailyRegisterForm.code}&kind=${dailyRegisterForm.kind}";
   ...
   function goback()
   {
      dailyRegisterForm.action="/kq/register/daily_register.do?b_search=link&action=daily_registerdata.do&target=mil_body";
      dailyRegisterForm.target="il_body"
      dailyRegisterForm.submit();
   } 
   function refer()
   {
      dailyRegisterForm.action="/kq/register/collect_registerdata.do?b_refer=link";
      dailyRegisterForm.submit();
   } 
   function audit()
   {
      dailyRegisterForm.action="/kq/register/collect_registerdata.do?b_audit=link";
      dailyRegisterForm.submit();
   }  
...
<table>
      ...
      <td align= "left" nowrap> 
         ...
         <hrms:menubar menu="menu1" id="menubar1" target="mil_body">
           <hrms:menuitem name="rec" label="报审报批" >            
            <hrms:menuitem name="mitem2" label="汇总数据报审" icon="/images/quick_query.gif" url="javascript:audit()" function_id="2702061"/>   
            <hrms:menuitem name="mitem1" label="汇总数据报批" icon="/images/quick_query.gif" url="javascript:refer();" function_id="2702060"/>  
            <hrms:menuitem name="mitem3" label="返回日明细" icon="/images/add_del.gif" url="javascript:goback();" function_id="2702033"/>              
          </hrms:menuitem>   
         </hrms:menubar>
       </td>
       </tr>
 ...
 <%int i=0;%>
    <table width="100%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable" >
      ...
      <hrms:paginationdb id="element" name="dailyRegisterForm" sql_str="dailyRegisterForm.sqlstr" table="" where_str="dailyRegisterForm.strwhere" columns="dailyRegisterForm.columns" order_by="dailyRegisterForm.orderby" pagerows="18" page_id="pagination">
          <%
          if(i%2==0){ 
          %>
