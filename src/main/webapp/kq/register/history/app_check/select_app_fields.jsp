...
<script language="javascript">
	...
	function showSetList(outparamters){
		...
		AjaxBind.bind(appForm.fieldlist,/*$('fieldlist')*/fieldlist);
...
<html:form action="/kq/register/history/selectfiled" method="my_openframe">
<!--查询指标-->
<br/>
...
<table width="80%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable">
		...
		&nbsp;<bean:message key="label.query.selectfield"/>&nbsp;
              ...
              <table>
                <tr>
                 <td align="center"  width="46%">
                   ...
                   <tr>
                       <td align="center">
                         <html:select name="appForm" property="left_fields" multiple="multiple" size="10" ondblclick="additem('left_fields','right_fields');" style="height:230px;width:100%;font-size:9pt">
	           ...
	           <html:button  styleClass="mybutton" property="b_delfield" onclick="removeitem('right_fields');">
                ...
                <td width="46%" align="center">
                 <table width="100%">
                  ...
                  <tr>
                  <td width="100%" align="left">
 		     <html:select name="appForm" property="right_fields" multiple="multiple" size="10" ondblclick="removeitem('right_fields');" style="height:230px;width:100%;font-size:9pt">
          ...
          <input type="button" name="btnreturn" value='取消' onclick="history.back();window.close();" class="mybutton">						      
               <hrms:submit styleClass="mybutton"  property="b_next" onclick="return filloutData();">
