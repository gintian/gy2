...
<script language="javascript">
   ...
   {
    appForm.action="/kq/register/history/app_check.do?b_search=link&table="+table;
    appForm.submit();    
   }
</script>
<html:form action="/kq/register/history/view_app">
   <br><br>
            ...
            <table border="0" cellpmoding="5" cellspacing="0"  class="DetailTable"  cellpadding="0" style="margin-left: 15px;">      
             ...
             <br>
               ...
               <logic:equal name="appForm" property="table" value="Q11_arc"> 
	 	              <html:button  styleClass="mybutton" property="b_return" onclick="toallapp('Q11_arc');">
            	      <bean:message key="button.return"/>    
	                </html:button >
	            </logic:equal>  
	           <logic:equal name="appForm" property="table" value="Q15_arc"> 
	 	              <html:button  styleClass="mybutton" property="b_return" onclick="toallapp('Q15_arc');">
            	        <bean:message key="button.return"/>    
	            </html:button >
	           </logic:equal>  
	           <logic:equal name="appForm" property="table" value="Q13_arc"> 
	 	          <html:button  styleClass="mybutton" property="b_return" onclick="toallapp('Q13_arc');">
            	        <bean:message key="button.return"/>    
	            </html:button >
	           </logic:equal>  
	         </td>
