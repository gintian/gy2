...
<script language="javascript">
  ...
  function appQuery()
   {
      appForm.action="/kq/register/history/selectfiled.do?b_query=link&table=${appForm.table}";
      appForm.submit();
      returnValue="ok";
      window.close();         
   }
   function appBack(){
   	  appForm.action="/kq/register/history/selectfiled.do?b_init=link";
      appForm.submit();
   }
</script>
<base id="mybase" target="_self">
<html:form action="/kq/register/history/selectfiled"><br/>
          ...
          <tr class="list3">
            <td colspan="1">
				<input type="button" name="btnreturn" value='<bean:message key="button.query"/>' onclick="appQuery();" class="mybutton">
				 ...
				 <input type="button" name="btnreturn" value='<bean:message key="button.query.pre"/>' onclick="appBack();" class="mybutton">						      
