          		...
          		<logic:iterate id="info" name="browseHistoryForm"  property="kqnamelsit">
                   ...
                   <logic:equal name="info" property="itemtype" value="N">
                   		<td align="left" class="RecordRow" nowrap>
					         ...
					         <bean:define id="scope" name="element" property="scope"/>
					         <bean:define id="nbase" name="element" property="nbase"/>
					         <%
					         		//参数加密
					    		     String str1 = "b0110="+b01101+"&itemid="+itemid1+"&a0100="+a01001+"&scope="+scope+"&usernbase="+nbase;
					         %>
                   		<a href="###" onclick="hr('/kq/register/history/statfx/statfxuserinfo.do?b_userinfo=link&encryptParam=<%=PubFunc.encrypt(str1) %>')">
