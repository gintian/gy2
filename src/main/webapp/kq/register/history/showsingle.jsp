...
<html:form action="/kq/register/history/showsingle_month">
<script language="javascript">
 function couser()
   {
      singleRegisterForm.action="/kq/register/history/showsingle_month.do?b_browse=link&a0100=${singleRegisterForm.a0100}&kind=${singleRegisterForm.userbase}";
   ...
   function returnC()
   {
       singleRegisterForm.action="/kq/register/history/showsingle_month.do?br_browse=link";
       singleRegisterForm.submit();
   }
   </script>
<table>
