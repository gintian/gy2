...
//singleRegisterForm.action="/general/muster/hmuster/select_muster_name.do?b_query=link&nFlag=81&relatTableid=${singleRegisterForm.relatTableid}";
//singleRegisterForm.submit();
	document.mysearchform.submit();
	var returnURL = getEncodeStr("${singleRegisterForm.returnURL}");
	var urlstr = "/general/muster/hmuster/searchHroster.do?b_search=link&nFlag=81&relatTableid=${singleRegisterForm.relatTableid}&closeWindow=1&single=1";
    ...
    function goback(rflag)
    {
     if(rflag=="05")
     {
       singleRegisterForm.action="/kq/register/select_collectdata.do?b_query2=link";
       singleRegisterForm.submit();
     }else if(rflag=="08")
     {
       singleRegisterForm.action="/kq/register/audit_registerdata.do?b_query2=link";
       singleRegisterForm.submit();
     }else
     {
       history.back();
   ...
   {	
      ...
      //singleRegisterForm.submit();
      singleRegisterForm.action="/kq/register/print_kqreport.do?b_search=link";
      singleRegisterForm.submit();
   }
 </script> 
<table border="0" cellspacing="0"  cellpadding="0">
 ...
 <tr>
	   <td width="60%" align="left"  nowrap>    
	      <input type="button" name="btnreturn" value='<bean:message key="button.print"/>' onclick="change_print();" class="mybutton" style="margin-top:5px;">	     	                 	                 
               <logic:equal name="singleRegisterForm" property="marker" value="1">
               		 <input type="button" name="btnreturn" value="返回" onclick="kqreport();" class="mybutton" style="margin-top:5px;">
               </logic:equal>
               <logic:notEqual name="singleRegisterForm" property="marker" value="1">
					 <input type="button" name="btnreturn" value="返回" onclick="goback('${singleRegisterForm.rflag}');" class="mybutton" style="margin-top:5px;">               
               </logic:notEqual>
           </td>
	   <td width="40%"></td>
        </tr>
