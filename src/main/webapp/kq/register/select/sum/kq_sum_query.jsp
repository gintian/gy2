...
<html:form action="/kq/register/select/sum/kqquery">
<script language="javascript">
   ...
   function selectKq()
   {
       ...
       target_url="/kq/register/select/sum/selectfiled.do?b_init=link&select_flag=${selectKqFieldForm.select_flag}&duration=${selectKqFieldForm.duration}";
