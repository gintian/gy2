...
function backpage()
{
    var report_id="${printKqInfoForm.report_id}"
    var relatTableid = "${printKqInfoForm.relatTableid}";
    if(relatTableid==null)
      relatTableid = "";
    ...
    if(""==relatTableid)
      ...
      printKqInfoForm.action="/kq/register/select_kqreportdata.do?b_select=link&code=${printKqInfoForm.code}&kind=${printKqInfoForm.kind}&userbase=${printKqInfoForm.userbase}&coursedate=${printKqInfoForm.coursedate}&relatTableid=${printKqInfoForm.relatTableid}";
...
function SetDownMsg(s) {
  ...
  function oplidata()
  {
     ...
     printKqInfoForm.action="/kq/register/select_kqreportpar.do?b_parupdate=link";
     printKqInfoForm.submit();
  }
</script> 
<%
...
%>
<html:form action="/kq/register/select_kqreportpar">
<br>	
      <html:hidden name="printKqInfoForm" property="report_id" styleClass="text"/>
      <html:hidden name="printKqInfoForm" property="userbase" styleClass="text"/>
      <html:hidden name="printKqInfoForm" property="code" styleClass="text"/>      
      <html:hidden name="printKqInfoForm" property="coursedate" styleClass="text"/>
      <html:hidden name="printKqInfoForm" property="kind" styleClass="text"/>
      <table width="550" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr height="20">
            <!-- <td>
       	   ...
       	   <td colspan="4" align=center class="TableRow">&nbsp;<bean:message key="kq.label.report_format"/>&nbsp;</td>          	      
         </tr>         
         <tr>
         <td >
		                	   ...
		                	   <%if(!"Q05".equalsIgnoreCase(table)) {%>
		                	   		<tr>
                                     	<td height="30" align="left" colspan="3">
		                	       			<span style="margin-right:0px;width:40px;"><bean:message key="report.parse.display"/>&nbsp;</span>
		                	       			<span style="margin-right:10px;width:50px;cursor: pointer;">
		                	       				<html:multibox name="printKqInfoForm" property="parsevo.body_dept" value="#dept[1]" styleId="dept"/>
		                	       				
		                	       			<label for="dept"><bean:message key="report.parse.dept"/></label></span>
		                	       			<span style="margin-right:10px;width:50px;cursor: pointer;">
		                	       			<html:multibox name="printKqInfoForm" property="parsevo.body_pos" value="#pos[1]" styleId="pos"/>
		                	       			<label for="pos"><bean:message key="report.parse.pos"/></label></span>
		                	       			<span style="margin-right:10px;width:50px;cursor: pointer;">
		                	       			<html:multibox name="printKqInfoForm" property="parsevo.body_gh" value="#gh[1]" styleId="gh"/>
		                	       			<label for="gh"><bean:message key="report.parse.gh"/></label></span>
		                	       			<span style="margin-right:10px;width:80px;cursor: pointer;">
		                	       			<html:multibox name="printKqInfoForm" property="parsevo.body_kqfu" value="#kqfu[1]" styleId="kqfu"/>
		                	       			<label for="kqfu"><bean:message key="report.parse.kqfu"/></label></span>
		                	       			<span style="margin-right:10px;width:80px;cursor: pointer;">
		                	       			<html:multibox name="printKqInfoForm" property="parsevo.body_tjxm" value="#tjxm[1]" styleId="tjxm"/>
		                	       			<label for="tjxm"><bean:message key="report.parse.tjxm"/></label></span>
                                        </td>
		                	   		</tr>
		                	   	<%} %>
		                	 </table> 		                                    
    ...
    <tr>
    <td width="100%" height="30" align="center" style="height:35px;">
    <table width="50%">
      <tr>
        <td align="right">
