...
<html:form action="/kq/register/notq09">
...
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
  ...
  <hrms:extenditerate id="element" name="browseRegisterForm" property="notQ09ListForm.list" indexes="indexes"  pagination="notQ09ListForm.pagination" pageCount="10" scope="session">
          <%
          if(i%2==0)
          {
          %>
  ...
  <table width="70%" align="center">
    ...
    <tr>
       <td valign="bottom" class="tdFontcolor">第
          <bean:write name="browseRegisterForm" property="notQ09ListForm.pagination.current" filter="true" />
          页
          共
          <bean:write name="browseRegisterForm" property="notQ09ListForm.pagination.count" filter="true" />
          条
          共
          <bean:write name="browseRegisterForm" property="notQ09ListForm.pagination.pages" filter="true" />
          页
       </td>
       <td  align="right" nowrap class="tdFontcolor">
          <p align="right">
           <hrms:paginationlink name="browseRegisterForm" property="notQ09ListForm.pagination"
                   nameId="notQ09ListForm">
           </hrms:paginationlink>
       </td>
    </tr>
    <tr>
