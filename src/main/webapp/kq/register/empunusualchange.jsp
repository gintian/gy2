...
<html:form action="/kq/register/empchangeunusual">
...
function changeunusual(){
	...
	if(isCorrect){
		displayWaiting();
		empChangeForm.action="/kq/register/empchangeunusual.do?b_unusual=link";
	    empChangeForm.submit();
	}else{
		alert("请先选择人员！");
	}
...
<table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable">
    ...
    <tr>
      ...
      <td align="center" class="TableRow" nowrap><bean:message key="kq.emp.change.unusual.startdate"/></td>
      <td align="center" class="TableRow" nowrap><bean:message key="kq.emp.change.unusual.enddate"/></td>
      <td align="center" class="TableRow" nowrap><bean:message key="kq.emp.change.unusual.desc"/></td>
  ...
  <hrms:extenditerate id="element" name="empChangeForm" property="recordListForm.list" indexes="indexes"  pagination="recordListForm.pagination" pageCount="${empChangeForm.pagerows}" scope="session">
          ...
          %> 
            ...
            <td align="left" class="RecordRow" nowrap> 
 			...
 			<td align="left" class="RecordRow" nowrap>                  	      
	          	  &nbsp; <bean:write  name="element" property="string(change_end_date)" filter="true"/>&nbsp;             
	          </td>  
	          <td align="left" class="RecordRow" nowrap> 
	          		<logic:equal name="element" property="string(status)" value="2">
	          		&nbsp;<bean:message key="kq.emp.change.unusual.desc.more"/>
	          		</logic:equal>                 	      
	          	   <logic:equal name="element" property="string(status)" value="3">
	          		&nbsp;<bean:message key="kq.emp.change.unusual.desc.less"/>
	          		</logic:equal>
	          		<logic:equal name="element" property="string(status)" value="4">
	          		&nbsp;<bean:message key="kq.emp.change.unusual.desc.startmore"/>
	          		</logic:equal>
	          		 &nbsp;             
	          </td>             
         </tr>
  ...
  <table align="center" width="100%"  class="RecordRowP">
    ...
    <tr>
        <td valign="bottom">  
         <bean:message key="kq.emp.change.unusual.title"/><font color="red">
         <bean:write name="empChangeForm" property="unusal_count" /> </font>人 
        </td>
 ...
 <table width="50%" align="center">
    <tr>
       ...
       -->
        <input type="button" value='<bean:message key="button.ok"/>' onclick="changeunusual();" class="mybutton">   
