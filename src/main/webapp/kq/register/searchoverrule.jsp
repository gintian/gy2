...
<table align="center" width="80%" valign='middle'height="300">
  <tr>
     <td valign='middle'>
         <table border="1" width="100%" cellspacing="0" cellpadding="4" style="border-collapse: collapse" bgcolor="#F7FAFF" height="270" align="center">
           <tr>
             <td bgcolor="#3399FF" style="font-size:14px;color:#ffffff" height=24 colspan="2" align="center">审批意见信息</td>
           </tr>
           <tr>
