...
<html:form action="/kq/register/empchange_leave">
...
function leavechange(){
	...
	if(isCorrect){
		displayWaiting();
		empChangeForm.action="/kq/register/empchange_leave.do?b_leavechange=link";
	    empChangeForm.submit();
	}else{
		alert("请先选择人员！");
	}
...
<table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable">
		<tr>
			<td align="center" class="TableRow" nowrap>
				<input type="checkbox" name="selbox"
					onclick="batch_select(this,'recordListForm.select');"
					title='<bean:message key="label.query.selectall"/>'>
				&nbsp;
			</td>
			<td align="center" class="TableRow" nowrap>
				<bean:message key="hrms.nbase" />
			</td>
			<td align="center" class="TableRow" nowrap>
			...
			<td align="center" class="TableRow" nowrap>
				<bean:message key="kq.emp.change.end.date" />
				<html:hidden name="empChangeForm" property="changestatus"
					styleClass="text" />
			</td>
		</tr>
  ...
  <table align="center" width="100%"  class="RecordRowP">
    <tr>
       <td valign="bottom">  
        减少人数<font color="red">
           <bean:write name="empChangeForm" property="leave_count" /> </font>人 
       </td>
 ...
 <table width="50%" align="center">
    <tr>
       <td width="60%" align="center"  nowrap>
		   <input type="button" value='<bean:message key="button.ok"/>' onclick="leavechange();" class="mybutton">
