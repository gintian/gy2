...
<script> 
 var url="/kq/register/daily_registerdata.do?b_creat=link" ;   //要加载的目标页 
  ...
  <tr>
     <td valign='middle'>
         <table border="1" width="37%" cellspacing="0" cellpadding="4" style="border-collapse: collapse" bgcolor="#F7FAFF" height="87" align="center">
           <tr>
             <td bgcolor="#3399FF" style="font-size:12px;color:#ffffff" height=24><bean:message key="kq.register.creat1.go"/></td>
           </tr>
           <tr>
