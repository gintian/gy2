...
<html:form action="/kq/register/collect_orgdailydata">
<script language="javascript">
   //验证是否报批成功 
  ...
  function change()
   {
      orgRegisterForm.action="/kq/register/collect_orgdailydata.do?b_search=link";
      orgRegisterForm.submit();
   }
function changeys(dd)
{
	if(dd==2){
 		orgRegisterForm.action="/kq/register/collect_orgdailydata.do?b_search=link&selectys=2&code=${orgRegisterForm.code}&kind=${orgRegisterForm.kind}";
    	orgRegisterForm.submit();
 	}else if(dd==1){
 		orgRegisterForm.action="/kq/register/collect_orgdailydata.do?b_search=link&selectys=1";
    	orgRegisterForm.submit();
 	}
} 
function go_must(){
...
<table>
        ...
        <td align="left">
           <table border="0" cellspacing="0"  align="left" cellpadding="0"><tr><td>
            <hrms:menubar menu="menu1" id="menubar1" target="mil_body">              
              ...
              <hrms:menuitem name="mitem5" label="导出Excel" icon="/images/export.gif" url="javascript:excecuteExcel();" function_id=""/>
              <hrms:menuitem name="mitem4" label="打印" icon="/images/print.gif" url="javascript:go_must();" function_id=""/>              
              </hrms:menuitem>              
           </hrms:menubar>
           </td></tr></table>
        </td>  
 ...
 <tr>
 	<td>
 		<table  width="70%" align="center" class="ListTableF">
	<tr>
