...
<html:form action="/kq/register/history/statfx/statfxdata">
	...
	<table width="100%" border="0" cellspacing="0" align="center" cellpadding="0">
		<tr class="list3">
			...
			人员库
         <html:select name="browseHistoryForm" property="dbpre" size="1" onchange="">
			...
			<bean:message key="label.by.time.domain"/>
		 			<bean:message key="label.from"/>
   	  	 			<input type="text" name="start_date" value="${browseHistoryForm.start_datetj}" extra="editor" class="inputtext" style="width:100px;font-size:10pt;text-align:left" id="editor1"  dropDown="dropDownDate">
   	  	 		 <bean:message key="label.to"/>
   	  	 		 <input type="text" name="end_date"  value="${browseHistoryForm.end_datetj}" extra="editor" class="inputtext" style="width:100px;font-size:10pt;text-align:left" id="editor2"  dropDown="dropDownDate">
		...
		<table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable" >
			<thead>
         	...
         	<hrms:paginationdb id="element" name="browseHistoryForm" sql_str="browseHistoryForm.sqlstr" table="" where_str="browseHistoryForm.strwhere" columns="browseHistoryForm.columns" order_by="browseHistoryForm.orderby" pagerows="18" page_id="pagination">
          		<%
                   ...
                   <!--数字-->
                      ...
                      <td align="center" class="RecordRow" nowrap> 
                         <logic:greaterThan name="element" property="${info.itemid}" value="0">
                            	...
                            	<a href="###" onclick="hr('/kq/register/history/statfx/statfxname.do?b_seename=link&b01101=<bean:write name="element" property="b0110" filter="true"/>&itemid=<bean:write  name="info" property="itemid"/>&codetj=<%=codename%>');">
                                  &nbsp;<hrms:codetoname codeid="UN" name="element" codevalue="b0110" codeitem="codeitem" scope="page"/>
