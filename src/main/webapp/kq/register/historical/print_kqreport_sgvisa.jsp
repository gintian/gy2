...
<script language=JavaScript>
	function pagepar()
	{
     printKqInfoForm.action="/kq/register/historical/print_kqreport_unittable.do?b_par=link&userbaseunit=${printKqInfoForm.userbaseunit}&unita0100=${printKqInfoForm.unita0100}&username=${printKqInfoForm.username}&report_unitid=${printKqInfoForm.report_unitid}";
     printKqInfoForm.submit();
	}
	function go_back()
	{
		var codeValue = document.getElementById("codeValue").value;
	    printKqInfoForm.action="/kq/register/historical/print_kqreport.do?b_search=link&b_search=link&code="+codeValue+"&kind=1";
        printKqInfoForm.submit();
	} 
</script>
