...
<html:form action="/kq/register/historical/orgyearsingle">
<script language="javascript">
 function couser()
   {
      singleRegisterForm.action="/kq/register/historical/orgyearsingle.do?b_browse=link&b0110=${singleRegisterForm.b0110}";
      singleRegisterForm.submit();
   }  
   function change_print()
   {
       singleRegisterForm.action="/general/muster/hmuster/select_muster_name.do?b_query=link&nFlag=81&kqtable=Q09_arc&relatTableid=${singleRegisterForm.relatTableid}";
       singleRegisterForm.submit();
   }
          function historical_back()
   {
       singleRegisterForm.action="/kq/register/historical/orgyearsingle.do?br_browse=link";
       singleRegisterForm.submit();
   }
   </script>
<table>
 ...
 <tr>
	   <td align="center"  nowrap>	
        ...
        <input type="button" name="btnreturn" value='<bean:message key="kq.emp.button.return"/>' onclick="historical_back();" class="mybutton">	
     </td>
  </tr>
</table>
</html:form>
