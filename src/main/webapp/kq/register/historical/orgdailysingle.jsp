...
<hrms:themes /> <!-- 7.0css -->
<html:form action="/kq/register/historical/orgdailysingle">
<script language="javascript">
 function couser()
   {
      singleRegisterForm.action="/kq/register/historical/orgdailysingle.do?b_browse=link&b0110=${singleRegisterForm.b0110}";
      singleRegisterForm.submit();
   }  
    function change_print()
   {
       singleRegisterForm.action="/general/muster/hmuster/select_muster_name.do?b_query=link&kqtable=Q07_arc&nFlag=81&relatTableid=${singleRegisterForm.relatTableid}";
       singleRegisterForm.submit();
   }
       function historical_back()
   {
       singleRegisterForm.action="/kq/register/historical/orgdailysingle.do?br_browse=link";
       singleRegisterForm.submit();
   }
   </script>
<table width="100%">
   ...
   <table width="100%" border="0" cellspacing="1"  align="left" cellpadding="1">
    <tr>
      <td align= "left" nowrap>      
       ...
       <html:select name="singleRegisterForm" property="cur_duration" size="0" onchange="javascript:couser();">
  ...
  <td>
    ...
    <table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTableF" style="border:none;" >
     ...
     <table  width="100%" align="center" class="RecordRowP">
	  ...
	  <td  width="100%" align="right" nowrap class="tdFontcolor">
   ...
   <tr>
	  ...
	  <!-- <input type="button" name="btnreturn" value='<bean:message key="button.print"/>' onclick="change_print();" class="mybutton"> --> 	     	                 	     	                 
        <input type="button" name="btnreturn" value='<bean:message key="button.return"/>' onclick="historical_back();" class="mybutton">						      
   </td>
 </tr>
</table>
</html:form>
