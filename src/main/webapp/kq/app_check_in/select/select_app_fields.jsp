...
<script language="javascript">
	...
	function showFieldList(outparamters){
		var fieldlist=outparamters.getValue("fieldlist");
		AjaxBind.bind(appForm.left_fields,fieldlist);
	}
	...
	function searchFieldList(){
	   var tablename='table=${appForm.table}';		      
   	   var request=new Request({method:'post',asynchronous:false,parameters:tablename,onSuccess:showFieldList,functionId:'1510030001'});
	}
...
<html:form action="/kq/app_check_in/select/selectfiled">
<!--查询指标-->
<br/>
