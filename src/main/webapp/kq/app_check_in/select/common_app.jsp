...
<script language="javascript">
  ...
  function appQuery()
   {
      appForm.action="/kq/app_check_in/select/selectfiled.do?b_query=link&table=${appForm.table}";
   ...
   function backVo(){
   		appForm.action="/kq/app_check_in/select/selectfiled.do?b_init=link&table=${appForm.table}"
   		appForm.submit();  
   }
   
</script>
<base id="mybase" target="_self">
<html:form action="/kq/app_check_in/select/selectfiled"><br/>
  <table width="550" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr height="20">
       		...
       		<td align="left" class="TableRow">&nbsp;&nbsp;申请查询</td>      		           	      
          </tr> 
          <tr>
            ...
            <logic:iterate id="element" name="appForm"  property="factorlist" indexId="index"> 
			  ...
			  <td align="center" class="RecordRow" nowrap >
				...
				<html:text name="appForm" property='<%="factorlist["+index+"].value"%>' size="30" maxlength="10" styleClass="text4" ondblclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates);' onblur="Element.hide('date_panel');"/>
                            </td>                           
                          </logic:equal>
                          <!--备注型 -->                              
                          ...
                          <logic:equal name="element" property="fieldtype" value="A">
                            <td align="left" class="RecordRow" nowrap>
                              <logic:notEqual name="element" property="codeid" value="0">
                                <html:hidden name="appForm" property='<%="factorlist["+index+"].value"%>' styleClass="text4"/>                               
                                <html:text name="appForm" property='<%="factorlist["+index+"].hzvalue"%>' size="30" maxlength="50" styleClass="text4" onchange="fieldcode(this,1)"/><img src="/images/code.gif" align="middle" onclick='openCondCodeDialog("${element.codeid}","<%="factorlist["+index+"].hzvalue"%>");'/>
                              </logic:notEqual>                              
                              <logic:equal name="element" property="codeid" value="0">
                                <!--考勤日期-->
                                <logic:equal name="element" property="fieldname" value="q03z0">
                                  <html:text name="appForm" property='<%="factorlist["+index+"].value"%>' size="30" maxlength="${element.itemlen}" styleClass="text4"  onfocus="setday(this);"/>                               
                                </logic:equal>
                                <!--人员库-->
                                <logic:equal name="element" property="fieldname" value="nbase">
                                   <html:select name="appForm" property='<%="factorlist["+index+"].value"%>' size="1" styleClass="text4">
          ...
          <tr class="list3">
            <td colspan="1">
				<input type="button" name="btnreturn" value='<bean:message key="button.query"/>' onclick="appQuery()" class="mybutton">
				 ...
				 <input type="button" name="btnreturn" value='<bean:message key="button.query.pre"/>' onclick="backVo();" class="mybutton">						      
