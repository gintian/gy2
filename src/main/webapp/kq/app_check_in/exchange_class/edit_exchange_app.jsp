...
<script language="javascript">
   ...
   function saveRe()
   {
     ...
     if(confirm("确实要保存吗！"))
      {
         exchangeAppForm.action="/kq/app_check_in/exchange_class/app_exchange.do?b_save=link&app_flag=edit";         
	...
	<fieldset align="center" style="width:90%;">
        ...
        <table width="100%"  border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">
            ...
            <tr> 
               ...
               <td  class="tdFontcolor" nowrap >  
               <html:textarea name="exchangeAppForm" property="ex_vo.string(q1911)" cols="30" rows="5" styleClass="text5"/>
               </td>
            <tr> 
            <tr> 
               <td align="right" height="25" width="25%" class="tdFontcolor" nowrap >                 
            ...
            <tr> 
               ...
               <td class="tdFontcolor" nowrap >  
                 <html:textarea name="exchangeAppForm" property="ex_vo.string(q1915)" cols="30" rows="5" styleClass="text5"/>
               </td>
            <tr> 
         </table>
        </fieldset>
...
<table  width="100%" align="center">
  <tr> 
    ...
    <hrms:priv func_id="270134" module_id=""> 
