...
<script language="javascript">
   ...
   function saveRe(flag)
   {
     ...
     if(confirm(info))
      {
         exchangeAppForm.action="/kq/app_check_in/exchange_class/app_exchange.do?b_saveapprove=link&app_flag=edit&flagsturt="+flag;
         exchangeAppForm.submit();          
      }
   }
  function reSaveFlag()
  {
     var spflag="${exchangeAppForm.spFlag}";
     if(spflag!="")
     {
       alert(spflag);
        exchangeAppForm.action="/kq/app_check_in/exchange_class/exchangedata.do?b_search=link";
        exchangeAppForm.submit();
       ...
       <fieldset align="center" style="width:90%;">
          ...
          <table width="100%"  border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">
            <tr> 
              ...
              <td height="30" >
              <html:text styleClass="inputtext"  name="exchangeAppForm" property="ex_vo.string(q19z1)" styleId="q19z1" size="10" onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,false);' onchange="rep_dateValue(this);getClass('c');" readonly="true"/>  
              </td>
              <td height="30" align="center" > <bean:message key="kq.exchange.move.date"/> </td>
              <td height="30" >
              <html:text styleClass="inputtext"  name="exchangeAppForm" property="ex_vo.string(q19z3)" styleId="q19z3" size="10" onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,false);' onchange="rep_dateValue(this);getClass('e');" readonly="true"/>  
              </td>
            <tr> 
          </table>
       </fieldset>
        ...
        <table width="100%"  border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">
            <tr> 
               ...
               <td class="tdFontcolor" nowrap > 
                <html:text styleClass="inputtext"  name="exchangeAppForm" property="ex_vo.string(q1909)"/>  
               </td>
            <tr> 
            <tr> 
               <td  align="right" height="25" width="25%" class="tdFontcolor" nowrap >                 
               ...
               <td  class="tdFontcolor" nowrap >  
               <html:textarea name="exchangeAppForm" property="ex_vo.string(q1911)" cols="30" rows="3" styleClass="text5"/>
               </td>
            <tr> 
            <tr> 
               <td align="right" height="25" width="25%" class="tdFontcolor" nowrap >                 
               ...
               <td  class="tdFontcolor" nowrap >          
               <html:text styleClass="inputtext"  name="exchangeAppForm" property="ex_vo.string(q1913)"/>                 
               </td>
            <tr> 
            <tr> 
               <td align="right" height="25" width="25%" class="tdFontcolor" nowrap >                 
               ...
               <td class="tdFontcolor" nowrap >  
                 <html:textarea name="exchangeAppForm" property="ex_vo.string(q1915)" cols="30" rows="3" styleClass="text5"/>
               </td>
            <tr> 
         </table>
        </fieldset>
