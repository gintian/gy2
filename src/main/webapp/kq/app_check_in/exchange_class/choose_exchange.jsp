...
{  
         ...
         exchangeClassForm.action="/kq/app_check_in/exchange_class/exchangedata.do?b_change=link";
 ...
 <legend ><bean:message key="kq.approve.idea"/></legend>
  <table width="250" border="0" cellpadding="0"  cellspacing="0" align="center">
      ...
      <tr class="list3">	 
         ...
         <logic:equal name="exchangeClassForm" property="audit_flag" value="1">
           <bean:message key="kq.register.overrule"/>
         </logic:equal>  
         <logic:equal name="exchangeClassForm" property="audit_flag" value="2">
         ...
         <tr class="list3">
            <td>
            	<html:textarea name="exchangeClassForm" property="result"   cols="50" rows="20" style="height:110px;width:100%;font-size:9pt"/>
            	<html:hidden name="exchangeClassForm" property="audit_flag" styleClass="text"/>
             </td>
            </tr>
            <logic:equal name="exchangeClassForm" property="audit_flag" value="1">
              <tr class="list3">
            	...
            	<html:radio name="exchangeClassForm" property="radio" value="01"  /><bean:message key="label.agree"/>&nbsp;&nbsp;&nbsp;
            	<html:radio name="exchangeClassForm" property="radio" value="02"  /><bean:message key="label.nagree"/>&nbsp;&nbsp;&nbsp;
             </td>
            </tr>  
            </logic:equal>             
   </table>        
