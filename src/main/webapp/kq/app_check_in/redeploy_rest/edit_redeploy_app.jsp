...
<script language="javascript">
   ...
   function saveF(outparamters)
   {
     ...
     if(class_id=="0")
     {
       if(confirm("确实要保存吗！"))
       {
          redeployAppForm.action="/kq/app_check_in/redeploy_rest/app_redeploy.do?b_save=link&app_flag=edit&flag="+flag;;
...
<table width="100%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable" style="border-style:solid;border-width:1px;border-color:#C4D8EE;">
 <thead>
   <tr>
	...
	<fieldset align="center" style="width:90%;">
        ...
        <table width="100%"  border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">
            ...
            <tr> 
               ...
               <td  class="tdFontcolor" nowrap >  
               <html:textarea name="redeployAppForm" property="ex_vo.string(q2511)" cols="30" rows="5" styleClass="text5"/>
               </td>
            <tr> 
            <tr> 
               <td align="right" height="25" width="25%" class="tdFontcolor" nowrap >                 
            ...
            <tr> 
               ...
               <td class="tdFontcolor" nowrap >  
                 <html:textarea name="redeployAppForm" property="ex_vo.string(q2515)" cols="30" rows="5" styleClass="text5"/>
               </td>
            <tr> 
         </table>
        </fieldset>
