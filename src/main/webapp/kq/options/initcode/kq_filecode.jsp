...
<script language="JavaScript" >
  ...
  function saveRe()
  {
      ...
      if(flag=="true")
      {
         if(confirm("归档后数据不能还原，您确定要归档所选表的数据吗？"))
         {
         	if (!count_start) {
         		count_start = "";
         	}
        	...
        	waitInfo.style.display="block";
           	...
           	kqInitCodeForm.action="/kq/options/initcode/kq_filecode.do?b_ok=link&count_start="+count_start+"&count_end="+count_end;
...
<html:form action="/kq/options/initcode/kq_filecode" onsubmit="return validate()">
	<br>
<table width="480" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable">
   	  <thead>
           <tr>
            <td align="center" class="TableRow" nowrap>
		&nbsp;<bean:message key="kq.init.filecode"/>&nbsp;	
            </td>            	        	        	        
           </tr>
   	  </thead>
   	   <tr>
               ...
               <fieldset align="center" style="width:95%;">
                 ...
                 <table border="0" cellspacing="0"  align="center" cellpadding="2" width="95%">
                  ...
                  <tr >
                   ...
                   <td align="left" nowrap valign="left">        
                        <html:checkbox name="kqInitCodeForm" property="shift" value="1" /> 排班信息表<!--<bean:message key="kq.init.shift"/>-->        
                   </td>
                   <td align="left" nowrap valign="left">        
        	    ...
        	    <td align="left" nowrap valign="left">          
                  ...
                  <tr>
        	    <td align="left" nowrap valign="left" colspan="4">
                    </td>                    
                  </tr>  
                </table>       
	       </fieldset>
                 ...
                 <table border="0" cellspacing="0" cellpadding="2" width="95%">
                   <tr>
                    <td width="95%">
                      &nbsp;&nbsp;
                      <font color="black">
                      <bean:message key="kq.inti.archive.data.hint"/>
                      <br/>
                      &nbsp;&nbsp;
                      <bean:message key="kq.inti.archive.data.hint2"/>
                      </font>
                    </td>
                    <td align="left">                    
