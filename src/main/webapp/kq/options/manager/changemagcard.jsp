...
function saveSet()
{
   if(confirm("确定保存换卡内容?"))
   {
	 ...
	 var request=new Request({method:'post',asynchronous:false,onSuccess:saveCard,functionId:'15207000076'},hashvo);
	}
}
...
<html:form action="/kq/options/manager/changemagcard">
        ...
        <tr>
          ...
          <fieldset style="width:100%;height:310">
              ...
              <tr> 
                ...
                <td width="35%" class="TableRow" align="center">原值</td>
                <td width="35%" class="TableRow" align="center"><bean:message key='infor.menu.alert.value'/></td>
              ...
              <tr> 
                ...
                <logic:notEqual name="element" property="codesetid" value="0">
                	<logic:equal name="element" property="codesetid" value="UN">
                		<td class="RecordRow"  nowrap>
                		<hrms:codetoname codeid="UN" name="element" codevalue="value" codeitem="codeitem" scope="page"/> 
                        &nbsp;&nbsp;<bean:write name="codeitem" property="codename" /> 
                		</td>                		
                	</logic:equal>
                	<logic:equal name="element" property="codesetid" value="UM">
                		<td class="RecordRow"  nowrap>
                		  <hrms:codetoname codeid="UM" name="element" codevalue="value" codeitem="codeitem" scope="page"/> 
                          &nbsp;&nbsp;<bean:write name="codeitem" property="codename" />  
                		</td>                		
                	</logic:equal>
                	<logic:equal name="element" property="codesetid" value="@K">
                		<td class="RecordRow"  nowrap>
                		  <hrms:codetoname codeid="@K" name="element" codevalue="value" codeitem="codeitem" scope="page"/> 
                          &nbsp;&nbsp;<bean:write name="codeitem" property="codename" /> 
                		</td>
                	</logic:equal>
                		...
                		<logic:notEqual name="element" property="codesetid" value="UM">
                			<logic:notEqual name="element" property="codesetid" value="@K">
                				<td class="RecordRow"  nowrap>
                				    ...
                				    <hrms:codetoname codeid="${element.codesetid}" name="element" codevalue="value" codeitem="codeitem" scope="page"/> 
                                    &nbsp;&nbsp;<bean:write name="codeitem" property="codename" /> 
                				</td>                				
                			</logic:notEqual>
                		</logic:notEqual>
