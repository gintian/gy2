...
<script language="javascript">
  ...
  function addSetCard(outparamters)
  {
	...
	var hidd_card="<input type='hidden' name='r_card' value=''>";
	...
	var cell_1="<TD vAlign='center' align='right' width='50'>"+hidd_card+"&nbsp;</TD>";
	for (i=0;i<2;i++)
        { 
  ...
  function setCardEmp(obj_select)
  {
     var card_no=obj_select.options[obj_select.selectedIndex].value;
     var n=0; 
     if(card_no=="")
     {
       return;
     ...
     if(obj_tr[i].style.backgroundColor==COLOR_SELECTED)
     {
            var obj_td_x=obj_tr[i].getElementsByTagName('td');
            var hidd_id="<input type='hidden' name='r_card' value="+card_no+">";
            var cell_1="<TD vAlign='center' align='right' width='50'>"+card_no+""+hidd_id+"</TD>";
            ...
            obj_td_x[1].innerHTML=cell_1;
            removeCard("card_no",card_no);
            return;
     }  
     }   
  }
...
function saveCard()
{
       ...
       kqCardForm.action="/kq/options/manager/sendcard.do?b_savework=link";       
       kqCardForm.submit();
}
</script>
<hrms:themes /> <!-- 7.0css -->
		...
		<thead>
			<tr>
				<td align="left" class="TableRow" nowrap>
					&nbsp;
					<bean:message key="kq.card.work.send" />
					&nbsp;
		...
		<tr>
			<td class="RecordRow">
				<table width="100%">
					...
					<tr valign="top">
						<td align="center" >
							<div id="tbl_containerll" class="div2  common_border_color" style="vertical-align: top">
											<div id="treemenu" style="text-align: left;" onclick="getemp();" ondblclick="getemp1();">
												<SCRIPT LANGUAGE=javascript>    
						...
						<table width="100%" height="100%">
							...
							<tr>
								<td height="15%" align="center">
								  <input type="button" style="width: 30px;" name="b_addfield" value="&gt;&gt;" class="mybutton" onclick="batch_Emp();">
								</td>
							</tr>
							<tr>
								<td height="15%" align="center">
								<input type="button" style="width: 30px;" name="b_delfield" value="&gt;" class="mybutton" onclick="getemp1();">
								</td>
							</tr>
							<tr>
								<td height="15%" align="center">
								<input type="button" style="width: 30px;" name="Submit2" value="&lt;" class="mybutton" onclick="deleteTR(obj_tr);">
								</td>
							</tr>
							<tr>
								<td height="15%" align="center">
								<input type="button" style="width: 30px;" name="b_delfield" value="&lt;&lt;" class="mybutton" onclick="deleteALL(obj_tr);">
								</td>
							</tr>
							<tr>
								<td height="20%">
						...
						<td rowspan="2">
							...
							<input type='hidden' name='r_card' value="">
							<input type='hidden' name='r_gno' value="">
							<div id="tbl_container" class="div4 common_border_color">
						...
						<td colspan="2">
							<table width="96%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td align="left">
										<hrms:optioncollection name="kqCardForm" property="card_list"
											collection="list" />
										<html:select name="kqCardForm" property="card_no" size="1"
											onchange="setCardEmp(this)">
									...
									<td width="20%">
										...
										<input type="button" name="b_addfield"
											value="<bean:message key="kq.card.auto.createcard"/>"
											class="mybutton" onclick="createCard();">
									</td>
								</tr>
							</table>
						</td>
