...
<script language="javascript">
   ...
   function change()
   {
      kqShiftForm.action="/kq/team/history/search_array_data.do?b_search=link&a_code=${kqShiftForm.a_code}";
      kqShiftForm.submit();
   }   
      function historical(obj)
   {
   	  if(obj.value=="1"){
   	  	  obj.options(0).selected = true;
	      kqShiftForm.action="/kq/team/historical/search_array.do?b_query=link&action=search_array_data.do&target=mil_body&privtype=kq";
  ...
  function excecuteExcel()
   ...
   function viewAll()
   {
       ...
       kqShiftForm.action="/kq/team/history/search_array_data.do?b_search=link&select_flag=0";
       kqShiftForm.submit();
   }
   function show_state(s)
   {
     var state = s.options[s.selectedIndex].value;     
     kqShiftForm.action="/kq/team/history/search_array_data.do?b_search=link&a_code=${kqShiftForm.a_code}&state="+state;
     kqShiftForm.submit();
   }
   function quitRe()
   {
   ...
   function selectflag()
   {
      ...
      kqShiftForm.action="/kq/team/history/search_array_data.do?b_search=link&select_flag=1";
      kqShiftForm.submit();
   }
   ...
   <table width="100%" border="0" cellspacing="1"  align="left" cellpadding="1">
    <tr> 
     ...
     <td align= "left" nowrap>&nbsp;
		  <select onchange="historical(this)">
           	<option value="0">封存数据</option>
         <% 
         	UserView userView=(UserView)session.getAttribute(WebConstant.userView);
         if(1==userView.getVersion_flag()){ %>  	
    ...
    <td align= "left" nowrap>&nbsp;&nbsp;
        ...
        <html:optionsCollection property="session_y_list" value="dataValue" label="dataName"/>
        </html:select> 
        <html:select name="kqShiftForm" property="session_m" size="0" onchange="javascript:change();">
        <html:optionsCollection property="duration_list" value="dataValue" label="dataName"/>
        </html:select>
      ...
      <td align= "left" nowrap>         
          &nbsp;
           ...
           <input type="text" id="select_name" class="inputtext" name="select_name" value="<%= selname %>"  onfocus="dofocus(this)" onblur="doblur(this)";  size="29" style="text-align:left;color:gray;height: 23px;margin-left: -2px ">&nbsp;
