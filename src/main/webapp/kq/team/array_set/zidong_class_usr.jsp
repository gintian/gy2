	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        ...
        <tr> 
          ...
          <td align="left" class="tdFontcolor" nowrap>
           <html:text name="arrayGroupForm" property='end_date' styleId='end_date' size="20" maxlength="20" onchange="rep_dateValue(this);"  onclick='getKqCalendarVar();popUpCalendar(this,this,weeks,feasts,turn_dates,week_dates,false);' styleClass="TEXT4"/>
           </td>
          <!--数据值-->
        </tr>
      </table>	            	
