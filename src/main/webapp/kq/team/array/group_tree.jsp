	...
	if(userView != null)
	{
	  ...
	  if(css_url==null||css_url.equals(""))
	   ...
	   }else
	   {
		 ...
		 if(userView.getKqManageValue() != null && userView.getKqManageValue().length() > 0)
		 {
			 codetiem = userView.getKqManageValue();
...
<SCRIPT LANGUAGE=javascript>
  ...
  var m_sXMLFile= "/kq/team/array/group_list.jsp?params=gp&codetiem="+codetiem+"";	
  var root=new xtreeItem("root","所有班组","/kq/team/array/search_array_data.do?b_search=link&group_id=&a_code=GP","mil_body","所有班组","/images/table.gif",m_sXMLFile);
