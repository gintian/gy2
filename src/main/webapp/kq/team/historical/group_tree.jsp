...
<SCRIPT LANGUAGE=javascript>
  ...
  var m_sXMLFile= "/kq/team/historical/group_list.jsp?params=gp&codetiem="+codetiem+"";	
  var root=new xtreeItem("root","所有班组","/kq/team/historical/search_array_data.do?b_search=link&group_id=&a_code=GP","mil_body","所有班组","/images/table.gif",m_sXMLFile);
