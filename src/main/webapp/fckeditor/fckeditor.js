...
{
	var sFile = 'fckeditor.html';//(/fcksource=true/i).test( window.top.location.search ) ? 'fckeditor.original.html' : 'fckeditor.html' ;//chenmengqing added note domain error
...
FCKeditor.prototype._IsCompatibleBrowser = function()
{
	...
	//IE11—È÷§
	if (sAgent.indexOf('trident') > -1 && sAgent.indexOf("rv:11.0") > -1)	{
		return true;
	}
	...
	//haosl add 20170329 ºÊ»›π»∏Ë°¢edgeµ»‰Ø¿¿∆˜
