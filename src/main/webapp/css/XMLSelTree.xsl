...
<xsl:variable name="LeafImgSrc">/images/NodeImg0.gif</xsl:variable>
<xsl:variable name="BranchImgSrc">/images/NodeImg1.gif</xsl:variable>
...
<xsl:template match="TreeNode">
	...
	<div class="clsItem" type="leaf" onmousedown="NodeMouseDown(this);" onmouseover="NodeMouseOver(this);" onmouseout="NodeMouseOut(this);">
...
<xsl:template match="TreeNode[* or @NodeXMLSrc]">
	...
	<div class="clsItem" type="branch" onmousedown="NodeMouseDown(this);" onmouseover="NodeMouseOver(this);" onmouseout="NodeMouseOut(this);">
		<img type="img" onclick="MouseClick(this)">
			<xsl:attribute name="src">
				<xsl:choose>
					<xsl:when test="@NodeImgSrc">
