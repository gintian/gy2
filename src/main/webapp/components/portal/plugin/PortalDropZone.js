Ext.define('EHR.portal.plugin.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        EHR.portal.plugin.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        EHR.portal.plugin.PortalDropZone.superclass.unreg.call(this);
