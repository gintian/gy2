...
<hrms:themes />
<html:form action="/gz/gz_accounting/addStaff">
<%int i=1;%>
<div id="scroll_box" style="position:absolute;overflow:auto;width:100%;height:510px;padding-bottom: 3px;"><!-- modify by xiaoyun 2014-10-14 薪资审批/编辑/数据比对，新增人员页签中列表缺线 -->
<table border="0" class="ListTable">
	<tr>
		<td align="center" width="20" class="TableRow_right" nowrap>&nbsp;</td>
	...
	<hrms:paginationdb id="element" name="accountingForm" sql_str="accountingForm.sqlstr" table="" where_str="accountingForm.where" columns="accountingForm.column" order_by="accountingForm.orderby" pagerows="20" page_id="pagination" indexes="indexes" curpage="curpage">	
	 ...
	 <%
		...
		<logic:iterate id="tableid2" name="accountingForm" property="tableidlist2" indexId="index">
		<td align="right" class="RecordRow" nowrap>
			<logic:notEqual name="tableid2" property="codesetid" value="0">
				<logic:equal name="tableid2" property="codesetid" value="UM">
					...
					<hrms:codetoname codeid="UN" name="element" codevalue="${tableid2.itemid}_2" codeitem="${tableid2.itemid}" scope="page"/>
					<bean:write name="${tableid2.itemid}" property="codename" />&nbsp;
				</logic:equal>
