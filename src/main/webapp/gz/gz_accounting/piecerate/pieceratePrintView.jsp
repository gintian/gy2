...
%>
<iframe id="fram" frameborder="0"  style="border: 0px;" src="/system/options/customreport/displayExcel.jsp?filename=<%=filename %>" width="100%"></iframe>
<object id="WebBrowser" width=0 height=0 classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2"></object>
<script>
	function downLoadExcel () {
		window.open("/servlet/DisplayOleFile?filename=<%=filename %>");
	}
	setHight();
	function setHight() { 
