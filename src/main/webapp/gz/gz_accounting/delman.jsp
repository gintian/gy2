...
<!--
	...
	function allSelect()
	{
	   changeInfoForm.action="/gz/gz_accounting/delman.do?b_all=all";
	   changeInfoForm.submit();
	}
	function allClear()
	{
	   changeInfoForm.action="/gz/gz_accounting/delman.do?b_clear=clear";
	   changeInfoForm.submit();
	}
//-->
</script>
<html:form action="/gz/gz_accounting/delman">
<br>
