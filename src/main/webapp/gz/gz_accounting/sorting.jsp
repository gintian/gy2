...
<html:form action="/gz/gz_accounting/sorting">
<center>
<table width="390px;" height="300" border="0" align="center">

		<html:hidden name="formulaForm" property="salaryid"/>

  <tr> 
    <td align="center">
    	<fieldset style="height:350">
    	<legend><bean:message key='gz.formula.alert.cond.sort'/></legend>
    	<table width="100%" border="0" align="center">
    	<tr>
    		<td width="80%">
    			<html:select name="formulaForm" property="sort_fields" multiple="multiple" ondblclick="removeitem('sort_fields');" style="height:300px;width:100%;font-size:10pt">
                    <html:optionsCollection property="sortlist" value="dataValue" label="dataName"/>   		      
 		     	</html:select>
    		</td>
    		<td>
    			<table width="100%"  border="0" align="center"  valign="center" height="300">
    				<tr>
    					<td align="center">
