...
<html:form action="/gz/formula/calculating_conditions">
<html:hidden name="formulaForm" property="salaryid"/> 
<table width="510px;" height="350" border="0" align="center">
<tr>
<td align="center">  
		...
		<table width="99%" border="0">
        	<tr> 
          		<td colspan="2" align="center"> 
            		<html:textarea name="formulaForm" property="conditions"  onclick="this.pos=document.selection.createRange();"   style="width:480;height:200px;" styleId="shry"></html:textarea> 
            	</td>
        	</tr>
        	<tr> 
            					...
            					<table width="100%"  border="0" >
              						<tr> 
                						<td height="30"><bean:message key='gz.formula.project'/>
											<html:select name="formulaForm" property="itemid" onchange="changeCodeValue();" style="width:180">
