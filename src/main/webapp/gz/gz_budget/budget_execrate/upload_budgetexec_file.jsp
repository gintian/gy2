...
function upload() {
      if(confirm("确定导入数据吗？导入的数据将覆盖原有数据。")){
    	 var fileEx = budgetExecRateForm.templateFile.value;
        if(fileEx == ""){
        	alert(GZ_TAX_INFO1);
        	return ;
        }
        ...
        jinduo();
		 ...
		 document.budgetExecRateForm.action="/gz/gz_budget/budget_execrate.do?b_upload=validate&tab_id="+document.budgetExecRateForm.tab_id.value;
  		document.budgetExecRateForm.submit();
     }else{
       return;
     }
    }
 function impsucess(outparameters){
 goback();
}
    
    
function goback(){
    document.budgetExecRateForm.action="/gz/gz_budget/budget_execrate.do?b_query=open&tab_id="+document.budgetExecRateForm.tab_id.value;
  	document.budgetExecRateForm.submit();
}
function jinduo(){
...
<hrms:themes />
<body>
<html:form action="/gz/gz_budget/budget_execrate" enctype="multipart/form-data">
<br>
<br>
<br>
<br>
				...
				<table border="0" cellspacing="0" align="center" cellpadding="0">
					<tr>
						<td width="400">
							<Br>
							文件
							<input type="file" name="templateFile" class="text6" size="40">
							<br>
							<br>
