...
e.maxWidth;0<e.ptQueue.size();){console.log(a+"----"+e.ptQueue.size());var c=e.ptQueue.pop();this.curPos=c;e._drawLine(a);this.oldPos=c;a-=a/10}};this._handleMouseDown=function(a){1===a.which&&(e._mouseButtonDown=!0,e._strokeBegin(a))};this._handleMouseMove=function(a){e._mouseButtonDown&&e._strokeUpdate(a)};this._handleMouseUp=function(a){1===a.which&&e._mouseButtonDown&&(e._mouseButtonDown=!1,e._strokeEnd(a))};this._handleTouchStart=function(a){1==a.targetTouches.length&&e._strokeBegin(a.changedTouches[0])};
this._handleTouchMove=function(a){a.preventDefault();e._strokeUpdate(a.targetTouches[0])};this._handleTouchEnd=function(a){a.target===e._canvas&&(a.preventDefault(),e._strokeEnd(a))};this._handleTouchCancel=function(a){a.target===e._canvas&&(a.preventDefault(),e._strokeEnd(a))};this._handleMouseEvents();this._handleTouchEvents()};b.prototype.simulate_mouseevent=function(a,c){if(void 0!==a&&null!==a)if(g.all)a.fireEvent("on"+c);else{var e=g.createEvent("MouseEvents");e.initEvent(c,!0,!0);a.dispatchEvent(e)}};
b.prototype.clear=function(){var a=this._ctx,c=this._canvas;a.fillStyle=this.backgroundColor;a.clearRect(0,0,c.width,c.height);a.fillRect(0,0,c.width,c.height);this._reset()};b.prototype.toDataURL=function(a,c){var e=this._canvas;return e.toDataURL.apply(e,arguments)};b.prototype.fromDataURL=function(a){var c=this,e=new Image,b=window.devicePixelRatio||1,d=this._canvas.width/b,l=this._canvas.height/b;this._reset();e.src=a;e.onload=function(){c._ctx.drawImage(e,0,0,d,l)};this._isEmpty=!1};b.prototype._strokeUpdate=
function(a){a=this._createPoint(a);this._ctx.fillStyle=this.penColor;this._ctx.strokeStyle=this.penColor;this.curPos=a;this._drawLine();this.oldPos=this.curPos};b.prototype._strokeBegin=function(a){for(this._reset();0<this.ptQueue.size();)this.ptQueue.pop();this.oldPos=this._createPoint(a);self.oldPos=self.curPos;this.penPress=0;this.LstTrans=.1;this.LstSize=0;this._ctx.fillStyle=this.penColor;this._ctx.strokeStyle=this.penColor;this.count=0;if("function"===typeof this.onBegin)this.onBegin(a)};b.prototype._strokeDraw=
function(a){var c=this._ctx,e="function"===typeof this.dotSize?this.dotSize():this.dotSize;c.beginPath();this._drawPoint(a.x,a.y,e);c.closePath();c.fill()};b.prototype._strokeEnd=function(a){this.penPress=0;this.oldPos=this.curPos;if("function"===typeof this.onEnd)this.onEnd(a)};b.prototype._handleMouseEvents=function(){this._mouseButtonDown=!1;this._canvas.addEventListener("mousedown",this._handleMouseDown);this._canvas.addEventListener("mousemove",this._handleMouseMove);g.addEventListener("mouseup",
this._handleMouseUp)};b.prototype._handleTouchEvents=function(){this._canvas.style.msTouchAction="none";this._canvas.style.touchAction="none";this._canvas.addEventListener("touchstart",this._handleTouchStart);this._canvas.addEventListener("touchmove",this._handleTouchMove);this._canvas.addEventListener("touchend",this._handleTouchEnd);this._canvas.addEventListener("touchcancel",this._handleTouchCancel)};b.prototype.on=function(){this._handleMouseEvents();this._handleTouchEvents()};b.prototype.off=
