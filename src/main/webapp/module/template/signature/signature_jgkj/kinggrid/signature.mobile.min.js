...
return(b=document.cookie.match(new RegExp("(^| )"+a+"=([^;]*)(;|$)")))?unescape(b[2]):null}function n(a){var b=new Date;b.setTime(b.getTime()-1);var c=m(a);null!=c&&(document.cookie=a+"="+c+";expires="+b.toGMTString())}var q=window.kinggrid,h=window.Signature,r=window.jQuery;"use strict";var t=function(a,b){this.preV={x:null,y:null};this.pinchStartLen=null;this.scale=1;this.isDoubleTap=!1;this.rotate=b.rotate||function(){};this.pointStart=b.pointStart||function(){};this.multipointStart=b.multipointStart||
