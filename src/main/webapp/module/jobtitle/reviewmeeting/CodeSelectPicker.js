 ...
 * 
 * */
Ext.define('ReviewMeetingURL.CodeSelectPicker', {
	xtype: 'codeselectpicker',
	constructor : function() {
		var extraParams = {
	    				//codesource:me.codesource,
					codesetid:jobtitle_reviewconsole.w0575codesetid,
					multiple:true,
			    ...
			    listeners:{
			       load:function(self,records){
			       		for(var k=0; k<records.length; k++){
			       		    if(jobtitle_reviewconsole.ctrl_param.indexOf(","+records[k].get("id")+",") > -1)
	...
	checkTable:function(){
        ...
        jobtitle_reviewconsole.setPersonNum(ids);
	},
