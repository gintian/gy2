...
function onchanges(obj){
	...
	self.parent.location="/org/orgdata/org_tree.do?b_init=link&infor=${orgDataForm.infor}&codeitem="+codeitem;
}
</script> 
...
<table width="100%" border="0" cellspacing="1"  align="center" cellpadding="1" >   
     ...
     <tr>        
           <td align="left"> 
                 <hrms:orgtree action="/org/orgdata/orgdata.do?b_query=link&infor=${orgDataForm.infor}" target="mil_body" flag="0"  loadtype="${orgDataForm.loadtype}" priv="1" lv="1" showroot="false" dbpre="" rootaction="1"/>			           
           </td>
      </tr>            
</table>
</logic:equal>
...
<logic:notEqual name="orgDataForm" property="checkorg" value="UN">
   ...
   <SCRIPT LANGUAGE=javascript>   			
			...
			for(var i=0;i<obj.options.length;i++)
	        {
             ...
             var m_sXMLFile="/org/orgdata/code_tree.jsp?codesetid=${orgDataForm.codeitem}&infor=${orgDataForm.infor}";
                 m_sXMLFile +="&codeitemid="; 
                 m_sXMLFile +="&parentid=";       
             var root=new xtreeItem("root",theName,"/org/orgdata/orgdata.do?b_query=link&infor=${orgDataForm.infor}&a_code=all","mil_body",theName,"/images/unit.gif",m_sXMLFile);
