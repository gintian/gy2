...
<%
   ...
   String userbase=request.getParameter("userbase");
	if (StringUtils.isNotEmpty(a0100)) {
		...
		}else if(StringUtils.isNotEmpty(userbase)){
			a0100=userbase+"`"+PubFunc.decrypt(a0100);
		}else{
	...
	try {
		fieldpriv = PubFunc.encrypt((fieldpriv != null && fieldpriv.length() > 0 ? fieldpriv : "0"));
	...
	String zp_flag=PubFunc.encrypt("zp_noticetemplate_flag");
	String hcmFlag ="hcm";
%>
<script language="JavaScript" src="../../module/utils/js/template.js"></script>
<script language="JavaScript" src="../../module/gz/gz_resource_zh_CN.js"></script><!--未引入，工资资源文件 -->
