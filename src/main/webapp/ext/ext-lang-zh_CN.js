...
Ext.define("Ext.locale.zh_CN.form.field.VTypes", {
    ...
    alphanumText: '该输入项只能包含半角字母,"_"和数字'   //这个不容易看懂,改了一下 '该输入项只能包含半角字母,数字和_'
});
...
//解决Ext menu 的 menuItem 设置href时重复提交问题
Ext.define("Ext.locale.zh_CN.menu.Item",{
