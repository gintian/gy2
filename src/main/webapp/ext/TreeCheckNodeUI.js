...
Ext.extend(Ext.ux.TreeCheckNodeUI, Ext.tree.TreeNodeUI, {renderElements:function (D, I, H, J) {
	...
	if(isIE6()){
	  if (F === null) {
		...
		if (F ===true || F===false) {
			...
			F = this.checkbox.defaultChecked;
		}
	} else {
		this.checkbox.checked = F;
		this.checkbox.defaultChecked = F;
	}
	  G.attributes.defaultChecked = F;
