...
//       } 
    ...
    function getSelectedData(flag)
    {
      ...
      <% } } %>
       ...
       <% if(request.getParameter("def_flow_self")==null&&!request.getParameter("allow_def_flow_self").equals("true")&&(request.getParameter("noObject")==null||request.getParameter("noObject").equals("0"))){ %>
                ...
                <table border="0"  cellspacing="5" class="DetailTable" cellpadding="0" width="400">
                   ...
                   <tr class="list3">
                       ...
                       <td align="left">                                
                        ...
                        <% if(request.getParameter("def_flow_self")==null&&!request.getParameter("allow_def_flow_self").equals("true")&&(request.getParameter("noObject")==null||request.getParameter("noObject").equals("0"))){ %>
                     <tr class="list3" >
                        <td align="right" nowrap style="padding-left:7px;padding-top:5px">
                       ...
                       <td align="left">
                                ...
                                <% } %>                                                                         
                             <INPUT type="text" id="user_" value="" onchange='validateValue()'  class="TEXT" size="18" maxlength="200">
                    ...
                    <tr class="list3">
                     ...
                     <% 
                     //
                     if(request.getParameter("def_flow_self")==null&&!request.getParameter("allow_def_flow_self").equals("true")&&(request.getParameter("message")==null||!request.getParameter("message").equals("0"))){
                        if(!isSendMessage.equals("0")){ %>
                    <tr class="list3">
                        ...
                        <INPUT type="text" id="user_s"  value="${templateForm.user_}" class="TEXT" size="30" maxlenth="200">
                        <img src='/images/del.gif' title='清空抄送人员' onclick='clearObjs()' />     <INPUT type="hidden" id="user_h_s"  value="${templateForm.user_h}"  size=30> 
                        </td>
                    </tr>
                        <% if(email_staff.equalsIgnoreCase("True")){ %>
                            <tr class="list3" ><td colspan="2" align="left">
        ...
        <tr class="list3">
            ...
            <% if(request.getParameter("noObject")==null||request.getParameter("noObject").equals("0")){ %>
                ...
                <% if(request.getParameter("def_flow_self")==null&&enduser.trim().length()>0&&endusertype.trim().length()>0&&!_enduser.equalsIgnoreCase(enduser)){ %>
                    <button extra="button" onclick="subEndUser();">
               ...
               <%if("0".equals(view_type)){ %>
                ...
                <logic:equal name="templateForm" property="startflag" value="0">    
                    <button extra="button" onclick="getSelectedData('2');">
                        <bean:message key="button.reject"/>
                    </button>&nbsp;
                    <% if(isEndTask_flow.equalsIgnoreCase("true")||request.getParameter("def_flow_self")==null){ %>
                    <hrms:priv func_id="010703,32101,33001001,33101001,2701501,0C34801,32001,324010102,325010102,3800701">              
                    <button extra="button" onclick="getSelectedData('3');">
            ...
            %>                  
              <!--   <button extra="button" onclick="showyj();">
