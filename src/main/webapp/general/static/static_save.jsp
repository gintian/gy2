...
<hrms:themes />
<html:form action="/general/static/static_save">
      <br>
      <br>

      <fieldset id="fieldsetHtml" align="center" style="width:18%;">
               ...
               <table width="55%" border="0" cellspacing="1"  align="center" cellpadding="1" bordercolor = "#223377"> 
                 ...
                 <tr class="trDeep1">
                     ...
                     <td align="left"  nowrap valign="center">
            				...
            				<html:hidden property="find"/>
            				<html:hidden property="result"/>
                     </td>
                 </tr>
                  <!-- 【5655】员工管理：简单统计，保存统计条件页面问题  jingq upd 2014.12.03 -->
                 <!-- <tr class="trShallow1"> -->
                 <tr>
...
<script>
    if (!getBrowseVersion() || getBrowseVersion() ==10) {//非IE兼容模式   样式调整      wangb 20190307
        document.getElementsByTagName('fieldset')[0].style.margin = '0 auto';
        document.getElementsByTagName('fieldset')[0].style.minWidth = '260px';
    }
</script>
