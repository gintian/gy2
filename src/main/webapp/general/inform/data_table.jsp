...
<html:form action="/general/inform/get_data_table.do?b_rmain=link">
...
<hrms:menubar menu="menu1" id="menubar1">
  <hrms:menuitem name="gz0" label="infor.menu.base">
        ...
        <hrms:menuitem name="m3" function_id="2606401" label="infor.menu.transbase" visible="${mInformForm.viewbutton}" enabled="true" icon="/images/link.gif" url="shiftlabrary('${mInformForm.dbname}','${mInformForm.tablename}','${mInformForm.a_code}')"/>              
  </hrms:menuitem>
  <hrms:menuitem name="gz1" label="infor.menu.edit" visible="${mInformForm.viewbutton}" function_id="2606402,2606405,2606403,2606404">
    <hrms:menuitem name="m1" function_id="260640201" label="infor.menu.new" enabled="true" visible="${mInformForm.viewbutton}" icon="/images/quick_query.gif" url="append('${mInformForm.tablename}','${mInformForm.a_code}','');" command="" />
    <hrms:menuitem name="m2" function_id="260640301" label="infor.menu.ins" enabled="true" visible="${mInformForm.viewbutton}" icon="/images/deal.gif" url="insert('${mInformForm.tablename}','${mInformForm.a_code}');" command="" />  
    <hrms:menuitem name="m3" function_id="260640401" label="infor.menu.del" enabled="true" visible="${mInformForm.viewbutton}" icon="/images/del.gif" url="" command="delselected" hint="general.inform.search.confirmed.del" />  
  ...
  <hrms:menuitem name="gz2" label="infor.menu.bat" function_id="3233104,3233105,3233108,3233109">
      <hrms:menuitem name="mitem1" function_id="3233104" label="infor.menu.batupdate_s" icon="/images/add_del.gif" url="batchHand(1,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.viewsearch}');" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem2" function_id="3233105" label="infor.menu.batupdate_m" icon="/images/write.gif" url="batchHand(2,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.viewsearch}','${mInformForm.train}');" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem5" function_id="3233108" label="infor.menu.compute" icon="/images/add_del.gif" url="batchHand(5,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.viewsearch}');" command="" enabled="true" visible="true"/>
  	  <hrms:menuitem name="mitem6" function_id="3233109" label="org.gzdatamaint.gzdatamaint.singlecheck" icon="/images/quick_query.gif" url="singleAudit(1,'${mInformForm.dbname}');" command="" enabled="true" visible="true"/>
  </hrms:menuitem>  
  <hrms:menuitem name="gz3" label="infor.menu.query" function_id="3233118,3233119,3233120">
      <hrms:menuitem name="mitem1" function_id="3233118" label="infor.menu.squery" icon="" url="searchInform(1,1,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.inforflag }');" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem2" function_id="3233119" label="infor.menu.hquery" icon="" url="searchInform(1,2,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.inforflag }');" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem3" function_id="3233120" label="infor.menu.gquery" icon="" url="">
      	<%int n=4;%>
      	...
      	<%if(n>10){%>
      	<hrms:menuitem name='<%="mitem"+(n+1)%>' label='general.inform.search.themore' icon="" url="searchInform(1,3,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.inforflag }');" command="" enabled="true" visible="true"/>
      	<%} %>
      </hrms:menuitem>
   ...
   <hrms:menuitem name="gz5" label="infor.menu.print" function_id="3233110,3233111,3233112">
      <hrms:menuitem name="m1" function_id="3233110" label="infor.menu.outmuster" icon="/images/print.gif" url="" command="" enabled="true" visible="true">
      ...
      <hrms:menuitem name="m2" function_id="3233111" label="infor.menu.outcard" icon="/images/print.gif" url="" command="" enabled="true" visible="true">
      ...
      <hrms:menuitem name="m3" function_id="3233112" label="infor.menu.outhmuster" icon="/images/print.gif" url="" command="" enabled="true" visible="true">
  ...
  <hrms:menuitem name="gz4" label="infor.menu.view" function_id="3233113,3233114,3233116,3233117">
      <hrms:menuitem name="mitem1" function_id="3233113" label="infor.menu.picture" icon="/images/man.gif" url="diplaypicture('${mInformForm.tablename}');" command="" enabled="true" visible="true"/>
      <logic:equal name="mInformForm" property="inforflag" value="1">
      
      <hrms:menuitem name="mitem2" function_id="3233115" label="infor.menu.media" icon="/images/prop_ps.gif" url="to_multimedia_tree('${mInformForm.tablename}','${mInformForm.dbname}');" command="" enabled="true" visible="true"/>

      </logic:equal> 
      <hrms:menuitem name="mitem3" function_id="3233114" label="infor.menu.msort" icon="/images/sort.gif" url="to_sort_main_info();" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem5" function_id="3233116" label="infor.menu.hide" icon="" url="to_hide_field();" command="" enabled="true" visible="true"/>
      <hrms:menuitem name="mitem6" function_id="3233117" label="infor.menu.sortitem" icon="/images/sort.gif" url="to_sort_field();" command="" enabled="true" visible="true"/>
  </hrms:menuitem>   
</hrms:menubar>
</td></tr></table>
</td>
...
<bean:define id="rflag" name="mInformForm" property="returnvalue" />
...
sql="${mInformForm.sql}" pagerows="${mInformForm.pagerows}" keys="${mInformForm.keys}" buttons="movefirst,prevpage,nextpage,movelast">
   ...
   <hrms:commandbutton name="compute" function_id="3233108" functionId="" refresh="true" visible="true" type="selected" setname="${mInformForm.tablename}" onclick="batchHand(5,'${mInformForm.a_code}','${mInformForm.dbname}','${mInformForm.viewsearch}');">
     <bean:message key="button.computer"/>
   </hrms:commandbutton> 
   <hrms:commandbutton name="lietable" function_id="2600,32331" hint="" functionId="" visible="true" refresh="true" type="selected" setname="${mInformForm.tablename}" onclick="lietable();" >
     <bean:message key="kjg.title.listtable"/>
   </hrms:commandbutton> 
   <%if("dxt".equals(rflag)&&(bosflag.equals("hl")||bosflag.equals("hcm"))){%>
   <hrms:commandbutton name="firstpage" function_id="2600,32331" hint="" functionId="" visible="true" refresh="true" type="selected" setname="${mInformForm.tablename}" onclick="returnFirst('${mInformForm.inforflag}');" >
...
<div id="movDiv" class="viewPhoto" onmousedown="getFocus(this)" style="display:none">
	<table width="85" border="0" cellspacing="0" cellpadding="0" class="ListTable1">
		<tr>
			<td class="TableRow" style="cursor:move;height:10; border-right: none;" onmousedown="MDown(movDiv)">
			<div id="realName"></div></td>
			<td align="right" style="border-left: none;" class="TableRow"><img src="/images/del.gif" onclick="closePhoto();"></td>
		</tr>
		<tr>
			<td class="appblack complex_border_color" align="center" colspan="2">
				<iframe id="ole" name="ole" height="120" frameborder="0" width="500" scrolling="no"  src="#"></iframe> 
			</td>
		</tr>
		<tr>
			<td align="center" class="TableRow" colspan="2">
				<table align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td nowrap="nowrap" align="center">
							...
							<img src="/images/viewSmall.gif" style="margin-left: -8px" onclick="minSize();" border="0">
						<td>
	...
	<iframe src="javascript:false" class="aframephoto">
	</iframe>
</div>
...
function checkOnlyName(outparamters){
	...
	if(itemcheck=='ok'){
		...
		if (itemarr!=null&&trim(itemarr).length>0) {
...
function table${mInformForm.tablename}_onRowClick(table){
    ...
    parent.ril_body2.location="/general/inform/get_data_table.do?b_menu=link&a0100="+a0100+"&dbname=${mInformForm.dbname}";
...
function lietable(){
	self.parent.location = "/general/inform/get_org_tree.do?b_query=link&inforflag=${mInformForm.inforflag}&vorg=0&lies=1&modleflag=1";
}
