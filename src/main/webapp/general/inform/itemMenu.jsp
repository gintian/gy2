...
<html:form action="/general/inform/get_data_table">
		...
		ArrayList list = mInformForm.getSetlist();
		...
		<hrms:tabset name="cardset" width="100%" height="98%" type="true" >
			...
			<logic:iterate id="element" name="mInformForm" property="setlist" indexId="index">
				<%
				...
				%>
				<logic:equal name="mInformForm" property="defitem" value="<%=fieldid%>">
					<%
						menuname = "mitem"+i;
					//	tabstr.append("<img src=\"/images/cc1.gif\">");
					%>
				</logic:equal>
				<% 
				...
				<hrms:tab name='<%="mitem" + i%>' label="<%=fielddesc %>"
					...
					url="/general/inform/get_data_table.do?b_item=link&a0100=${mInformForm.a0100}&dbname=${mInformForm.dbname}&fieldid=${nid}&inforflag=${mInformForm.inforflag}">
				</hrms:tab>
				<%} %>
			</logic:iterate>
		</hrms:tabset>
