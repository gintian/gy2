...
<script language="javascript">
	function saveorgoption()
	{	
		orgMapForm.action="/general/inform/org/map/setorgmapoption.do?b_save_report_relation=link";		
   		orgMapForm.submit();
	}
 	function return_pos()
	{
		//orgMapForm.action="/general/inform/org/map/setorgmapoption.do?b_return_report_relation=link";
		//orgMapForm.action="/pos/posreport/report_relations_tree.do?b_search=link";
		//orgMapForm.target="mil_body";
		orgMapForm.action="/pos/posreport/search_report_relations.do?b_search=link&position=";
   		orgMapForm.submit();
	}
	...
	function save()
	{
	   if(checkText())
	   {
	     if(ifqrbc())
	     {
	        orgMapForm.action="/general/inform/org/map/setorgmapoption.do?b_save=link&code=${orgMapForm.code}&kind=${orgMapForm.kind}&orgtype=${orgMapForm.orgtype}";
   	        orgMapForm.submit();
	     }
	   }
	...
	function returnr()
	{
	   orgMapForm.action="/general/inform/org/map/setorgmapoption.do?b_return=link&code=${orgMapForm.code}&kind=${orgMapForm.kind}&orgtype=${orgMapForm.orgtype}";
   		orgMapForm.submit();
	}
function checkText()
{
...
<div style="z-index:1">
<html:form action="/general/inform/org/map/setorgmapoption"> 
<html:hidden name="orgMapForm" property="report_relations" />
         ...
         <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
           ...
           <tr>
               ...
               <logic:equal name="orgMapForm" property="graphaspect" value="true">
                 <html:radio name="orgMapForm" property="graphaspect" value="false"><bean:message key="general.inform.org.graphvaspect"/></html:radio> 
                 <html:radio name="orgMapForm" property="graphaspect" value="true"><bean:message key="general.inform.org.graphhaspect"/></html:radio> 
               </logic:equal>
              ...
              <td align="left"  nowrap valign="top">
                   <table width="100%" border="0" cellspacing="1"  align="center" cellpadding="1">
                        ...
                        <tr>
                         ...
                         <logic:equal name="orgMapForm" property="orgtype" value="1">
                           <tr>
                           <td align="right"  nowrap> 
                                显示职位
                           </td>
                           <td align="left"  nowrap >
                           <html:checkbox name="orgMapForm" property="isshowposname" value="true"></html:checkbox>     
                           </td>
                           </tr>                          
                        </logic:equal>
                    </table> 
 ...
 <br>
 <br>
  <logic:equal name="orgMapForm" property="ishistory" value="0">
  <fieldset align="center" style="width:90%;">
         <legend ><bean:message key="label.institutions"/></legend>
         <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
           <tr>
              <td align="left"  nowrap>
         ...
         <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
          <tr>
              <td align="left"  nowrap>
                   ...
                   <html:select name="orgMapForm" property="dbnames" size="1">                   
           ...
           <tr>
              <td align="left"  nowrap>
                  <html:checkbox name="orgMapForm" property="isshowpersonname" value="true"><bean:message key="general.inform.org.isshowpersonname"/></html:checkbox>     
               </td>
           </tr>
           
           <!--<tr>
              <td align="left"  nowrap>
                  <html:checkbox name="orgMapForm" property="namesinglecell" value="true" disabled = "true"><bean:message key="general.inform.org.namesinglecell"/></html:checkbox> 
               </td> 
           </tr>-->
         </table>
      </fieldset>   
 ...
 <br>
 <fieldset align="center" style="width:90%;">
         <legend >机构图输出设置</legend>
         <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
            <tr>
               <td align="left" width="200"  nowrap colspan="2">    
                               单位级数&nbsp;&nbsp;
                           <html:select name="orgMapForm" property="unitlevel">
            ...
            <tr>
               ...
               <td align="left"  nowrap >
                           &nbsp;<html:checkbox name="orgMapForm" property="isshowdeptname" value="true"></html:checkbox>     
                               &nbsp;&nbsp;&nbsp;&nbsp; 部门级数&nbsp;&nbsp;
                           <html:select name="orgMapForm" property="deptlevel">
                                <html:option value=""></html:option>
                                <html:option value="1">&nbsp;&nbsp;1&nbsp;&nbsp;</html:option>
                                <html:option value="2">&nbsp;&nbsp;2&nbsp;&nbsp;</html:option>
                                <html:option value="3">&nbsp;&nbsp;3&nbsp;&nbsp;</html:option>
 ...
 <br>
      ...
      <logic:equal name="orgMapForm" property="report_relations" value="yes">
         <fieldset align="center" style="width:90%;">
           <legend><bean:message key="kq.wizard.other"/> </legend>
            <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
           <tr>
              <td align="left"  nowrap style="padding-bottom: 10px;">
                  <html:checkbox name="orgMapForm" property="isshowposup" value="true"><bean:message key="pos.report.relations.showposup"/></html:checkbox>    
               </td>
           </tr>
         </table>
         </fieldset>
     ...
     <table width="80%" border="0" cellspacing="1"  align="center" cellpadding="1">
           <tr>
             <td align="center"  nowrap>
              ...
              <logic:equal name="orgMapForm" property="report_relations" value="no" >
              ...
              <logic:equal  name="orgMapForm" property="report_relations" value="yes" >
              		<input type="button" name="savebutton"  value="<bean:message key="button.save"/>" class="mybutton" onclick="saveorgoption()">              		
         			<input type="button" name="returnbutton"  value="<bean:message key="button.return"/>"  class="mybutton" onclick="return_pos()"> 
              </logic:equal>
               </td> 
           </tr>
         </table>            
