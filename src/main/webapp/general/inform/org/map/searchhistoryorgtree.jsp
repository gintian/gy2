...
<html:form action="/general/inform/org/map/searchorgmap"> 
            <div id="treemenu" style="margin:0px; padding:0 5px;width:auto; height: 100%; overflow: auto;">
             <SCRIPT LANGUAGE=javascript>    
               <bean:write name="orgMapForm" property="treeCode" filter="false"/>
             </SCRIPT>
             </div>             
</html:form>
<script language="javascript">
...
<script language="javascript">
  initDocument();
 parent.document.getElementById("center_iframe").scrolling="no";
</script>