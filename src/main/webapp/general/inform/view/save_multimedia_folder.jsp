...
function sub(){
	...
	if(foldername!=null && foldername.length>0)
	{
		...
		//add by xiegh on 20171205 多媒体增加文件夹名称
		...
		if(subcallback && subcallback.length>0 && "null"!=subcallback){
			...
			window.opener[subcallback](arrays);
			window.close();
			return;
		}
...
<td align="center">  
	...
	<tr>
	<td align="center">  
	<input type="text" class="text4" id="foldername" name="foldername" size="25" maxlength="20" onkeypress="event.returnValue=IsDigit(this)" onkeydown="NoExec()">
	</td>
	</tr>
	<tr>
	<td align="center">  
