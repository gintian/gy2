...
<script type="text/javascript">
	function clickok(){//update by xiegh on date20171125 修改自助服务-员工信息-信息审核：浏览器兼容问题：驳回按钮
		var contentObj=document.getElementById("content");
 		if(contentObj&contentObj.value.length == 0) {
			window.alert("请填写退回原因！");
			return ;
		} 
...
<html:form action="/org/orginfo/searchorgtree"> 
  ...
  <tr><td colspan="2">退回原因：</td></tr>
  <tr>
  	<td align="left"><textarea rows="19" cols="62" id="content" style="border: 1pt solid #A8C4EC;" ></textarea> </td>
  	<td align="center" valign="top">
  		<input name="ok" type="button" class="mybutton" value="<bean:message key="button.ok"/>" onclick="clickok()"/> <br/><br/>
