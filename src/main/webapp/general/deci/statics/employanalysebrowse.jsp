...
<% MakeupAnalyseForm makeupAnalyseForm=(MakeupAnalyseForm)session.getAttribute("makeupAnalyseForm");
   if(makeupAnalyseForm.getInfofieldlist().size()>0){%>   

<table width="98%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable3">
 <html:hidden name="makeupAnalyseForm" property="dbpre"/> 
 <html:hidden name="makeupAnalyseForm" property="a0100"/> 
<logic:iterate  id="element"    name="makeupAnalyseForm"  property="infofieldlist" indexId="index"> 
  ...
  <tr>
   <td align="center">
      <logic:equal name="makeupAnalyseForm" property="returnphoto" value="0">
          <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/general/deci/statics/employmakeupanalysebrowse.do?br_return1=link','nil_body')">                 
      </logic:equal>
       <logic:equal name="makeupAnalyseForm" property="returnphoto" value="1">
          <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/general/deci/statics/employmakeupanalysebrowse.do?br_photo1=link','nil_body')">                 
      </logic:equal>
    </td>
  </tr>
 </table> 
