...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("auto_upload", false);//自动上传开关[true=开自动上传,false=关自动上传] add by stephen
...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, 'px" height="', this.settings.button_height, 'px" class="mybutton"','style="margin-bottom:-4px;cursor: pointer;" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000">',
