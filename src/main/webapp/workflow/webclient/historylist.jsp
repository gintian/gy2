...
<html:form action="/workflow/webclient/historylist">
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
   	  <thead>
          ...
          %>  
            ...
            <td align="center" class="RecordRow" nowrap>
                    <bean:write  name="element" property="instance_id" filter="true"/>&nbsp;
	        </td>
            ...
            <td align="center" class="RecordRow" nowrap>
            	<a href="/workflow/webclient/view_historytask.do?b_viewhistorytask=link&a_definition=<bean:write name="element" property="definition_id" filter="true"/>&a_instance_id=<bean:write name="element" property="instance_id" filter="true"/>&a_advice_id=<bean:write name="element" property="id" filter="true"/>" >浏览</a>
	    </td>		        	        	        
          </tr>
        </hrms:extenditerate>
