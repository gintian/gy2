...
<title>移动eHR</title>
     <link rel="stylesheet" href="../phone-app/css/login.css" type="text/css">
...
<body style="background-image:url(../phone-app/images/login/bck.gif);	background-repeat:repeat-x;">
	<html:form focus="username" action="/phone-app/index" >
	<div id="box">
	  <div id="logo"></div>
	  <div id="content">
		<table class="text" border="0" cellspacing="0" cellpadding="0" style="margin:auto;position: relative;top: 10px;">
					   ...
					   <tr style="height: 80px">
					     <td  colspan="2" align="center">&nbsp;
	                          <input name="logon" type="image" src="../phone-app/images/login/hj_04.gif" TABINDEX="3">  
					     </td>
					   </tr>						   
	    </table>	
