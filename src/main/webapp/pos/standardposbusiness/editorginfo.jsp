...
<script language="javascript">
  ...
  {
    var tag=true;    
     <logic:iterate  id="element"    name="standardPosForm"  property="infofieldlist" indexId="index"> 
  ...
  function check()
  {
    var code="${standardPosForm.a_code}";
    var kind="${standardPosForm.a_code}";
    if(code==""||kind=="")
    {
       alert("请选定所要操作的职位信息!");
       return false; 
  ...
  function exeReturn(returnStr,target)
{
 ...
 // window.open(target_url,target); 
   standardPosForm.action=returnStr;
   standardPosForm.target=target;
...
<html:form action="/pos/standardposbusiness/searchposlist" onsubmit="return validate()">
...
<logic:iterate  id="element"    name="standardPosForm"  property="infofieldlist" indexId="index"> 
      ...
      <logic:equal name="element" property="itemtype" value="D">
        <%
         ...
         <td align="left"  nowrap valign="top">
             &nbsp;<html:text   name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' readonly="true" styleClass="text6" maxlength="${element.itemlength}" />  &nbsp;&nbsp;&nbsp;&nbsp; 
      ...
      <logic:equal name="element" property="itemtype" value="A">
       ...
       <logic:equal name="element" property="itemtype" value="N">
          ...
          if(flag==0){
           ...
           <td align="left"  nowrap valign="top">
               &nbsp;<html:text  name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' readonly="true" styleClass="text6" maxlength="${element.itemlength + element.decimalwidth +1}" />  &nbsp;&nbsp;&nbsp;&nbsp; 
           </td>
         <%if(flag==0){%>
           </tr>
         <%}else{%>
            ...
            %>
             ...
             flag=1;%>
                 ...
                 <td align="left"  nowrap valign="top"  colspan="3">
                  &nbsp;<html:textarea name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' readonly="true"  rows="5"  cols="66" />&nbsp;&nbsp;&nbsp;&nbsp; 
                    <logic:equal name="element"  property="fillable" value="true">
                    <font color="red">*</font>
                    </logic:equal>
                 </td> 
    ...
    <logic:notEqual name="element" property="codesetid" value="0">
          ...
          if(flag==0){
           ...
           <td align="left"  nowrap valign="top">
                 <html:hidden name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' />  
                    &nbsp;<html:text name="standardPosForm" property='<%="infofieldlist["+index+"].viewvalue"%>' readonly="true"  styleClass="text6" /> &nbsp;&nbsp;&nbsp;&nbsp; 
                <logic:equal name="element"  property="fillable" value="true">
                    <font color="red">*</font>
                    </logic:equal>
           </td>
   ...
   <logic:equal name="element" property="priv_status" value="2"> 
    <logic:equal name="element" property="codesetid" value="0">
      <logic:equal name="element" property="itemtype" value="D">
        <%
         ...
         <td align="left"  nowrap valign="top">
             &nbsp;<input type="text" name='<%="infofieldlist["+index+"].value"%>' value="<bean:write name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>'/>" style='BACKGROUND-COLOR:#F8F8F8;border: 1pt solid #A8C4EC;width:150' extra="editor" itemlength=${element.itemlength } dataType="simpledate" dropDown="dropDownDate"/>&nbsp;&nbsp;&nbsp;&nbsp; 
              <logic:equal name="element"  property="fillable" value="true">
                    <font color="red">*</font>
                    </logic:equal>
         </td> 
      ...
      <logic:equal name="element" property="itemtype" value="A">
         ...
         <td align="left"  nowrap valign="top">
            &nbsp;<html:text  name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' styleClass="text6" maxlength="${element.itemlength}" />  &nbsp;&nbsp;&nbsp;&nbsp; 
             <logic:equal name="element"  property="fillable" value="true">
                    <font color="red">*</font>
                    </logic:equal>
         </td>
       ...
       <logic:equal name="element" property="itemtype" value="N">
          ...
          if(flag==0){
           ...
           <td align="left"  nowrap valign="top">
               &nbsp;<html:text  name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>' styleClass="text6" maxlength="${element.itemlength + element.decimalwidth +1}" /> &nbsp;&nbsp;&nbsp;&nbsp; 
                     <logic:equal name="element"  property="fillable" value="true">
                    <font color="red">*</font>
                    </logic:equal>
           </td>
          ...
          if(flag==0){
            ...
            %>
             ...
             flag=1;%>
                 ...
                 <td align="left"  nowrap valign="top"  colspan="3">
                  &nbsp;<html:textarea name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>'  rows="5"  cols="66"/>&nbsp;&nbsp;&nbsp;&nbsp; 
                     <logic:equal name="element"  property="fillable" value="true">
                      <font color="red">*</font>
                     </logic:equal>
                 </td> 
    ...
    <logic:notEqual name="element" property="codesetid" value="0">
          ...
          if(flag==0){
           ...
           <td align="left"  nowrap valign="top">
              <html:hidden name="standardPosForm" property='<%="infofieldlist["+index+"].value"%>'/>  
              &nbsp;<html:text name="standardPosForm" property='<%="infofieldlist["+index+"].viewvalue"%>'  styleClass="text6" onchange="fieldcode(this,2);checkDict('${element.codesetid}',this);" onkeyup="addDict('${element.codesetid}',this);" onkeydown="return inputType2(this,event)" onclick="styleDisplay(this);"/>  
 ...
 <tr>
  <td  width="100%" align="center"  nowrap colspan="4">
    &nbsp;&nbsp;<html:hidden name="standardPosForm" property="edittype"/> 
        <html:hidden name="standardPosForm" property="edit_flag"/> 
        <html:hidden name="standardPosForm" property="first"/> 
        <html:hidden name="standardPosForm" property="a_code"/>       
        <logic:equal name="standardPosForm" property="setprv" value="2">
          <logic:equal name="standardPosForm" property="edit_flag" value="new">
           <hrms:submit styleClass="mybutton"  property="b_save" onclick='return check();'>
                    <bean:message key="button.save"/>
	       </hrms:submit>   
	       </logic:equal>
	       <logic:notEqual name="standardPosForm" property="edit_flag" value="new">
	     ...
	     <logic:equal name="standardPosForm" property="edit_flag" value="new">
	        <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/workbench/dutyinfo/searchdutyinfodata.do?b_query=link&code=${standardPosForm.a_code}','nil_body')">
	     </logic:equal>
	     <logic:notEqual name="standardPosForm" property="edit_flag" value="new">
           <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/workbench/dutyinfo/searchdutyinfodata.do?b_query=link&code=${standardPosForm.return_codeid}','nil_body')">                 
          </logic:notEqual>
  </td>
 </tr>
   <tr>
