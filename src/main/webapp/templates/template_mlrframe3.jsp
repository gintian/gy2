...
<frameset cols="250,*"  bordercolor='#DCEFFE' framespacing="2" >
  <frame src="<hrms:insert parameter="HtmlMenu" />" frameborder="1"  name="mil_menuto" scrolling="auto" >
  <frame src="<hrms:insert parameter="HtmlBody" />" frameborder="1"  name="mil_bodyto" scrolling="auto" >
</frameset>
 <%}%>
  <%if(ver>40){%>
 <script type="text/javascript">
	...
	<%if(!"true".equals(framedegrade)){%>
		...
		header:false,
		 ...
		 region:'west' 
		,width:180 
		,html:'<iframe src="<hrms:insert parameter="HtmlMenu" />" name="mil_menuto" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe> ' 
		,collapsible:false
		,split:true 
		,collapseMode:'mini' 
			,border:<%=bborder%>
		...
		header:false,
		 region:'center' 
	    ,margins:'-1 -1 -1 0'			 
		,html:'<iframe src="<hrms:insert parameter="HtmlBody" />" name="mil_bodyto" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe> ' 
			,border:<%=bborder%> 
		}] 
		}); 
