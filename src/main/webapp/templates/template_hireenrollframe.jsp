...
<frameset rows="128,*,21" border="0" frameborder="no">
  ...
  <frameset cols="170,*" border="0" frameborder="no">
     <frame src="<hrms:insert parameter="HtmlMenus"/>" frameborder="no" name="mil_menu" scrolling="auto" >
     <frame src="<hrms:insert parameter="HtmlBody"/>" frameborder="no" name="mil_body" scrolling="auto" >
  </frameset>
