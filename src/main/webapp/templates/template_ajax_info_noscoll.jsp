...
<%
	...
	String browser=userView.getBrower();	
...
<%if(browser.equalsIgnoreCase("Trident") || browser.equalsIgnoreCase("Gecko")) {%>  <!--ie--内核判断出错不严谨 非兼容性ie11 内核为 Gecko wangbs 20190305-->
...
<body style="margin:10 0 0 0;overflow-x:hidden;overflow-y:hidden" onKeyDown="return pf_ChangeFocus(event);" >
