...
<frameset cols="250,*"  bordercolor='#DCEFFE' framespacing="2" >
  <frame src="<hrms:insert parameter="HtmlMenu" />" frameborder="1"  name="mil_menu_child" scrolling="auto" >
  <frame src="<hrms:insert parameter="HtmlBody" />" frameborder="1"  name="mil_body_child" scrolling="auto" >
</frameset>
 <%}%>
  <%if(ver>40){%>
	...
	Ext.onReady(function() { 
	 <%if(!"true".equals(framedegrade)){%>
		...
		header:false,
		 ...
		 region:'west' 
		,width:180 
		,html:'<iframe src="<hrms:insert parameter="HtmlMenu" />" name="mil_menu_child" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe> ' 
		,collapsible:false
		,split:true 
		,collapseMode:'mini' 
			,border:<%=bborder%>
		...
		header:false, 
		 region:'center' 
	    ,margins:'-1 -1 -1 0'			 
		,html:'<iframe src="<hrms:insert parameter="HtmlBody" />" name="mil_body_child" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe> ' 
			,border:<%=bborder%>
		}] 
		}); 
	});  
