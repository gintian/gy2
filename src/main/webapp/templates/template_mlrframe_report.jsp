	...
	Ext.onReady(function() { 
		...
		header:false,
		 ...
		 items:[
		    ...
		    ,margins:'-1 -1 -1 -1'
		    ,height:250
			,html:'<iframe src="<hrms:insert parameter="HtmlBody2" />" name="ril_body2" id="center_iframe" scrolling="yes" width="100%" height="100%" frameborder="0"></iframe> '
			,split:true 				
			,collapsible:false
			,collapseMode:'mini' 				 
				,border:<%=bborder%> 
		...
		//var splitter2 = b[1];
		//var button = splitter2.firstChild;
