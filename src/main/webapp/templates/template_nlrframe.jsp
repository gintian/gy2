...
<frameset cols="200,*"  bordercolor='#DCEFFE' framespacing="2" >
 ...
 <script type="text/javascript">
    var menupnl;
    var pad=false;
    var htmlmenu='<iframe src="<hrms:insert parameter="HtmlMenu" />" name="nil_menu" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>';
    var htmlbody='<iframe src="<hrms:insert parameter="HtmlBody" />" name="nil_body" id="center_iframe" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>';
