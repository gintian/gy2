...
<frameset name='forum' cols="200,*" border="0" frameborder="no">
  <frame src="<hrms:insert parameter="HtmlMenu" />" frameborder="no" name="mil_menu" scrolling="auto" noresize>
  <frame src="/templates/right_frame_k.jsp?url=<hrms:insert parameter="HtmlBody" />" frameborder="0" name="mil_body" scrolling="auto">
</frameset>
