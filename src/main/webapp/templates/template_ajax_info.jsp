...
<html>
<head>
<meta name="format-detection" content="telephone=no"><!--add by xiegh on date 20180212 bug34899  -->
...
<body style="margin:<%if("hcm".equals(bosflag)){ %>10px<%}else{%>0<%}%> 0 0 5px;" onKeyDown="return pf_ChangeFocus(event);" >
...
<script language="javascript">
  ...
  //应聘简历导出下拉菜单特殊样式处理
  var buttons = document.getElementsByName("hire_export_dropdown_button");
  if(buttons != null){
	    var themes = "<%=themes %>";
	    var colors="";
	    if(themes=="default"){
