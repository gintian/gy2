...
<body onKeyDown="return pf_ChangeFocus(event);" style="margin:0 0 0 0;overflow-x:hidden;overflow-y:hidden">

<table id="table" width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>  
    <td valign="top">
