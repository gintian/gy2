        ...
        if(this.portal.fireEvent('validatedrop', dropEvent) !== false &&
           this.portal.fireEvent('beforedrop', dropEvent) !== false){
            ...
            /*for(var n=0;n<result.length;n++){
            	alert(result[n].id+"  "+result[n].col);
            }*/
            
            /*var hashvo=new ParameterSet();
			hashvo.setValue("result",result);
			hashvo.setValue("cols",cols);
			hashvo.setValue("portalid",portalid);
			var request=new Request({method:'post',asynchronous:false,onSuccess:null,functionId:'1010010069'},hashvo);*/
	        var map = new HashMap();
