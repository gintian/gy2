...
<table cellpadding=0 cellspacing=0 width="169" class=menu_table>
  <tr style="cursor:hand;">
    <td align="center" class=menu_title  id=menuTitle1 onclick="menuChange(menu1,divHeight,menuTitle1,arrow1);"><span><span id=arrow1><img src="../../images/darrow.gif" border=0></span>组织机构</span></td>
  </tr>
  <tr>
    <td>
   ...
   <form name="static" action="" method="post">
     <table cellpadding=2 cellspacing=3 align=center width="100%"  class="DetailTable" style="position:relative;top:10px;">
            ...
            <tr>
              <td  align="center" class="loginFont" ><hrms:link href="/org/orginfo/searchorgtree.do?b_query=link&code=${userView.managePrivCodeValue}" target="il_body" function_id="xxx"><img src="/images/employee.gif" border=0></hrms:link></td>
            </tr>
            <tr>
            ...
            <tr>
              <td  align="center" class="loginFont" ><a href="/hire/resource_plan/search_resource_list.do?b_query=link" target="il_body"><font id="a003" class="menu_a" >组织机构图</font></a></td>
            </tr> 
            ...
            <tr>
              <td  align="center" class="loginFont" ><a href="/hire/resource_plan/search_resource_list.do?b_query=link" target="il_body"><font id="a003" class="menu_a" >查阅历史组织机构</font></a></td>
            </tr> 
