...
function changbutton(id) 
{
  ...
  function isclose()
  {
  	if(confirm("确定要注销吗？"))
  	{
   		var url = "/templates/index/zfwlogon.jsp";
        ...
        <td  valign="top">
           <table border="0" align="right" cellpadding="0" cellspacing="2">
            <tr>
			    ...
			    <td align="left">	
			            <hrms:link href="/selfservice/welcome/zfwcredit.do?br_query=link" target="i_body" ><img src="/images/home_1.gif" border=0 title="<bean:message key="label.banner.home"/>"></hrms:link>
		  			<% if(status==4){%>						
