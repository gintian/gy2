...
<%
    ...
    try
    {
	     ...
	     isopen_2=(String)map.get("34");//34是薪资管理
    }catch(Exception e)
    {
...
function changbutton(id) 
{
  ...
  {
    logonForm.action="/templates/index/employLogon.do?logon.x=link";
...
<form name="logonForm" method="post" action="/templates/index/UserLogon.do">
           ...
           <tr> 
             ...
             <td class="bgToptitleRight" valign="bottom">
          	  <table  border="0" align="right" cellpadding="0" cellspacing="0" width="400">
                     ...
                     <tr align="left">
          	     	  <td valign="middle" style="color:black"><%=verdesc%>
          	     	  </td>                     
	          	      <td>
						...
						<hrms:priv func_id="3013,000103" module_id=""> 							
						  <input name="reenter" type="image" src="/images/reenter.gif" title="<bean:message key="label.banner.relogin"/>" onclick="logout();">
						</hrms:priv> 						  
 	 ...
 	 <table  border="0"  align=right cellpadding="0" cellspacing="0"  width="100%">
  	 <tr>		
		      ...
		      <hrms:priv func_id="324" module_id="8">                    
                  <td class=top_button_v width="68" id="gz" onclick="javascript:changbutton('gz')"><A href="/templates/menu/gz_m_menu.do?b_query=link&module=8&isopen=<%=isopen_2%>" target='i_body'>薪资管理</A></td>                           
    		  </hrms:priv>	
    		  ...
    		  <hrms:priv func_id="327" module_id="28">                    
                  <td class=top_button_v width="68" id="gz_ins" onclick="javascript:changbutton('gz_ins')"><A href="/templates/menu/gz_ins_menu.do?b_query=link&module=16" target='i_body'>薪资福利</A></td>                           
    		  </hrms:priv>
		      ...
		      <hrms:priv func_id="300" module_id="11">                   
				...
				<%
				 ...
				 { 
				%>                          
				  <td class=top_button_v width="68" id="selfCenter" onclick="javascript:changbutton('selfCenter')"><A href="javascript:submitWinopen();"><bean:message key="label.selfservice.os"/></A></td>
				<%}%>	
