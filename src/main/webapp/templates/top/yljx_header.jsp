...
function changbutton(id) 
{
  ...
  {
    logonForm.action="/templates/index/yljxlogon.do?logon.x=link";
  ...
  function isclose()
  {
  	if(confirm("确定要注销吗？"))
  	{
   		var url = "/templates/index/yljxlogon.jsp";
        ...
        <td  valign="top">
           <table border="0" align="right" cellpadding="0" cellspacing="2">
            <tr>
			    ...
			    <td align="left">	
			            <hrms:link href="/selfservice/welcome/yljxcredit.do?b_query=link" target="i_body" ><img src="/images/home_1.gif" border=0 title="<bean:message key="label.banner.home"/>"></hrms:link>
