...
function changbutton(id) 
{
   ...
   function logout()
  {
  	if(confirm("确定要注销吗？"))
  	{
   		...
   		url="/servler/sys/logout?flag=14";
  ...
  {
    logonForm.action="/templates/index/UserLogon.do?logon.x=link";
...
<body topmargin="0" bottommargin="0" style="margin:0 0 0 0" onbeforeunload="">
<form name="logonForm" method="post" action="/templates/index/employLogon.do">
