...
<%ShowKhResultForm s = (ShowKhResultForm) session
			...
			String object_id=(String)objectList.get(0);
...
<!--
function onscore(){
	showKhResultForm.action="/performance/showkhresult/objectkh.do?b_query=link&opertor=2&object_id=<%=object_id%>";
...
<html:form action="/performance/showkhresult/objectkh">
	<br />
		...
		<tr>
			...
			<html:hidden name="showKhResultForm" property="flag"/>
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>						
								<bean:message key="tree.unroot.undesc" />:<bean:write name="showKhResultForm" property="ocname"/>
								&nbsp;
								<logic:notEqual value="${showKhResultForm.objectname}"  name="showKhResultForm" property="ocname">
								<%
									if(s.getOdname()!=null){
								%>
								<bean:message key="tree.umroot.umdesc" />:<bean:write name="showKhResultForm" property="odname"/>
								&nbsp;
								<%}%>
								</logic:notEqual>
								<bean:message key="lable.appraisemutual.examineobject" />:<bean:write name="showKhResultForm" property="objectname"/>
				...
				<table  width="<%=tablewidth%>" border="0" cellspacing="0" align="left" cellpadding="0" class="ListTable">
					...
					<hrms:paginationdb id="element" name="showKhResultForm" sql_str="showKhResultForm.sql" table="" where_str="showKhResultForm.where" columns="showKhResultForm.column" order_by="showKhResultForm.orderby" pagerows="15" page_id="pagination"
	                  ...
	                  <tr class="trShallow">	
							...
							<bean:write name="element" property="mainame" />
							</td>
							<%
		...
		<tr>
			<td colspan="1000" class="RecordRowP" style="border-left:none;">
				<table width="100%">
					...
					<tr>
					<td colspan="1000" style="padding-left:5px;padding-top:5px;">
