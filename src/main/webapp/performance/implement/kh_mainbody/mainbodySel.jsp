...
<SCRIPT LANGUAGE=javascript src="/js/xtree.js"></SCRIPT>
<SCRIPT LANGUAGE=javascript src="/js/validate.js"></SCRIPT>
<html:form action="/performance/implement/kh_mainbody/mainbodySel">
...
<script>
	var m_sXMLFile	= "/performance/implement/kh_mainbody/mainbody_type_tree.jsp?planID=${implementForm.planid}";		
	var newwindow;
	var root=new xtreeItem("root","所有类别","/performance/implement/kh_mainbody/mainBodyList.do?b_query=link&code=all","mil_body","所有类别","/images/add_all.gif",m_sXMLFile);
