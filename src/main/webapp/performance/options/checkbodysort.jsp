...
{ 
	...
	var request=new Request({method:'post',asynchronous:false,
     	onSuccess:showFieldList,functionId:'9026001007'},hashvo);
}
function showFieldList(outparamters)
{
	...
	if(base=='ok')
	{
		...
		}else if(parent.parent.window.opener){
			parent.parent.window.opener.window.reflesh();
		}else{
	 		parent.parent.toSorting_ok("ok");
		}
		sort_close();
	}else
	{
...
<center>
<table width="490px;" height="300" border="0" align="center">

	<input type="hidden" id="bodyType" name="bodyType" value="${checkBodyObjectForm.bodyType}" />
  <tr> 
    <td>
    	...
    	<tr>
    		<td width="100%">
    			<html:select name="checkBodyObjectForm" property="sort_fields" multiple="multiple"  style="height:243px;width:100%;font-size:10pt" >
