...
<script>
	var m_sXMLFile	= "/performance/options/kh_relation/mainbody_type_tree.jsp";		
	var newwindow;
	var root=new xtreeItem("root","所有类别","/performance/options/kh_relation/mainBodyList.do?b_query=link&code=all","mil_body","所有类别","/images/add_all.gif",m_sXMLFile);	
