...
function savevalue(saveflag){
   <% int m=0; if(log_type.equals("1")){ %>
	<logic:iterate  id="element"    name="weekWorkplanForm"  property="jihuaFieldsList" indexId="index"> 
   ...
   <%}else{%>
      <logic:iterate  id="element"    name="weekWorkplanForm"  property="zongjieFieldsList" indexId="index"> 
   ...
   <%}%>
   weekWorkplanForm.action = "/performance/nworkplan/week/searchWeekWorkplan.do?b_save=link&saveflag="+saveflag;
...
<tr height="20">
	...
	<logic:equal value="1" name="weekWorkplanForm" property="type">
	   <logic:equal value="2" name="weekWorkplanForm" property="log_type">
		新增周总结
		</logic:equal>
	   <logic:equal value="1" name="weekWorkplanForm" property="log_type">
		新增周计划
		</logic:equal>
		</logic:equal>
		<logic:equal value="2" name="weekWorkplanForm" property="type">
		<logic:equal value="2" name="weekWorkplanForm" property="log_type">
		修改周总结
		</logic:equal>
	   <logic:equal value="1" name="weekWorkplanForm" property="log_type">
...
<html:hidden property="planYear_start"/>
<html:hidden property="planMonth_start"/>
<html:hidden property="planDay_start"/>
<html:hidden property="planYear_end"/>
<html:hidden property="planMonth_end"/>
<html:hidden property="planDay_end"/>
<html:hidden property="summarizeYear"/>
<html:hidden property="summarizeTime"/>
</html:form>
</div>
<br/>
<table width="95%" border="0" cellspacing="0"  align="center" cellpadding="0">
