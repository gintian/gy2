  	...
  	if(plan_id=='')
  	{
	  	...
	  	if(obj)
	  	{
	    	...
	    	if(objfirst)
	    	{
	    		...
	    		setUnderlingObjectiveForm.action="/performance/objectiveManage/setUnderlingObjective/underling_objective_list.do?b_init=init&posid=-1&a0100=-1&plan_id="+objfirst.uid+"&opt=1";
