...
<script language="jscript">
   ...
   　       var request=new Request({asynchronous:false,onSuccess:save_ok,functionId:'1010010056'},hashvo);        
	   }
	   function save_ok()
	   {
	   	alert("保存成功！");
...
<html:form action="/system/security/kq_class_priv"> 
...
<SCRIPT LANGUAGE=javascript>
  ...
  var m_sXMLFile= "/system/security/kq_class_tree.jsp?params=1%3D1";	 
  var root=new xtreeItem("root","基本班次","","","基本班次","/images/add_all.gif",m_sXMLFile);
