...
<script language="javascript">
   ...
   <script language="JavaScript">
   	...
   	function savecode()
   	{
    	   ...
    	   if(isAccord==1)
    	   {
	    	   if(input_code_id==null||input_code_id.length<1)
	    	     return ;  
	    	}  
	    	if(codeitemid=='root'){
...
<table width="100%" border="0" cellspacing="1" align="center"
			...
			<tr align="left">
				<td valign="top" nowrap>
					<bean:message key="column.name" />&nbsp;&nbsp;<Input class=text4 type='text' name='a_name' style="width: 255px;" id="selectname" onkeyup="showDateSelectBox('selectname')" title='' />
				</td>
			</tr>
			<tr>
				<td align="left" style="padding: 0;margin: 0;">
				   <div id="treemenu" style="height: 300px;width:290px; overflow: auto;border: solid 1px;" class="complex_border_color"></div>
				</td>
			</tr>
			<tr>
				<td height="5px"></td>
   ...
   <SCRIPT LANGUAGE=javascript>
             var codesetid,codevalue,name,itemdesc;
