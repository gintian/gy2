   ...
   function change()
   {
	...
	function searchFieldList()
	{
	   ...
	   var In_paramters="tablename="+tablename;
   	   var request=new Request({method:'post',asynchronous:false,parameters:In_paramters,onSuccess:showFieldList,functionId:'1010020805'});
	}	
...
<html:form action="/system/options/standardduty_param">
											...
											<tr>
												<td align="center">
													<select name="left_fields" multiple="multiple"
														...
														style="height: 220px; width: 100%; font-size: 9pt">
													</select>
												</td>
											</tr>
										</table>
