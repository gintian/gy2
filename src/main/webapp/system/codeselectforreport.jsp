...
<tr><td align="left" valign="top" height="330px;">
   <div id="treemenu" style="height: 330px;width:290px;overflow: auto;border-style:solid ;border-width:1px;margin-top:5px;"></div>
   <SCRIPT LANGUAGE=javascript>
             ...
             /* 此处注释掉，因为下边使用处早已经注释掉了，这段代码无用，还会报错 guodd 2018-5-22
             try {
             eval(paraArray[4]);
             } catch(e) {
             	alert("属性设置错误！");
   ...
   <tr><td style="padding-top:5px;" align="center" valign="top">
