...
<script language="javascript">
  ...
  {  	  
	...
	//	return false;
     ...
     var request=new Request({method:'post',onSuccess:showSelect,functionId:'1010100127'},hashvo);
   }	
   ...
   function searchFieldList()
	...
	function MusterInitData()
	{
	   ...
	   hashvo.setValue("type","init");
   	   var request=new Request({method:'post',asynchronous:false,onSuccess:showSetList,functionId:'1010100125'},hashvo);
	}
