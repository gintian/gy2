...
<script language="javascript">
  ...
  {  	  
     ...
     var request=new Request({method:'post',onSuccess:showSelect,functionId:'1010100108'},hashvo);
   }	
   ...
   function searchFieldList()
	...
	function MusterInitData()
	{
	   ...
	   hashvo.setValue("type","init");
   	   var request=new Request({method:'post',asynchronous:false,onSuccess:showSetList,functionId:'1010100107'},hashvo);
	}
...
<html:form action="/sys/export/SearchHrSyncFiled">
	...
	<table width="530" border="0" cellspacing="0" align="center"
					...
					<tr>
								...
								<tr>
									<td align="center">
										<select name="left_fields" multiple="multiple"
											...
											style="height: 229px; width: 100%; font-size: 9pt">
										</select>
									</td>
								</tr>
							</table>
						...
						<td width="46%" align="center">
							<table width="100%">
								...
								<tr>
									<td width="100%" align="left">
										<html:select styleId="right" name="hrSyncForm"
											property="right_fields" multiple="multiple" size="2"
											ondblclick="removeitem('right_fields');"
											style="height:250px;width:95%;font-size:9pt">
										</html:select>
									</td>
								</tr>
								<!-- tr>
		...
		<tr>
			<td align="center" class="RecordRow" nowrap colspan="3" style="padding-top:5px;padding-bottom:5px;">
				<input type="button" name="btnreturn" value='确定' class="mybutton"
					onclick=" savefield();">
				<input type="button" name="btnreturn" value='关闭' class="mybutton"
					onclick="winclose();">
			</td>
		</tr>
	</table>
