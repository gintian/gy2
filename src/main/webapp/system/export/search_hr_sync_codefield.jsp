...
<script language="javascript">
  ...
  {  	  
     ...
     var request=new Request({method:'post',onSuccess:showSelect,functionId:'1010100115'},hashvo);
   }	
   ...
   { 
     ...
     if(types=="ok")
     {
		...
		thevo.mess=mess;
		if(parent.parent.Ext && parent.parent.Ext.getCmp('select_codefield')){
			 parent.parent.Ext.getCmp('select_codefield').return_vo = thevo;	
		}else{
   ...
   function searchFieldList()
	...
	{
	   var hashvo=new ParameterSet();
   	   var request=new Request({method:'post',asynchronous:false,onSuccess:showSetList,functionId:'1010100112'},hashvo);
	}
    ...
    function winclose(){
    	 if(parent.parent.Ext && parent.parent.Ext.getCmp('select_codefield')){
			var win = parent.parent.Ext.getCmp('select_codefield');
			win.close();
			return;
		}
    	 window.close();
...
<table width="530" border="0" cellspacing="0"  align="center" cellpadding="0" class="RecordRow">
		...
		<bean:message key="label.query.selectfield"/>&nbsp;&nbsp;
                ...
                <tr>
                 <td align="center"  width="46%">
                   <table align="center" width="100%">
                    ...
                    <tr>
                       <td align="center">
                         <html:select styleId="left" name="hrSyncForm" property="left_fields" multiple="multiple" size="10" ondblclick="additem('left_fields','right_fields')" style="height:230px;width:100%;font-size:9pt">
	 		     	  	 </html:select>
                    </td>
	           ...
	           <html:button  styleClass="smallbutton" property="b_delfield" onclick="removeitem('right_fields');" style="margin-top:30px;">
                ...
                <td width="46%" align="center">
	                 <table width="100%">
	                  ...
	                  <tr>
	                  <td width="100%" align="left">
	                  <html:select styleId="right" name="hrSyncForm" property="right_fields" multiple="multiple" size="10" ondblclick="removeitem('right_fields');" style="height:230px;width:100%;font-size:9pt">
	 		     	  </html:select>     
	                  </td>
	                  </tr>
	                  </table>             
          ...
          <tr>
          <td align="center" class="RecordRow" nowrap  colspan="3" height="35px;" style="padding-top:5px;padding-bottom:5px;">
