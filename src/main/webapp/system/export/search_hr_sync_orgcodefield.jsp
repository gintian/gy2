...
<script language="javascript">
  ...
  {  	  
     ...
     var request=new Request({method:'post',onSuccess:showSelect,functionId:'1010100117'},hashvo);
   }	
   ...
   { 
     ...
     if(types=="ok")
     {
		...
		thevo.mess=mess;
		if(parent.parent.Ext && parent.parent.Ext.getCmp('select_orgcodefield')){
			 parent.parent.Ext.getCmp('select_orgcodefield').return_vo = thevo;	
		}else{
   ...
   function searchFieldList()
	...
	function MusterInitData()
	{
	   ...
	   hashvo.setValue("type","init");
   	   var request=new Request({method:'post',asynchronous:false,onSuccess:showSetList,functionId:'1010100114'},hashvo);
	}
    ...
    function winclose(){
    	 if(parent.parent.Ext && parent.parent.Ext.getCmp('select_orgcodefield')){
			var win = parent.parent.Ext.getCmp('select_orgcodefield');
			win.close();
			return;
		}
    	 window.close();
