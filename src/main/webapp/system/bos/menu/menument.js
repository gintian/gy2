...
//自动选中绩效任务书
	function autoSelectNode()
	{
		...
		{
			parent.mil_body.location="/system/bos/menu/menuMain.do?b_search=query&onePage=1&target_id=-1";
...
//保存业绩任务书标准值
  ...
  {
  	    var theurl="/system/bos/menu/menuMain.do?b_editMenu=new`menuid="+id;
    	var iframe_url="/general/query/common/iframe_query.jsp?src="+theurl;
   		var retvo= window.showModalDialog(iframe_url, 'template_win', 
