...
/***/
	...
	function submitUpload()
	{
	  ...
	  {
	  	  submitDATA();
		  	menuMainForm.action="/system/bos/menu/menuMain.do?b_query=link";
		  menuMainForm.target="il_body";
	      menuMainForm.method="post";
	      menuMainForm.enctype="multipart/form-data";
	      menuMainForm.submit();
      }else
      {
...
<hrms:themes></hrms:themes> 
  ...
  <table border="1" width="37%" cellspacing="0" cellpadding="4" class="table_style" height="87" align="center">
    ...
    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td valign="top">
					<form name="menuMainForm" method="post" action="/system/bos/menu/menuMain.do" enctype="multipart/form-data">
						<table width="500" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:-8px;">
							<tr height="20">
