...
//	}
		...
		colwidth= getEncodeStr(colwidth);
	 	document.portalMainForm.action="/system/bos/portal/portalMain.do?b_findadd=add&portal_name="+portal_name+"&portal_id="+portal_id+"&parentid="+parentid+"&colwidth="+colwidth+"&colnum="+colnum+"&opt="+opt;
				...
				<thead>
					<tr>
						<td align="left" class="TableRow">
							<bean:message key="lable.portal.main.addcolumn" />
							&nbsp;
						</td>
					</tr>
				</thead>
					...
					<td align="center" class="RecordRow" nowrap>
						<table border='0'>
							...
							<tr>
								...
								<td>
									<html:text name="portalMainForm" property="addportal_id" styleClass="textColorWrite" onkeyup="value=checkComments(this.value)"  onkeypress = "checkForm()"/>
								</td>
							</tr>
							<tr>
								<td align="right" height="30">
								...
								<td>
									<html:text name="portalMainForm" property="addportal_name" styleClass="textColorWrite" onkeyup="value=checkComments(this.value)"  onkeypress = "checkForm()"/>
								</td>
							</tr>
							<tr>
								<td align="right" height="30">
								...
								<td>
									<html:text name="portalMainForm" property="colwidth" styleClass="textColorWrite" onkeyup="value=checkComments(this.value)"  onkeypress = "checkForm()"/>
								</td>
							</tr>
