...
//自动选中绩效任务书
	function autoSelectNode()
	{
		...
		{
			parent.mil_body.location="/system/bos/portal/portalMain.do?b_search=query&onePage=1&target_id=-1";
...
//保存业绩任务书标准值
  ...
  {
  	    var theurl="/system/bos/portal/portalMain.do?b_editPortal=new`portalid="+id;
    	var iframe_url="/general/query/common/iframe_query.jsp?src="+theurl;
   		var retvo= window.showModalDialog(iframe_url, 'template_win', 
  		...
  		{
  			parent.mil_portal.alterTreeNode(retvo)
  		}
  }
  ...
  //	parent.mil_portal.delTarget2(target_id);
  }
