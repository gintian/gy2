...
<html:form action="/selfservice/propose/viewconsulant">
<center>
      <table width="500" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:6px;">
          ...
          <tr height="20">
       		...
       		<td align="left" colspan="4" class="TableRow"><bean:message key="lable.consult.repair"/>&nbsp;</td>              	      
          </tr> 
          <tr>
               ...
               <table border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">     
                      <tr class="list3" height="200">
                	      ...
                	      <td align="left"  nowrap valign="top" width="500" style="word-break:break-all"> 
                	        ...
                	        <div style="width:100%;height:220px;overflow:auto;"><bean:write  name="consulantForm" property="consulantvo.string(ccontent)" filter="false"/>&nbsp;</div>
                              </td>
                      </tr> 
            ...
            <td colspan="4" class="framestyle3" width="500">
               <table border="0" cellpmoding="0" cellspacing="0"  class="DetailTable"  cellpadding="0">     
                      <tr class="list3" height="200">
                	      ...
                	      <td align="left"  nowrap valign="top" width="500" style="word-break:break-all">
                	      	<%--当显示文字多了，不显示滚动条     bug 34941 wangb 20180226 --%>
                	        <div style="width:100%;height:200px;overflow:auto;"><bean:write  name="consulantForm" property="consulantvo.string(rcontent)" filter="false"/>&nbsp;</div>
                          </td>
                      </tr> 
