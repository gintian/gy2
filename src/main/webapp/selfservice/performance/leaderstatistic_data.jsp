...
<script language='javascript' >
	function reShow(showType)
	{
		...
		document.statisticForm.action="/selfservice/performance/leaderstatisticdata.do?b_search=query&showtype="+showType+"&planNum=${statisticForm.planNum}&planFlag=1";
		document.statisticForm.submit();
	}

</script>

<html:form action="/selfservice/performance/leaderstatisticdata">
...
<table width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="ListTable">
  <tr> 
    ...
    <td width="44%" valign="top" class="RecordRow"  <logic:notEqual name="statisticForm" property="showAppraiseExplain" value="true"> colspan='3' </logic:notEqual>  >&nbsp;<br>
    	<table>
    	        <tr>
    		  <td align="right">
    		...
    		%>
    			...
    			<tr>
    				<td class="tdFontcolor">
    				 ...
    				 &nbsp;&nbsp;<bean:write name="element" property="itemScore" filter="true"/>
    				</td>
    			</tr>
    			<tr>
    				<td>
...
<logic:notEqual  name="statisticForm" property="drawingFlag" value="2" >
