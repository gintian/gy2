      ...
      <table width="500" border="0" cellpadding="0" cellspacing="0" align="center">
          ...
          <tr class="list3">
            <td align="center" style="height:35px;">
               <table><tr><td>
         	<hrms:submit styleClass="mybutton" property="b_save" onclick="document.itemForm.target='_self';validate( 'R','itemvo.string(name)','项目名称','RD','first_date.','发布日期','RD','second_date.','结束日期','RI','itemvo.string(days)','调查天数');return (document.returnValue && ifqrbc());">
...
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
		...
		<bean:message key="conlumn.investigate_item.name"/>&nbsp;
             ...
             <td align="center" class="TableRow" nowrap>
		<bean:message key="conlumn.investigate_item.viewpoint"/>&nbsp;
	    </td>
		...
		<bean:message key="conlumn.investigate_item.additem"/>&nbsp;
          ...
          %>  
            ...
            <td align="left" class="RecordRow" nowrap>
             ...
             <td align="center" class="RecordRow" nowrap>
            	<a href="/selfservice/infomanager/askinv/searchoutline.do?b_query=link&itemid=<bean:write name="element" property="string(itemid)" filter="true"/>&itemName=<bean:write name="element" property="string(name)" filter="true"/>"><img src="/images/edit.gif" border=0></a>
	    </td>
