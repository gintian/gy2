...
<html:hidden styleId="oldName" name="outlineForm" property="oldName" />
     <table table width="70%" border="0" cellspacing="0" style="margin-top:6px;" align="center" cellpadding="0"> 
     <tr>
     <td align="center" valign="center" nowrap colspan="10" class="educationtitle">
     	<img src="/images/shimv.gif">&nbsp;<bean:message key="conlumn.investigate_point.maintopic"/>&nbsp;<img src="/images/shimv1.gif">
     </td>
     </tr>
     </table>
      <table width="70%" border="0" cellpadding="0" cellspacing="0" align="center" class="ftable common_border_color">
      	  <tr height="30">
       		<td colspan="2" align="left" class="TableRow"><bean:message key="lable.investigate_point.repair"/>&nbsp;</td>
          </tr> 

                     <tr class="list3"><td align="right" width="40%" nowrap valign="center"><bean:message key="conlumn.investigate_item.name"/></td>
                     <td width="200">
                      ...
                      <tr class="list3">
                	      <td align="right"  valign="center"> <bean:message key="conlumn.investigate_point.name"/></td>
          ...
          <tr class="list3">
            <td align="center" colspan="2" style="height:35px;">
         	<hrms:submit styleClass="mybutton" property="b_save" onclick="document.outlineForm.target='_self';validate( 'R','outlinevo.string(name)','要点名称');return (document.returnValue && check() && ifqrbc());">
...
var newName = document.getElementById("pointName");
