...
<html:form action="/selfservice/educate/edulesson/edulesson">
 <br>
 <table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" >
 		...
 		<img src="/images/shimv.gif">&nbsp;<bean:message key="conlumn.infopick.educate.edulesson.edulesson"/>&nbsp;<img src="/images/shimv1.gif">
 		</td>
 		</tr>
 </table>
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
   	  <thead>
           ...
           <tr>
            ...
            <td align="center" class="TableRow" nowrap>
			<hrms:fieldtoname name="eduLessonForm" fieldname="R4112" fielditem="fielditem"/>
			<bean:write name="fielditem" property="dataValue"/>&nbsp;
	    </td>
                       
	     <td align="center" class="TableRow" nowrap>
			<hrms:fieldtoname name="eduLessonForm" fieldname="R4116" fielditem="fielditem"/>
			<bean:write name="fielditem" property="dataValue"/>&nbsp;
	    </td>
	    <logic:iterate id="elementcol" name="eduLessonForm" property="dynamicCol">
	    <%
		...
		<hrms:fieldtoname name="eduLessonForm" fieldname="<%=str%>" fielditem="fielditem"/>
		<bean:write name="fielditem" property="dataValue"/>&nbsp;
	    </td>  
	    </logic:iterate>  
          ...
          <hrms:extenditerate id="element" name="eduLessonForm" property="eduLessonForm.list" indexes="indexes"  pagination="eduLessonForm.pagination" pageCount="10" scope="session">
          <%
          if(i%2==0)
          {
          %>
          ...
          %>  
            ...
            <td align="right" class="RecordRow" nowrap>
                   <bean:write name="element" property="r4112" filter="true"/>&nbsp;
	    </td> 
	    <td align="right" class="RecordRow" nowrap>
                   <bean:write name="element" property="r4116" filter="true"/>&nbsp;
	    </td> 
	    <logic:iterate id="elementcol" name="eduLessonForm" property="dynamicCol">
...
<table  width="70%" align="center">
		<tr>
		          ...
		          <p align="right"><hrms:paginationlink name="eduLessonForm" property="eduLessonForm.pagination"
				nameId="eduLessonForm" propertyId="roleListProperty">
				</hrms:paginationlink>
			</td>
		</tr>
</table>
