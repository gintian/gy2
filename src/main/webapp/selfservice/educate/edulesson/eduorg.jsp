...
<html:form action="/selfservice/educate/edulesson/eduorg">
<br> 
 <table width="70%" border="0" cellspacing="1"  align="center"  cellpadding="1"  >
 		...
 		<img src="/images/shimv.gif">&nbsp;<bean:message key="conlumn.infopick.educate.edulesson.eduorg"/>&nbsp;<img src="/images/shimv1.gif">
 		</td>
 		</tr>
 </table>
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
   	  <thead>
           ...
           <tr>
			...
			<hrms:fieldtoname name="organizationForm" fieldname="R0102" fielditem="fielditem"/>
			<bean:write name="fielditem" property="dataValue"/>&nbsp;
            </td>           
            <logic:iterate id="elementcol" name="organizationForm" property="dynamicCol">
	    <%
		...
		<hrms:fieldtoname name="organizationForm" fieldname="<%=str%>" fielditem="fielditem"/>
		<bean:write name="fielditem" property="dataValue"/>&nbsp;
	    </td>  
	    </logic:iterate>  	   
          ...
          <hrms:extenditerate id="element" name="organizationForm" property="organizationForm.list" indexes="indexes"  pagination="organizationForm.pagination" pageCount="10" scope="session">
          <%
          if(i%2==0)
          {
          %>
          ...
          %>  
            <td align="center" class="RecordRow" nowrap>
     		   <bean:write name="element" property="r0102" filter="true"/>&nbsp;
	    </td>            
             <logic:iterate id="elementcol" name="organizationForm" property="dynamicCol">
...
<table  width="70%" align="center">
		<tr>
		          ...
		          <p align="right"><hrms:paginationlink name="organizationForm" property="organizationForm.pagination"
