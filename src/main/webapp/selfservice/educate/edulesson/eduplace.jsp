...
<html:form action="/selfservice/educate/edulesson/eduplace">
 <br>
 <table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" >
 		...
 		<img src="/images/shimv.gif">&nbsp;<bean:message key="conlumn.infopick.educate.edulesson.eduplace"/>&nbsp;<img src="/images/shimv1.gif">
 		</td>
 		</tr>
 </table>
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
   	  <thead>
           ...
           <tr>
			...
			<hrms:fieldtoname name="eduPlaceForm" fieldname="R1011" fielditem="fielditem"/>
			<bean:write name="fielditem" property="dataValue"/>&nbsp;
            </td>           
            <logic:iterate id="elementcol" name="eduPlaceForm" property="dynamicCol">
	    <%
		...
		<hrms:fieldtoname name="eduPlaceForm" fieldname="<%=str%>" fielditem="fielditem"/>
		<bean:write name="fielditem" property="dataValue"/>&nbsp;
	    </td>  
	    </logic:iterate>  	   
          ...
          <hrms:extenditerate id="element" name="eduPlaceForm" property="eduPlaceForm.list" indexes="indexes"  pagination="eduPlaceForm.pagination" pageCount="10" scope="session">
          <%
          if(i%2==0)
          {
          %>
          ...
          %>  
            <td align="center" class="RecordRow" nowrap>
     		   <bean:write name="element" property="r1011" filter="true"/>&nbsp;
	    </td>            
            <logic:iterate id="elementcol" name="eduPlaceForm" property="dynamicCol">
...
<table  width="70%" align="center">
		<tr>
		          ...
		          <p align="right"><hrms:paginationlink name="eduPlaceForm" property="eduPlaceForm.pagination"
				nameId="eduPlaceForm" propertyId="roleListProperty">
				</hrms:paginationlink>
			</td>
		</tr>
</table>
