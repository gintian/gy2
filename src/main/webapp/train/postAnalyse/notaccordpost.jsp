...
function selectQ()
{
       ...
       var  return_vo= window.showModalDialog(thecodeurl, "", 
              "dialogLeft:"+dl+"px;dialogTop:"+dt+"px;dialogWidth:700px; dialogHeight:400px;resizable:no;center:yes;scroll:no;status:no"); 
      if(return_vo!=null){
   ...
   function search(){
	   trainStationForm.action="/train/postAnalyse/notaccordpostwork.do?b_searchlesson=link";
	   trainStationForm.submit();
	}
</script> 
<style type="text/css">
...
<tr>
   <td align="left"  nowrap>
    <table  border="0" cellspacing="0" height="30"  cellpadding="0">
     <tr>
        <td nowrap width="20">
           &nbsp;
        </td>
            ...
            <tr>
              ...
              <td>                
               ...
               <td style="padding-left: 5px;">
                ...
                <input type="button" class="mybutton" value="培训分析报表" onclick="search();"/>
              </td>
            </tr>
         </table> 	      
        </td>         
	     ...
	     <logic:iterate id="info"    name="trainStationForm"  property="browsefields">   
                   ...
                   <logic:notEmpty name="trainStationForm" property="ishavepostdesc">
                      <logic:equal name="trainStationForm" property="ishavepostdesc" value="true">
                       <bean:define id="e01a1" name="element" property="e01a1"/>	
				        <%
				        	//liuy 2015-6-17 10164：培训管理-培训分析-岗位培训分析-不符合本岗位的培训要求-岗位说明书和基本情况表（表格内没有显示内容）
		    ...
		    <logic:notEqual name="trainStationForm" property="cardid" value="-1">
	    			 <td align="center" class="RecordRow" style="border-left: none;border-top: none;" nowrap>&nbsp;
               			<a href="###" onclick='openwin("/general/inform/synthesisbrowse/synthesiscard.do?b_search=link&userbase=${trainStationForm.dbpre}&a0100=<%=PubFunc.encrypt(a0100.toString()) %>&inforkind=1&tabid=${trainStationForm.cardid}&multi_cards=-1");'>
