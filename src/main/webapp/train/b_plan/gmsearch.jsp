...
<table width="100%" border="0" align="center">
  ...
  <tr> 
    <td height="290" rowspan="3" align="center">
     <fieldset style="width:100%;">
     <legend><bean:message key='selfservice.query.queryfield'/></legend>
     <table width="100%" border="0" align="center">
        <tr> 
          <td height="280"> 
          <html:select name="planTrainForm" property="item_field" multiple="multiple" ondblclick="additemtr('item_field');" style="height:280px;width:100%;font-size:9pt"> 
          ...
          <td height="160" valign="top"> 
            <div id="strTable"> 
              <table width="100%" id="tablestr" border="0" class="ListTable1">
                <tr> 
                  <td align="center" class="TableRow" width="15%"><bean:message key='label.serialnumber'/></td>
      	...
      	<table width="100%" border="0">
    		<tr> 
    			<td height="70" valign="top"> 
      				<textarea name="cond" cols="55" onblur="setLogicArr();" rows="4"></textarea>
      			</td>
      		</tr>
      		<tr> 
...
<tr> 
    ...
    <td height="25" >
    	<table width="100%" border="0">
    		<tr>
    			<td width="20%">
    				<input type="button" name="save" value="<bean:message key='button.save'/>" onclick='checkCond(2,"${planTrainForm.tablename}","${planTrainForm.type}");' Class="mybutton">
    			</td>
    			<td width="20%">
    				<input type="button" name="searchok" value="<bean:message key='button.query'/>" onclick='checkCond(1,"${planTrainForm.tablename}","${planTrainForm.type}");' Class="mybutton"> 
    			</td>
    			<td  width="20%">
...
editTable("${planTrainForm.searchstr}");
</script>