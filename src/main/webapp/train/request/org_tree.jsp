  ...
  <table width="100%" border="0" cellspacing="1"  align="center" cellpadding="1" >   
     ...
     <tr>        
           <td align="left"> <!-- viewunit="<%=viewunit%>" -->
                 <hrms:orgtree action="/train/request/trainsData.do?b_query=link&model=1" target="ril_body1" flag="0" nmodule="6" loadtype="1" priv="1" showroot="false" dbpre="" rootaction="1"/>			           
           </td>
      </tr>            
   </table>
</html:form>
