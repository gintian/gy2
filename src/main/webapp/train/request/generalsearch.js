...
function searchSetCond(){
	...
	if(obj.checked)
		like="1";	
	document.getElementById("sexpr").value=condstr;
	document.getElementById("sfactor").value=condlogic;
	var urlstr="/general/inform/search/generalsearch.do?b_search=link&like="+like;
	searchInformForm.action=urlstr;
...
function addTable(itemid,desc,type,codesetid){
	...
	if(type=='N'){
		tabelstr+="<input type=\"text\" name=\""+id+".value\" class=\"text4\"";
		...
		if(codesetid=="0"){
			tabelstr+="<input type=\"text\" name=\""+id+".value\" style=\"width:120px\" class=\"text4\">";
		}else{
			tabelstr+="<input type=\"text\" onblur=\"hzvalueTovalue('"+id+"');\" name=\""+id+".hzvalue\" class=\"text4\" style=\"width:120px\">";
