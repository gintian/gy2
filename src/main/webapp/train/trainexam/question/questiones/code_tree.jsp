...
<bean:define id="setId" name="questionesForm" property="trainsetid"></bean:define>
<%
...
<table width="300px;" align="left" border="0" cellpadding="0" cellspacing="0" class="mainbackground">
	<tr align="left" class="toolbar">
		<td valign="middle" align="left" style="padding-left: 10px;padding-top: 3px;">
		<%
		    if (!"69".equals(setId)) {
		%>
		  <hrms:priv func_id="32306C01" module_id="">
			&nbsp;<input type="image" style="padding-right: 5px;" name="b_new" src="/images/add.gif" alt="新增" onclick="addCode();"> 
		  </hrms:priv>
		  <hrms:priv func_id="32306C03" module_id="">                   
			&nbsp;<input type="image" style="padding-right: 5px;" name="b_delete" src="/images/del.gif" alt="删除" onclick="deleteCode();"> 
		  </hrms:priv>
		  <hrms:priv func_id="32306C02" module_id="">            
			&nbsp;<input type="image" style="padding-right: 5px;" name="b_update" src="/images/edit.gif" alt="修改" onclick="updateCode();">  
		  </hrms:priv>
		  <!-- 
		  ...
		  <hrms:priv func_id="32306C14" module_id=""> 
			&nbsp;<input type="image" style="padding-right: 5px;" name="b_order" src="/images/sort.gif" alt="排序" onclick="codeSort();"> 
		  </hrms:priv> 
		  <%
 		      } else {
 		  %>  
