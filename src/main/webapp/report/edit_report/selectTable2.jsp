...
<script language="javascript">
		...
		function change()
		{
			printReportForm.action="/report/edit_report/printReport.do?b_query2=link&sortId=" + printReportForm.sortId.value+"&reptype=0" ;
		...
		//	printReportForm.submit();
		   ...
		   window.returnValue=menu_vo;
		   parent.return_vo = menu_vo;
		   goback();
	...
	function goback()
	{
		if(parent.Ext.getCmp('showBatId'))
			parent.Ext.getCmp('showBatId').close();
		else
			window.close();
	}
...
<style>
	...
	.TableRow{border-right:none;}
	.RecordRow{border-right:none;}
</style>
<form name="printReportForm" method="post" action="/report/edit_report/printReport.do">
	...
	<div class='fixedtab common_border_color' style='width:98%;margin-left:4; margin-top: 5px;'  >
	<table width="100%" border="0" cellspacing="0" align="center" cellpadding="0" class="RecordRow" style="border-right:none;border-left:none;border-top:none;">
		...
		<thead>
			...
			<tr>
				<td align="center" class="TableRow" nowrap width="10%" style="border-left:none;">
	...
	<table width="85%" align="center" style="margin-top: 1px;">
		<tr>
			<td align="center">
