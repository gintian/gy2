...
function tijiao()
{
   ...
   document.editReport_actuaialForm.action="/report/actuarial_report/edit_report/editreportU02List.do?b_importsubmit2=link"
   document.editReport_actuaialForm.submit();
}
			...
			<br>
			  <fieldset align="center" style="width:50%;">
				...
				<table border="0" cellspacing="0" align="center" cellpadding="0">
					...
					<tr>
					<td valign='top' >驳回描述:<br><html:textarea  name="editReport_actuaialForm"  rows='10' cols='60' property="description" />	
 					</td>
					</tr>
					<tr>
						<td align="center" >							
