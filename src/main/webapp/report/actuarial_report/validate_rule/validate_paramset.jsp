...
<html>
	...
	function onsave(){
  		...
  		var paramcopy = document.getElementsByName("paramcopy2")[0].value;
  		//alert(paramcopy);
	  ...
	  var In_paramters="paramcopy="+paramcopy; 		
	  var request=new Request({method:'post',asynchronous:false,parameters:In_paramters,onSuccess:returnInfo,functionId:'03060000407',submit_form:true},hashvo);
...
.selfTableRow {
	...
	<body>
		...
		<form name="validateRuleForm" method="post"
			...
			<html:hidden styleId="paramcopy2" name="validateRuleForm"
				property="paramcopy2" />
