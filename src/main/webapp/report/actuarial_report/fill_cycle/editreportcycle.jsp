...
<html>
  ...
  {   
	...
	var reportcycle_id =trim(document.getElementsByName("reportcycle_id")[0].value);
	...
	var pars="date="+date+"&year="+year+"&type="+type+"&reportcycle_id="+reportcycle_id;  
     var request=new Request({method:'post',asynchronous:false,parameters:pars,
                              onSuccess:validatereport,functionId:'03060000111'});
	}
	function validatereport(outparamters){
 	...
 	return;
 		...
 		alert("保存成功");
	 	reportCycleForm.action = "/report/actuarial_report/fill_cycle.do?b_editsave=editsave";
					...
					<tr>
						<td align="left" class="TableRow" colspan="2">
							...
							<tr class="trDeep">
								...
								<td class="RecordRow" nowrap>
									<input type="text" name="adddate" size="14" style="width:200px"  value='<bean:write name="reportCycleForm" property="reportcyclevo.string(bos_date)" />' style="border: 1pt solid;width:150px"  extra="editor"  id="editor4"  
							...
							<tr class="trDeep">
								...
								<td class="RecordRow" nowrap>
								<html:select  styleId="itemtype" style="width:200px"  name="reportCycleForm" property="reportcyclevo.string(kmethod)" onchange="getitemtype();"   styleClass="textColorWrite" >
								&nbsp;
									<html:option value="">
										&nbsp;
									</html:option>
