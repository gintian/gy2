...
<html:form action="/hire/zp_release_pos/search_release_poslist">
...
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
		...
		<bean:message key="label.edit"/>            	
          ...
          <td align="center" class="RecordRow" nowrap>
                   <hrms:checkmultibox name="zpreleasePosForm" property="zpreleasePosForm.select" value="true" indexes="indexes"/>&nbsp;  		   
	    </td>            
	    ...
	    <td align="center" class="RecordRow" nowrap>
                <a href="/hire/zp_release_pos/add_zp_pos.do?b_query=link&a_id=<bean:write name="element" property="string(zp_pos_id)" filter="true"/>"><img src="/images/edit.gif" border=0></a>            	
	   </td>
       </tr>
       </hrms:extenditerate>   	    	    	
