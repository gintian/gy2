...
function changeFieldSet(){
	var v = parameterForm2.staticfieldsetid.value;
	...
	var request=new Request({method:'post',asynchronous:false,
		parameters:In_paramters,onSuccess:resultChangeFieldSet,functionId:'3000000194'},hashvo);					
  }
  
  function resultChangeFieldSet(outparamters){
  	//Element.hide('cid');
  	var fielditemlist=outparamters.getValue("resumeStaticFieldsList");
	AjaxBind.bind(parameterForm2.staticitemid,fielditemlist);
...
%> 
<html:form action="/hire/parameterSet/configureParameter/getResumeStaticFieldsList">
<%
                ...
                <tr>
                 <td align="center"  width="46%">
                   <table align="center" width="100%">
                    ...
                    <tr>
                      <td align="center">
			 <hrms:optioncollection name="parameterForm2" property="resumeStaticFieldsSetList" collection="list" />
		             <html:select name="parameterForm2" property="staticfieldsetid" size="1" onchange="changeFieldSet();" style="width:100%">
                   ...
                   <tr>
                       <td align="center">
                         <hrms:optioncollection name="parameterForm2" property="resumeStaticFieldsList" collection="list"/>
		              <html:select name="parameterForm2" size="10" property="staticitemid" multiple="multiple" ondblclick="additem('staticitemid','right_fields');" style="height:209px;width:100%;font-size:9pt">
		              <html:options collection="list" property="dataValue" labelProperty="dataName"/>
		        </html:select>		
                       </td>
                    </tr>
                ...
                <td width="8%" align="center">
                   <html:button  styleClass="mybutton" property="b_addfield" onclick="additem('staticitemid','right_fields');">
	           ...
	           <html:button  styleClass="mybutton" property="b_delfield" onclick="removeitem('right_fields');">
                ...
                <td width="46%" align="center">
 		        ...
 		        <hrms:optioncollection name="parameterForm2" property="selectedStaticFieldsList" collection="list"/>
