...
<html:form action="/hire/zp_person/search_zp_poslist"> 
<br>
<table width="70%" border="0" cellspacing="1"  align="center" cellpadding="1" class="ListTable">
		...
		<bean:message key="label.zp_person.zp_person_count"/>
   	  ...
   	  <hrms:extenditerate id="element" name="zppersonForm" property="zppositionForm.list" indexes="indexes"  pagination="zppositionForm.pagination" pageCount="20" scope="session">
          <%
          if(i%2==0)
          {
          %>
