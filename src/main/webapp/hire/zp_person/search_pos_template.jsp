...
<table>
  <tr>
   <td>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/hire/zp_person/apply_zp_position.do?b_query=link&zp_pos_id_value=${cardTagParamForm.zp_pos_id}"><bean:message key="hire.zp_persondb.applypos"/></a>
    </td>
 </tr>
 <tr>
  <td>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/hire/zp_persondb/applyaccount.do" target="_blank"><bean:message key="hire.zp_persondb.register"/></a>    
  </td>
  </tr>
 </table>
</html:form>
