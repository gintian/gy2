...
<%
	String url="/hire/zp_interface/applyuseraccount";
	if(request.getParameter("operate")!=null&&request.getParameter("operate").equals("add"))
	{
		url+=".do?operate=add";
	}
	else if(request.getAttribute("operate")!=null&&((String)request.getAttribute("operate")).equals("add"))
	{
		url+=".do?operate=add";
	}
%>
<hrms:themes></hrms:themes>
<html:form action="<%=url%>" onsubmit="return validate()">
 <br>
   ...
   <tr>
         <td class="framestyle9">
           <br>
            ...
            if(request.getParameter("clear")==null||!request.getParameter("clear").equals("1")){ %>
            <bean:write name="hireLoginForm" property="messageReturn"  filter="true"/>
            <% } %>
            </div>
           <br>
