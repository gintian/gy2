...
<br>
    <tr>  
       <td align="center">
          <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/hire/zp_filter/browsemaininfo.do?br_return=query')">
       </td>
    </tr>
 </table>
</html:form>
