...
<html:form action="/hire/zp_filter/showsetinfo">
...
<br>
    <tr>  
       <td align="center">
          <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/hire/zp_filter/showsetinfo.do?br_returnfilterquery=query')">
       </td>
    </tr>
 </table>
</html:form>
