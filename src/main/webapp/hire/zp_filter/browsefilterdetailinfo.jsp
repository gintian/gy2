...
<table width="80%" border="0">
  <tr>
   <td align="center">
         <input type="button" name="returnbutton"  value="<bean:message key="button.return"/>" class="mybutton" onclick="exeReturn('/hire/zp_filter/browsedetailinfo.do?br_returnfilter=query')">           
    </td>
  </tr>
 </table> 
</html:form>
