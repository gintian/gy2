			...
			<div class="center_bg" id='cms_pnl'>
				...
				<div class="right3"  id='rg'  style='min-height:<%=hi%>px;margin-bottom:30px'>
					...
					<table width="100%"  cellspacing="0" cellpadding="0" class="newHeadHunterTable">
						...
						<hrms:extenditerate id="element" name="employPortalForm" property="recommendUserListForm.list" indexes="indexes"
								...
								<tr>
									...
									<td class="newtable_line_nomral">
										<a href="javascript:resumeBrowseForHeader('${employPortalForm.dbName}','<bean:write name="element" property="a0100" filter="false"/>')"><bean:write name="element" property="A0101" filter="false" /></a>
									</td>
									...
									<td class="newtable_line_nomral">
										<logic:equal name="element" property="recommendPositions" value="0">
											<bean:write name="element" property="recommendPositions" filter="false"/>
										</logic:equal>
										<logic:notEqual name="element" property="recommendPositions" value="0">
											<a href='/hire/hireNetPortal/search_zp_position.do?b_applyedPosition=query&a0100=<bean:write name="element" property="a0100" filter="false"/>'><bean:write name="element" property="recommendPositions" filter="false"/></a>	
										</logic:notEqual>
									</td>
									<td class="newtable_line_nomral">
										<a href="javascript:recommendResume('<bean:write name="element" property="a0100" filter="false"/>','<bean:write name="element" property="A0101" filter="false" />')"><bean:message key="hire.out.headhunter.recommend"/></a>&nbsp;&nbsp;
										<a href='/hire/hireNetPortal/search_zp_position.do?b_showResumeList=show&setID=0&opt=1&a0100=<bean:write name="element" property="a0100" filter="false"/>'>
					...
					<div  style="position:relative;left:0.5%;top:15px;">
						<table>
							<tr>
								<td ><input class="imageButton" onclick="addPersonResume()" style="cursor:pointer " value="<bean:message key="hire.out.headhunter.addResume"/>"></input></td>
								<td style="margin-left:5px;margin-right:5px;"><input class="imageButton" onclick="batchRecommendValiate()" style="cursor:pointer " value="<bean:message key="hire.out.position.recommend"/>"></input></td>
								<td ><input class="imageButton" onclick="deletePersonResume()" style="cursor:pointer " value="<bean:message key="lable.tz_template.delete"/>"></input></td>
							</tr>
						</table>
					</div>
                </div>
