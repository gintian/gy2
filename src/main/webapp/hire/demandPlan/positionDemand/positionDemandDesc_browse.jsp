...
.RecordRow_top {
  ...
  <%
			...
			LazyDynaBean bean=(LazyDynaBean)positionDemandDescList.get(0);
			String channel=(String)bean.get("value");
...
function sub()
{
 ...
 var z0301=document.getElementById("z0301").value;
 ...
 hashvo.setValue("entertype","<%=request.getParameter("entertype")%>");
...
function check_bz_ok(outparameters)
{
	...
	document.positionDemandForm.action="/hire/demandPlan/positionDemand/positionDemandTree.do?b_savebrowse=add&opt=1&posState=<%=posState%>&z0301=<%=z0301%>&isClose=1";
...
function up_file(e01a1)
{
    ...
    var popwin= window.showModalDialog(iframe_url, e01a1, 
        "dialogWidth:450px; dialogHeight:240px;resizable:no;center:yes;scroll:yes;status:no");
...
<html>
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr height="20">  
          <% if(!channel.equalsIgnoreCase("01")){ %>     		
       		<td width='100%'  align="left" class="TableRow_lrt">&nbsp;&nbsp;<logic:equal value="1" name="positionDemandForm" property="positionState"><bean:message key="modify.position.request"/></logic:equal><logic:equal value="0" name="positionDemandForm" property="positionState">浏览岗位需求</logic:equal>&nbsp;(${positionDemandForm.positionStateDesc})</td>
       		<%}else{ %>
       		<td width='100%'  align="left" class="TableRow_lrt">&nbsp;&nbsp;<logic:equal value="1" name="positionDemandForm" property="positionState"><bean:message key="modify.position.professional"/></logic:equal><logic:equal value="0" name="positionDemandForm" property="positionState">浏览专业需求</logic:equal>&nbsp;(${positionDemandForm.positionStateDesc})</td>
       		<%} %>
          </tr> 
          <tr >
          	<td class='RecordRow' > 
          ...
          <%}else{ %>
          	  &nbsp;&nbsp; <bean:message key="hire.professional.descriptionfield"/>&nbsp;&nbsp;
          <%} %>
          <table width='97%' align='center' cellpadding="0" cellspacing="0"   ><tr><td class='RecordRow_top common_border_color' >
         &nbsp;
          </td></tr></table>
          <table border=0 width='90%' align='center' ><!-- 专业描述指标||岗位描述指标 -->
          <%
          	String z0336_value="";
          		 ...
          		 if(itemtype.equals("A"))
				 {
								if(codesetid.equals("0"))
								{
									...
									if(itemid.equalsIgnoreCase(hireMajor) && !(hireMajorCode==null || hireMajorCode.equals(""))){
										...
										out.print(" />&nbsp;&nbsp;");
										if(!(z0336_value.equals("01")&&itemid.equalsIgnoreCase(hireMajor)))
											out.print("<img  src='/images/code.gif' border=0 width=20 height=20 onclick=\"openInputCodeDialog2('"+hireMajorCode+"','positionDemandDescList["+i+"].viewvalue','0','','1');\" />");
									}
								...
								else
								{
									if(isMore.equals("0"))
									{
										...
										else
										{
											if(i==0)
											  out.print(" disabled");
										    else if(positionState.equals("0"))
									            out.print(" disabled");		
										...
										if(i==2)
										{
											out.print(" <span id='aup'> <input type='button' value=\""+ResourceFactory.getProperty("hire.upload.positionexplanation")+"\"  class='mybutton' onclick='up_file(\""+value+"\")' ");
									...
									else
									{
										...
										else
										{
						             	...
						             	out.print(" >&nbsp;&nbsp;<img  src='/images/code.gif' border=0 width=20 height=20 /></a>");	
						             	if(mustfill.equals("1")||((z0336_value.equals("01")||z0336_value.equals("04"))&&itemid.equalsIgnoreCase(hireMajor)))
									    {
										   out.print("&nbsp;<font color='red'>*</font>&nbsp;");
									    }	
         ...
         &nbsp;
           ...
           <table border=0 width='90%' align='center' ><!-- 对应聘者的要求 -->
           	<%
           		...
           		for(int j=0;j<posConditionList.size();j++)
           		{
           			...
           			{
           					out.print(" <tr><td width='15%' align='right' >"+itemdesc+"&nbsp;&nbsp;&nbsp;&nbsp;</td><td width='85%' align='left' ");
           					out.print(">");          			
	           				 if(itemtype.equals("A"))
							 {
								if(codesetid.equals("0"))
								...
								else
								{
									...
									if(isMore.equals("0"))
									{
										...
										ArrayList options=(ArrayList)abean.get("options");
										out.print("<select  name='posConditionList["+j+"].s_value'");
										if(positionState.equals("0"))
              					            out.print(" disabled ");  
										...
										{
											out.print("&nbsp;&nbsp;"+ResourceFactory.getProperty("kq.init.tand")+"&nbsp;&nbsp;");
											out.print("<select  name='posConditionList["+j+"].e_value' ");
											if(positionState.equals("0"))
           					                    out.print(" disabled ");  
											out.println("><option value=''></option> ");
											for(int n=0;n<options.size();n++)
									...
									else
									{
						              	...
						              	if(positionState.equals("0"))
           					                out.print(" disabled ");
           				              	out.print("/>");    
						             	out.print(" <span><img  src='/images/code.gif' border=0 width=20 height=20 style='position:relative;top:5px;' ");
						             	if(positionState.equals("1"))
						                 	out.print(" onclick='openInputCodeDialogS_value(\""+codesetid+"\",\"posConditionList["+j+"].view_s_value\")'");	
						             	out.print(" /></span>&nbsp;");	
										...
										if(flag.equals("false"))
										{
											...
											if(positionState.equals("0"))
           					                   out.print(" disabled ");
           				                	out.print("/>");    
							              	out.print(" <img  src='/images/code.gif' border=0 width=20 height=20 ");
							             	if(positionState.equals("1"))
						                     	out.print(" onclick='openInputCodeDialogS_value(\""+codesetid+"\",\"posConditionList["+j+"].view_e_value\")'");	
						                 	out.print(" />&nbsp;");			
							...
							{
								out.println("<input type='text'  name='posConditionList["+j+"].s_value'  class=textbox value='"+s_value+"'  ");
								if(positionState.equals("0"))
								   out.print(" disabled ");
								else
						    		out.print(" onclick='popUpCalendar(this,this, dateFormat,\"\",\"\",true,false)'");
								...
								{
										out.print("&nbsp;&nbsp;"+ResourceFactory.getProperty("kq.init.tand")+"&nbsp;&nbsp;");
										out.println("<input type='text'  name='posConditionList["+j+"].e_value'  class=textbox value='"+e_value+"'  ");
										if(positionState.equals("0"))
								            out.print(" disabled ");
								        else
										    out.print(" onclick='popUpCalendar(this,this, dateFormat,\"\",\"\",true,false)' ");	
           			...
           			else
           			{
           				...
           				for(int e=j;e<posConditionList.size();e++)
           				{
           						...
           						if(e==j)
           							out.print(" <tr id='"+aa_setname+"' style='display=block' ><td width='15%' align='right' >"+itemdesc+"&nbsp;&nbsp;&nbsp;&nbsp;</td><td  width='85%' align='left' >");          			
           						...
           						if(aa_setname.equals(setname3)&&!itemID.equals(itemid3))
           						{
           							 ...
           							 if(itemtype3.equals("A"))
									 {
										if(codesetid3.equals("0"))
										{
											...
											out.print("<input type=\"text\" size='10' class=textbox  name=\"posConditionList["+e+"].s_value\"   value=\""+s_value3+"\" ");
											if(positionState.equals("0"))
								     		   out.print(" disabled ");
										    out.println(" />&nbsp;");	
										}
										else
										{
											...
											if(isMore3.equals("0"))
											{
												...
												out.print("<select  name='posConditionList["+e+"].s_value' ");
												if(positionState.equals("0"))
										           out.print(" disabled ");
												out.println("><option value=''></option> ");
												for(int n=0;n<options.size();n++)
											...
											else
											{
										        ...
										        out.print("/>");
								             	out.print(" <span><img  src='/images/code.gif' border=0 width=20 height=20 style='position:relative;top:5px;'");
								             	if(positionState.equals("1"))
								             	   out.print("onclick='openInputCodeDialogS_value(\""+codesetid3+"\",\"posConditionList["+e+"].view_s_value\")'");	
								             	out.print(" /></span>");	
									...
									{
										out.print("<input type=\"text\"  size='10'  name=\"posConditionList["+e+"].s_value\"   value='"+s_value3+"'   class=textbox   ");
										if(positionState.equals("0"))
										   out.print(" disabled ");
										 out.println("/>&nbsp;");
...
%>
         ...
         &nbsp;
          ...
          <tr>	      
          	...
          	<td  width='85%'  align='left' >
          		<table><tr><td>
          		<logic:equal value="1" name="positionDemandForm" property="positionState">
					<html:checkbox property="isRevert" name="positionDemandForm" value="1"  onclick='showTemplate()' />
					</logic:equal>
				<logic:equal value="0" name="positionDemandForm" property="positionState">
				<html:checkbox property="isRevert" name="positionDemandForm" value="1"  disabled="true" onclick='showTemplate()' />
				</logic:equal>
					 <bean:message key="hire.revert.emailtoemployee"/>
					&nbsp;&nbsp;
					</td><td>
  ...
  <table width='90%' align='center' >
  	<tr>
  		<td align='center'>
  		<logic:equal value="1" name="positionDemandForm" property="positionState">
  		<logic:equal value="1" name="positionDemandForm" property="entertype">
  		<hrms:priv func_id="310111">
  			<input type='button' value="<bean:message key="button.ok"/>" class="mybutton" onclick='sub()' style="margin-top:5px;" >
  		</hrms:priv>
  		</logic:equal>
  		<logic:equal value="2" name="positionDemandForm" property="entertype">
  		<hrms:priv func_id="310121">
  			<input type='button' value="<bean:message key="button.ok"/>" class="mybutton" onclick='sub()' style="margin-top:5px;" >
  		</hrms:priv>
  		</logic:equal>
		&nbsp;
		</logic:equal>
		<input type='button' value="<bean:message key="button.cancel"/>"  onclick='goback()' class="mybutton" style="margin-top:5px;">   
		</td>
  	</tr>
  </table>
