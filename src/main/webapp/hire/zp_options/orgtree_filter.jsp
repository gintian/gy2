...
<%
	...
	if(flag.equals("org"))
	{
	  action="/hire/zp_options/pos_filter.do?b_query=link&a_code="+a_code;
...
<%
 ...
 {
%>
	var m_sXMLFile	= "/hire/zp_options/get_org_tree_filter.jsp?flag=<%=flag%>&params=codeitemid%3D'<%=codevalue%>'";	 //
<%
 }
 else
 {
%>
	var m_sXMLFile	= "/hire/zp_options/get_org_tree_filter.jsp?flag=<%=flag%>&params=codeitemid%3Dparentid";	 //
<%}
