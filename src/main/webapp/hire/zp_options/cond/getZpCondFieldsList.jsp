...
<script language="javascript">
	...
	var request=new Request({method:'post',asynchronous:false,parameters:In_paramters,onSuccess:resultChangeFieldSet,functionId:'3960000001'},hashvo);					
  }
...
{
   var type="${zpCondTemplateConstantForm.zp_cond_template_type}";
   zpCondTemplateConstantForm.action="/hire/zp_options/cond/zpCondTemplate.do?b_query=query&type="+type;
   zpCondTemplateConstantForm.submit();
}
