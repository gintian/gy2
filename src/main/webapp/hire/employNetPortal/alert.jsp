...
<table width="100%" height='100%' align="center" border="0" cellpadding="0" cellspacing="0" >
  <tr  height="240" >  
    <td width="100%"  height='100%'  valign="top"  style="background-image: url(/images/alertBack.jpg);background-repeat:no-repeat;background-color: #ffffff;background-position: top right;" align="center">
      	...
      	<table border="0" width='80%' height='80%'>
      		...
      		<tr><td  height='30%' align='right' ><a href='javascript:back()'> <bean:message key="button.return"/></a> </td></tr>
      	</table>
