                    ...
                    <tbody>
                      ...
                      <tr > 
                        <td align="left"   class=rptItemMain >   
                          ...
                          <a href="/hire/employNetPortal/search_zp_position.do?b_posDesc=link&posID=<%=z0311%>&z0301=<%=z0301%>&posName=<%=posName%>&unitName=<%=unitName%>" style="cursor:hand" target="_blank"> 
                       ...
                       <td align="center"   class=rptItemMain >
                         <a href="/hire/employNetPortal/search_zp_position.do?b_posDesc=link&posID=<%=z0311%>&z0301=<%=z0301%>&posName=<%=posName%>&unitName=<%=unitName%>" style="cursor:hand" target="_blank"> <img src="/images/yp.gif" border="0"> </a>
                         </td>
