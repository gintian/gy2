...
public class SelectKqOrgTreeTag extends BodyTagSupport {
	/**选中节点相应，弹出的网页*/
	...
	private String servlet_ul="/kq/emp/load_tree";
	...
	private String outTreePanel()
	{
		...
		String url=this.servlet_ul+"?target="+this.target+"&flag="+this.flag+"&dbtype="+this.dbtype+"&priv="+this.priv;
