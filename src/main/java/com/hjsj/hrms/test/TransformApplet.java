 ...
 *<p>Description:</p> 
 *<p>Company:HJHJ</p> 
 *<p>Create time:2007-10-13:下午02:42:43</p> 
 *@author cmq
 *@version 4.0
 */
public class TransformApplet extends JApplet implements ItemListener,
ActionListener {
   ...
   public void actionPerformed(ActionEvent e) {
    ...
    public static void main( String[] argv ) {
        if ( argv.length > 0 && "-no2d".equals(argv[0]) ) {
            TransformApplet.no2D = true;
        }
        ...
        JApplet applet = new TransformApplet();
...
class TransPanel extends JPanel {
	...
	Stroke oldStroke = g2.getStroke();
        ...
        switch ( TransformApplet.line.getSelectedIndex() ) {
	...
	Paint oldPaint = g2.getPaint();
        ...
        switch ( TransformApplet.paint.getSelectedIndex() ) {
        ...
        // Sets the Shape.
        Shape shape = shapes[TransformApplet.primitive.getSelectedIndex()];
 	...
 	AffineTransform toCenterAt = new AffineTransform();
        ...
        switch ( TransformApplet.stroke.getSelectedIndex() ) {
