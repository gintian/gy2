...
public class CmppSender  {
	...
	private List sendData=new ArrayList();//需要发出的二进制数据队列
	private List getData=new ArrayList();//需要接受的二进制队列
	private DataOutputStream out;
	private DataInputStream in;
	public CmppSender(DataOutputStream out,DataInputStream in,List sendData) {
		super();
