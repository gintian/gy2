...
public class MsgContainer{
	...
	public static  DataInputStream getSocketDIS(){
		if(in==null||msgSocket.isInputShutdown()||null==msgSocket||msgSocket.isClosed()||!msgSocket.isConnected()){
			try {
	...
	public static   DataOutputStream getSocketDOS(){
		if(out==null||msgSocket.isOutputShutdown()||null==msgSocket||msgSocket.isClosed()||!msgSocket.isConnected()){
			try {
