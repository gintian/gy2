package com.hjsj.hrms.module.recruitment.baseoptions.actionform;
...
public class BaseOptionsForm extends FrameForm {
    ...
    public void outPutFormHM() {
		...
		this.setItemDisplayNames((String) this.getFormHM().get("itemDisplayNames"));
	}
    ...
    public void inPutTransHM() {
		...
		this.getFormHM().put("itemDisplayNames", this.getItemDisplayNames());
	}
