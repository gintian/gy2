...
public class CardConstantSet {
	...
	public ArrayList setCardidSelect(Connection conn, UserView userview,
	 ...
	 public ArrayList setCardidSelect(Connection conn,UserView userview,String flag,String nbase,String a0100,String b0110,XmlParameter xml) throws Exception
	 {
			...
			if("1".equals(flag)&&codenamelist!=null&&codenamelist.size()>0)
			{
				...
				XmlParameter xmlParameter =new XmlParameter(conn,b0110,"");
				if(codeitemid==null)
					throw new Exception("未配置相关薪酬模板，请检查设置!");
	...
	public ArrayList setCardidSelectSelfinfo(Connection conn, UserView userview, String flag, 
	  ...
	  * @return
	  */
	 public ArrayList getMustCommDataList(String nbase,String a0100,String intoflag)
	 {
		 intoflag="1";
