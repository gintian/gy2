...
/**
 * 
 * <p>Title:AnswerResultBO.java</p>
 * <p>Description:</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:Nov 11, 2015 4:30:58 PM</p>
 * <p>@version:1.0</p>
 * <p>@author hej</p>
 */
public class AnswerResultBo {
	...
	public AnswerResultBo(){
		
	}

	public AnswerResultBo(Connection conn) {
		this.conn = conn;
	}
	
	public String getTemplateResult(Object[] objs,String mainObject,String subObject,String planid){
		...
		try {
			...
			//获取问卷题目
			ArrayList<HashMap<String, Object>> questionList = getTemplateQuestion(qnid,planid,mainObject,subObject,connection);
	 ...
	 * @return String
	 */
	private ArrayList<HashMap<String, Object>> getTemplateQuestion(int qnid,String planid,String mainObject,String subObject,Connection conn){
		ContentDAO dao = new ContentDAO(conn);
		...
		//获取某个人的非矩阵答题数据
		HashMap<String, ArrayList<String>> datamap = getData(String.valueOf(qnid),planid, mainObject,subObject,dao, itemmap, conn, optionmap);
		//获取某个人的矩阵数据
		HashMap<String, HashMap<String, ArrayList<HashMap<String, String>>>> mtdatamap = getMatrixData(dao, String.valueOf(qnid),planid,  mainObject,subObject, conn);
		RowSet rs = null;
		RowSet rs1 = null;
		RowSet rs2 = null;
		try {
	...
	private HashMap<String,ArrayList<HashMap<String,String>>> getOptions(String qnid,ContentDAO dao){
		...
		try {
			...
			while(rs.next()){
				...
				map.put("imgurl", rs.getString("imgurl")==null?"": SafeCode.encode(PubFunc.encrypt(rs.getString("imgurl"))));
				arr.add(map);
