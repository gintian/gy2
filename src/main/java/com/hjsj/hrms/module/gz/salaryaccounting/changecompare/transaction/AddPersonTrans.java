...
/**
 * 
 * <p>Title:AddPersonTrans.java</p>
 * <p>Description>:薪资发放_变动比对_新增人员</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:Oct 18, 2016 10:28:30 AM</p>
 * <p>@version: 7.0</p>
 * <p>@author:zhaoxg</p>
 */
public class AddPersonTrans extends IBusiness {
    ...
    public void execute() throws GeneralException {
		...
		try {
			...
			if("1".equals(flag)){
				...
				HashMap map = changeCompareBo.getColumn(changeCompareBo.ADD_PERSON, tableName, exceptStr);
				...
				String sql = "select "+tableName+".*,'add' as tabletype from "+tableName+" "+order;
