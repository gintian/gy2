...
/**
 * 
 * <p>Title:StopPersonTrans.java</p>
 * <p>Description>:薪资发放_变动比对_停发人员</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:Oct 18, 2016 11:01:09 AM</p>
 * <p>@version: 7.0</p>
 * <p>@author:zhaoxg</p>
 */
public class StopPersonTrans extends IBusiness {
    ...
    public void execute() throws GeneralException {
		...
		try {
			...
			if("1".equals(flag)){
				...
				HashMap map = changeCompareBo.getColumn(changeCompareBo.STOP_PERSON, tableName, exceptStr);
				...
				String sql = "select "+tableName+".*,'stop' as tabletype from "+tableName+" "+order;
