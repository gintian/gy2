...
/**
 * <p>Title:TSubSetDomain.java</p>
 * <p>Description>:子集区域类，包含子集区域所有的参数及其他单元格的参数</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:2015-12-18 下午04:45:12</p>
 * <p>@version: 7.0</p>
 */
public class SubSetDomain {
	...
	{
		if(this.subDomain==null|| "".equals(this.subDomain))
			return;
		Document doc=null;
			...
			if(childlist!=null&&childlist.size()>0)
			{
				 ArrayList sublist = new ArrayList();
				  for (int i = 0; i < childlist.size(); i++) {
	                     ...
	                     //syl 58048 V77包：人事异动：子集中的数值型指标，显示一位小数，该指标维护成“2.2”后点击保存，值变为“2.0”,见附件。
	                     //修改原因，工具箱设置时，默认为0， 如果其值为0，则优先指标设置小数位数，为其他，仍然取值工具箱设置其值。
