...
public class CreateTotalXml {
     ...
     * 
     */
    public CreateTotalXml(String codesetid,String codeitemid) {
        this.codeitemid=PubFunc.getReplaceStr(codeitemid);
        this.codesetid=PubFunc.getReplaceStr(codesetid);
    }
    
    public CreateTotalXml(String codesetid,String codeitemid,String privflag) {
    	this(codesetid,codeitemid);
    	this.privflag=privflag;
    }  
    public CreateTotalXml(String codesetid,String codeitemid,String privflag,String isfirstnode) {
    	this(codesetid,codeitemid);
    	this.privflag=privflag;
    ...
    private String getQueryString()
    {
        ...
        if("UN".equalsIgnoreCase(this.codesetid)|| "UM".equalsIgnoreCase(this.codesetid)|| "@K".equalsIgnoreCase(this.codesetid))
        {
            if("UN".equalsIgnoreCase(this.codesetid)){
                str.append("select codesetid,codeitemid,codeitemdesc,childid,parentid ");
    ...
    public String outCodeTree()throws GeneralException
    {
        ...
        try
        {
          ...
          child1.setAttribute("id","UN");
              
          child1.setAttribute("text", "不限");
          child1.setAttribute("title", "UN:不限");
          child1.setAttribute("xml", "111");
          child1.setAttribute("icon","/images/unit.gif");
