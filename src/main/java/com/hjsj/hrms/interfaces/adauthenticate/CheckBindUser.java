...
public class CheckBindUser
{
                                       ...
                                       String userDN, String userPWD)
    {
        ...
        try {
            ...
            while(allAttributes.hasNext()) {
                ...
                if ("loginAllowedTimeMap".equalsIgnoreCase(attrName)) {
                    timeMap = attribute.getByteValueArray()[0];
                }
                else if ("LoginDisabled".equalsIgnoreCase(attrName)) {
                    if ( (value = attribute.getStringValue()) != null)
                        login = value;
                }
                else if ("loginExpirationTime".equalsIgnoreCase(attrName)) {
                    if ( (value = attribute.getStringValue()) != null )
                        loginExpTime = value;
                }
                ...
                else if ("lockedByIntruder".equalsIgnoreCase(attrName)) {
                    if ( (value = attribute.getStringValue()) != null )
                        locked = value;
                }
            }
            ...
            if ( (login != null) && (login.length() != 0) ) {
                if ( "FALSE".equalsIgnoreCase(login) )
    ...
    public static boolean getTimeRestriction( byte[] tm, String localTime )
    {
        ...
        else if ( "Mon".equalsIgnoreCase(weekDay))
            index = 1 * 48 + clockIndex;
        else if ( "Tue".equalsIgnoreCase(weekDay))
            index = 2 * 48 + clockIndex;
        else if ( "Wed".equalsIgnoreCase(weekDay))
            index = 3 * 48 + clockIndex;
        else if ( "Thu".equalsIgnoreCase(weekDay))
            index = 4 * 48 + clockIndex;
        else if ( "Fri".equalsIgnoreCase(weekDay))
