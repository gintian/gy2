...
public class EditMenuSaveMainTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		menubo.editMenuContent(menu_id,menu_name,parentid,menu_func_id,menu_icon,menu_url,menu_target,menuhide,doc);
		//this.getFormHM().put("menu_id",menu_id);
...
//		menubo.editMenuContent(menu_id,name,parentid,doc);
//	}
