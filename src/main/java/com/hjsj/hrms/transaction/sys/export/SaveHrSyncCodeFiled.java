 ...
 *@version 1.0
 */
public class SaveHrSyncCodeFiled extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		hsb.syncFieldTrans("t_hr_view", code_fields);//数据视图更新翻译指标 wangb 20170619
	...
	private boolean saveFields(ArrayList code_fields,ContentDAO dao)throws GeneralException 
	{
		...
		HrSyncBo hsb = new HrSyncBo(this.frameconn);
		hsb.setTextValue(hsb.CODE_FIELDS,buf.toString());
