...
public class GetDutyFieldTrans extends IBusiness {
		...
		try
		{
		    for(int i=0;i<fielditemlist.size();i++)
		    {
		      ...
		      if("0".equals(this.userView.analyseFieldPriv(fielditem.getItemid())))
		        continue;
		      //未构库的指标不能在备选指标页面显示 27009  wangb1  20170502 
		      if("M".equalsIgnoreCase(fielditem.getItemtype()) || "0".equals(fielditem.getUseflag()))
		    	  continue;
