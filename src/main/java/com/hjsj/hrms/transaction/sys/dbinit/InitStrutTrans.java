...
/**
 * 
 *<p>Title:InitStrutTrans.java</p> 
 *<p>Description:</p> 
 *<p>Company:hjsj</p> 
 *<p>Create time:Sep 1, 2008:5:32:46 PM</p> 
 *@author huaitao
 *@version 1.0
 */
public class InitStrutTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		try {
			...
			//idj.InitData(dblist,"delete");
			idj.InitData(dblist,"drop");
