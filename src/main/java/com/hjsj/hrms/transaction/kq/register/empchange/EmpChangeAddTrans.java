 ...
 * 
 * */
public class EmpChangeAddTrans extends IBusiness{
   ...
   {    
        ...
        for(int i=0;i<kq_dbase_list.size();i++)
	    {
		   ...
		   String sql= Employ_Change.getDateSqlAdd(userbase,change_date,change_date,whereIN,1);
        ...
        if(addlist!=null&&addlist.size()>0){
           this.getFormHM().put("changestatus","1");  
           this.getFormHM().put("add_count",addlist.size()+"");
        }else{
           this.getFormHM().put("changestatus","1");
           this.getFormHM().put("add_count","0");
        }
