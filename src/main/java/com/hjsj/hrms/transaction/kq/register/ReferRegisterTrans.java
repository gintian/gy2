...
public class ReferRegisterTrans extends IBusiness {
    ...
    public void execute() throws GeneralException {
        try {
            ...
            validate = "true";
            if (isCorrect) {
                this.getFormHM().put("sp_result", "数据报批成功！");
            } else {
                this.getFormHM().put("sp_result", "数据报批失败！");
            }
    ...
    private boolean updateSql(String whereIN, String kind, String dbase, String code, String start_date, String end_date,
        ...
        String strSet = "q03.q03z5='02'";//更新串  xxx.field_name=yyyy.field_namex,....
        ...
        String strSWhere = srcTab + ".a0100 in(select a0100 " + whereIN + ") and q05.nbase='" + dbase + "' and q05.q03z0='"
                + kq_duration + "' and q05.q03z5='02'";//源表的过滤条件  
