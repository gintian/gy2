...
import com.hjsj.hrms.businessobject.kq.register.ExecuteKqDailyExcel;
...
//		{
//			ExecuteKqSumDailyExcel excel = new ExecuteKqSumDailyExcel(this.getFrameconn());
//			excel.setSjelement(sjelement);
//			excel.setTimeqd(timeqd);
//			url=excel.executeExcel(code,kind,coursedate,parsevo,this.userView,this.getFormHM());
//		}
