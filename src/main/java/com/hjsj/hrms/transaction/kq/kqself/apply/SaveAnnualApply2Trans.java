 ...
 * 
 * <p>Title:</p>
 * <p>Description:添加员工个人休假申请直接审批</p>
 * <p>Company:hjsj</p>
 * <p>create time:Feb 5, 2009:1:27:40 PM</p>
 * @author wangyao
 * @version 1.0
 *
 */
public class SaveAnnualApply2Trans extends IBusiness{
	...
	private void AddValue(String table,ArrayList viewlist,String plan_id) throws GeneralException {
			...
			try{
	          ...
	          vo.setString("q31z5","02");  //02是报批状态；01是起草状态
