...
//		 }	
//		ArrayList sqllist=OrgRegister.getSqlstrHistory(list,b0100s,cur_date, b0110, "Q07");
		DbWizard dbWizard =new DbWizard(this.getFrameconn());
		ArrayList sqllist=null;
		if(dataInQ07(cur_date) || !dbWizard.isExistTable("Q07_arc", false)){
			sqllist=OrgRegister.getSqlstrHistory(list,b0100s,cur_date, b0110, "Q07");
		}else{
		...
		this.userView.getHm().put("kq_condition", "7`"+sqllist.get(4).toString());
