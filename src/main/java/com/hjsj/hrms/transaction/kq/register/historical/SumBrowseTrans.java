...
public class SumBrowseTrans extends IBusiness {
	public void execute() throws GeneralException 
	{
	    ...
	    ArrayList fielditemlist = DataDictionary.getFieldList("Q03",Constant.USED_FIELD_SET);
		   ArrayList fieldlist=RegisterInitInfoData.newFieldItemList(fielditemlist);
...
//			sqllist = CollectRegister.getSqlstr2(fieldlist,sql_db_list,cur_year+"-"+cur_duration,code,kind,"Q05_arc",this.userView,"all",where_c);
			sqllist = RegisterInitInfoData.getSqlstr6(fieldlist,sql_db_list,cur_year+"-"+cur_duration,code,kind,"Q05_arc",this.userView,"all",where_c,this.frameconn);
		}		maps=count_Leave();
		...
		this.getFormHM().put("returnURL","/kq/register/historical/sumbrowsedata.do?b_search=link");
		//显示部门层数
