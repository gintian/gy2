...
import com.hjsj.hrms.businessobject.kq.register.KqUnitPDFDailyBo;
 ...
 * wangyao
 */
public class KqReportUnitPDFTran extends IBusiness{
	...
	public void execute() throws GeneralException {
		try {
            ...
            KqUnitPDFDailyBo bo = new KqUnitPDFDailyBo(this.frameconn, this.userView);
            ...
            if ("2".equals(fileunit)) {// 当前考勤期间
            	...
            	// 文件名
            	String fileName = bo.getKqReportPDF(a0100,coursedate, parsevo, nbase, name.replaceAll("　", ""), reportId);
