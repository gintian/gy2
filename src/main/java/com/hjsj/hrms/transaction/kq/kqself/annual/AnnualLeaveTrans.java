...
public class AnnualLeaveTrans extends IBusiness {
		...
		for(int i=0;i<fieldlist.size();i++)
		   {
			   ...
			   field.setValue("");
			   field.setViewvalue("");
			   if("b0110".equals(field.getItemid())|| "a0101".equals(field.getItemid())|| "e0122".equals(field.getItemid())|| "nbase".equals(field.getItemid())|| "a0100".equals(field.getItemid()))
