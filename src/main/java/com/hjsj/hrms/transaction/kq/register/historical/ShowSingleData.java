...
public class ShowSingleData  extends  IBusiness{
    public void execute()throws GeneralException
    {
	  ...
	  ArrayList yearlist=RegisterDate.sessionYaer(this.frameconn,"1");			
		...
		ArrayList sqllist=SingOpintion.getOneYearSQLStr(fielditemlist,userbase,a0100,cur_year,"Q05_arc");
		...
		this.getFormHM().put("returnURL","/kq/register/historical/showsingle_month.do?b_browse=link");
