...
/**
 * 
 *<p>Title:SearchTaskBook.java</p> 
 *<p>Description:</p> 
 *<p>Company:hjsj</p> 
 *<p>Create time:May 7, 2009:2:27:54 PM</p> 
 *@author huaitao
 *@version 1.0
 */
public class SearchTaskBook extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		String ordersql= " order by "+dbname+"a01.a0100,b.createtime";
		
		ContentDAO dao = new ContentDAO(this.frameconn);
		try {
			/*this.frowset = dao.search(sql+ordersql);
		...
		if(yearlist==null||yearlist.size()==1)
		{
			...
			CommonData data = new CommonData(year+"",year+"");
			yearlist.add(data);
		}
