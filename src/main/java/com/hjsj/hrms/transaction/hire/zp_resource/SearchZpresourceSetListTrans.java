 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SearchZpresourceSetListTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
	    ...
	    strsql.append("select * from zp_resource_set");
	    ...
	    try
	    {
	      ...
	      while(this.frowset.next())
	      {
	          ...
	          vo.setString("type_id", this.getFrowset().getString("type_id"));
	    ...
	    {
	        this.getFormHM().put("zpresourceSetlist",list); 
	    }
