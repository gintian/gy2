...
public class SubmitTemplateU04Trans extends IBusiness {
...
//		escope=report_id.split("_")[1];
	    ...
	    try {	
	    	...
	    	String delete_sql = " delete  from u04 where   id="+id+" and unitcode=? ";
	    	dao.batchUpdate(delete_sql, list_deleteinfo);
	    	//更新以下部门
			String update_sql1 = " insert into  u04(u0401,id,unitcode,editflag) values('1',"+id+",?,'1') ";
			String update_sql2 = " insert into  u04(u0401,id,unitcode,editflag) values('2',"+id+",?,'1') ";
			ArrayList updateu04 = new ArrayList();
			for(int i=0;i<unitcodesarr.length;i++){
	    		ArrayList list = new ArrayList();
	    		list.add(unitcodesarr[i]);
	    		updateu04.add(list);
	    	}
			dao.batchUpdate(update_sql1, updateu04);
			dao.batchUpdate(update_sql2, updateu04);
