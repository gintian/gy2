 ...
 * <p>Description:</p>
 * <p>Company:hjsj</p>
 * <p>create time:Aug 3, 2006:1:51:39 PM</p>
 * @author zhangfengjin
 * @version 1.0
 * 
 */
public class ReportInnerAnalyseTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		reportinnercheckresult.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		reportinnercheckresult.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		reportinnercheckresult.append(ResourceFactory.getProperty("report_collect.reportCollect")+"-"+ResourceFactory.getProperty("report_collect.reportInnerValidate")+"(");
...
/*		reportinnercheckresult.append("<br>");
		...
		for(int i = 0 ; i< ucs.length; i++){
			...
			for(int j =0; j<tbs.length; j++){
				String tabid = tbs[j];		
				ReportInnerCheck rc = new ReportInnerCheck(this.getFrameconn(),tabid,  2 ,unitCode);
		...
		if(flag == true){
			Exception e = new Exception(ResourceFactory.getProperty("report_collect.reportInnerValidateSuccess")+"！");
