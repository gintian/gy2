...
/**
 * 
 * <p>Title: MyTransferHoliday </p>
 * <p>Description: 我的调休</p>
 * <p>Company: hjsj</p>
 * <p>create time  2013-11-27 上午11:43:10</p>
 * @author tiany
 * @version 1.0
 */
public class MyTransferHoliday {
    public void execute(UserView userView, HashMap hm, Connection conn) throws GeneralException {
        ...
        try{
            ...
            List transferHolidayList= holidayBo.searchMyOvertimeForLeave(year, nbase, a0100,pageIndex,pageSize);
            hm.put("transferHolidayList", transferHolidayList);
            succeed ="true";
