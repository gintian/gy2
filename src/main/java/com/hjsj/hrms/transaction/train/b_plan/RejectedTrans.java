...
/**
 * <p>Title:培训班</p>
 * <p>Description:驳回培训班</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:2007-12-13 下午06:07:55</p>
 * @author lilinbing
 * @version 4.0
 */
public class RejectedTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		try{
			...
			for(int i=0;i<list.size();i++){
				...
				if("01".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.submit.drafting")+"!");
					continue;
				}else if("03".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.approved")+"!");
					continue;
				}else if("04".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.published")+"!");
					continue;
				}else if("05".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.perform")+"!");
					continue;
				}else if("06".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.end")+"!");
					continue;
				}else if("09".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.dismissed.suspended")+"!");
					continue;
				}
			...
			if(namestr.trim().length()>0){
				...
				sqlstr.append("update r25 set r2509='07' where R2501 in(");
