 ...
 * <p>Description:</p>
 * <p>Company:hjsj</p>
 * <p>create time:2005-6-17:13:30:27</p>
 * @author luangaojiong
 * @version 1.0
 * 
 */
public class SearchOrganizationListTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		{
				  String sql=" select *  "; 
				  String sql2=" from R01 ";
				  String sql3=" where R0101='"+eduid+"'";
			      ...
			      while(this.frowset.next())
			      {
			      	...
			      	vo.set("r0101",PubFunc.nullToStr(this.frowset.getString("r0101"))); 
			      	vo.set("r0102",PubFunc.nullToStr(this.frowset.getString("r0102"))); 
		...
		{
			 this.getFormHM().put("organizationlist",list);
		}
	...
	{
		 StringBuffer sb=new StringBuffer();
		 sb.append("select * from t_hr_busifield where fieldsetid='R01' and useflag='1'");
		 ContentDAO dao=new ContentDAO(this.getFrameconn());
		 try
		 {
		 	this.frowset = dao.search(sb.toString());
		 	...
		 	while(this.frowset.next())
		 	{
		 		...
		 		if("r0101".equals(columnName) ||
		 		   "r0102".equals(columnName) ||
		 ...
		 {
		 	System.out.println("-->com.hjsj.hrms.transaction.train-->SearchOrganizationListTrans-->getDynamicList->error");
		 	ex.printStackTrace();
		 }
	}
}
