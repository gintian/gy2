 ...
 * @author liweichao
 */
public class SuspendTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		try{
			...
			for(int i=0;i<list.size();i++){
				...
				if("01".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.suspended.submit.drafting")+"!");
					continue;
				}else if("02".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.suspended.submit.approvalr")+"!");
					continue;
				}else if("03".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.suspended.approved")+"!");
					continue;
				}else if("05".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.suspended.perform")+"!");
					continue;
				}else if("06".equals(sp)){
					exper.append("\n\n["+r2502+"]"+ResourceFactory.getProperty("train.b_plan.suspended.end")+"!");
					continue;
				}
			...
			if(namestr.trim().length()>0){
				...
				sqlstr.append("update r25 set r2509='09' where R2501 in(");
