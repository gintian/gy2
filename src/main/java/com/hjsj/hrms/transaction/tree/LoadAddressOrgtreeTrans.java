 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class LoadAddressOrgtreeTrans extends IBusiness {
	...
	//	    if(privtype!=null&&privtype.equals("kq"))
	//	    {
	...
	//		    treeItem.setLoadChieldAction("/serviceself/address/loadaddresstree?params=root&parentid=00&issuperuser=1&treetype=" + treetype + "&action=" + action + "&target=" + target + "&manageprive=" + privCode + privCodeValue);
	//		else
	//		{
	//			if(userView.getStatus()==4 || userView.getStatus()==0)
					treeItem.setLoadChieldAction("/serviceself/address/loadaddresstree?params=root&parentid=00&issuperuser="+issuperuser+"&treetype=" + treetype + "&action=" + action + "&target=" + target + "&manageprive=" + privCode + privCodeValue);
	//		    else
	//			    treeItem.setLoadChieldAction("/serviceself/address/loadaddresstree?params=root&parentid=00&issuperuser="+issuperuser+"&treetype=" + treetype + "&action=" + action + "&target=" + target + "&manageprive=" + privCode + "no");
