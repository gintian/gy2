...
public class LoadInfoEmpSendCardTreeTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		String kq_card=(String)hashmap.get("cardno");
		
	    String url="/common/sendcard/loadtree?target="+target+"&action=" + action + "&flag=1&dbtype=1&kq_type="+kq_type+"&viewPost="+viewPost+"&kq_card="+kq_card;
		if(!("UN".equals(a_code)))
		{
