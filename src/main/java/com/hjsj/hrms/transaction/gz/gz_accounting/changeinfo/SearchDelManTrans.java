 ...
 *<p>Description:</p> 
 *<p>Company:HJHJ</p> 
 *<p>Create time:2007-8-2:下午05:46:49</p> 
 *@author cmq
 *@version 4.0
 */
public class SearchDelManTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		try
		{
			...
			//String tablename=templatebo.createDelManTable();
			...
			String rightvalue = ctrl_par.getValue(SalaryCtrlParamBo.DEL_MAN_FIELD);
