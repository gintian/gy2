...
public class ConfigMoneyItemTrans extends IBusiness{

	public void execute() throws GeneralException
	{
		try
		{
			String ids=(String)this.getFormHM().get("moneyitemids");
			
			String moneyid=(String)this.getFormHM().get("nmoneyid");
			...
			bo.modifyMoneyitemInfo(moneyid,ids,1);
			bo.modifyMoneyitemInfo(moneyid,ids,0);
			ArrayList itemList = bo.getGzProjectList(salaryid);
		    ArrayList moneyItemList=bo.getSelectedMoneyItemList(moneyid);
			...
			String codeSql = bo.getCodeSql("", code);
