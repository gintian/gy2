...
/**
 * <p>
 * Title:GeneratePremiumTrans.java
 * </p>
 * <p>
 * Description:生成部门月奖金,由最顶层机构操作来生成所有子机构
 * </p>
 * <p>
 * Company:hjsj
 * </p>
 ...
 * 
 */
public class GeneratePremiumTrans extends IBusiness
{
	...
	String childOrgSqlStr = "select codeitemid from organization where  codesetid in ('UM','UN') and codeitemid!='" + currentOrg + "' and codeitemid like '"+ currentOrg +"%'";
	...
	String sqlStr2 = "select b0110,max(i9999) i9999 from " + setid + " where b0110 in (" + childOrgSqlStr + ") group by b0110";
	...
	try
	{
	    ...
	    while (this.frowset.next())
	    {
		String b0110 = this.frowset.getString("codeitemid");
		int i9999 = 1;
