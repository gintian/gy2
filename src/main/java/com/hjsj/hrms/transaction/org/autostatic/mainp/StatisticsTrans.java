 ...
 *@version 4.0
  */
public class StatisticsTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		ArrayList fieldsetlist = tempvarbo.fieldList(this.userView,"1");
