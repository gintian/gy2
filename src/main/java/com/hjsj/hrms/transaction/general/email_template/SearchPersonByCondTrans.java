...
/**
 * <p>Title:SearchPersonByCondTrans.java</p>
 * <p>Description:</p>
 * <p>Company:HJSJ</p>
 * <p>Create Time:2007-9-29 13:30:06</p>
 * @author LiZhenWei
 * @version 4.0
 */

public class SearchPersonByCondTrans extends IBusiness{
	...
	public void execute() throws GeneralException {
		...
		//	String nbase=(String)this.getFormHM().get("nbase");
			...
			/* 薪资发放-发送邮件-切换状态报错(安全问题) xiaoyun 2014-10-30 start */
			...
			/* 薪资发放-发送邮件-切换状态报错(安全问题) xiaoyun 2014-10-30 end */
			...
			//System.out.println(sql_arr[0]+" "+sql_arr[1]);
