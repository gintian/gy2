...
public class SelectMusterSetTrans extends IBusiness {
	...
	public void getUnitfile(LeadarParamXML leadarParamXML)
	{
		String unit_field=leadarParamXML.getTextValue(LeadarParamXML.UNIT_ZJ);			
		LeaderParam leaderParam=new LeaderParam(this.getFrameconn(),this.userView);	
		ArrayList list=leaderParam.getUnitList(unit_field);
		this.getFormHM().put("itemlist",list);
	}	
