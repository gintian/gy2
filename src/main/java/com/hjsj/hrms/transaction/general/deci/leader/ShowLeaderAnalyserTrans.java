...
public class ShowLeaderAnalyserTrans extends IBusiness {
	String statid ="";
	...
	public void execute() throws GeneralException {
	    ...
	    int h = Integer.parseInt((String)this.getFormHM().get("h"));
		...
		this.getFormHM().put("txtfile",com.hrms.frame.codec.SafeCode.encode(txtfile.toString()));
