...
public class ShowPrivateInfoTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
    	...
    	String fdg=(String)hm.get("a0100");
		...
		if(!("infoself".equalsIgnoreCase(flag) && userView.getStatus()!=4))
		{
			...
			try
			{
		       ...
		       this.getFormHM().put("factorlist",infoFieldViewList);            //压回页面
		       this.getFormHM().put("logiclist",infoSetList);
		       this.getFormHM().put("history",filename);	      
	       }	
		}
		else
		{
