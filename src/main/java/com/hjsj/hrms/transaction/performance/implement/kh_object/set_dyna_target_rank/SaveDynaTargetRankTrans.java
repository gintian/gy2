...
/**
 *<p>Title:SaveDynaTargetRankTrans.java</p> 
 *<p>Description:</p> 
 *<p>Company:hjsj</p> 
 *<p>Create time:Jul 7, 2008:1:48:56 PM</p> 
 *@author JinChunhai
 *@version 1.0
 */

public class SaveDynaTargetRankTrans extends IBusiness 
{
...
//						+" (select item_id from per_template_item where UPPER(template_id)=(select template_id from per_plan where plan_id="+planid+")) and ptp.point_id=pp.point_id and pp.point_id='"+bean.get("point_id")+"' and ptp.rank ='"+bean.get("rank")+"'");
