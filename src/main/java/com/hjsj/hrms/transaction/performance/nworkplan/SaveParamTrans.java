...
public class SaveParamTrans extends IBusiness 
{
	...
	public void execute() throws GeneralException 
	{
		...
		try
		{
			...
			String sp_flag14 = (String)this.getFormHM().get("sp_flag14");
			String plan_fields4 = (String)this.getFormHM().get("plan_fields4");
			String summarize_fields4 = (String)this.getFormHM().get("summarize_fields4");
			...
			String sp_flag24 = (String)this.getFormHM().get("sp_flag24");
			...
			String sp_flag13 = (String)this.getFormHM().get("sp_flag13");
			String plan_fields3 = (String)this.getFormHM().get("plan_fields3");
			String summarize_fields3 = (String)this.getFormHM().get("summarize_fields3");
			...
			String sp_flag23 = (String)this.getFormHM().get("sp_flag23");
			...
			String sp_flag12 = (String)this.getFormHM().get("sp_flag12");
			String plan_fields2 = (String)this.getFormHM().get("plan_fields2");
			String summarize_fields2 = (String)this.getFormHM().get("summarize_fields2");
			...
			String sp_flag22 = (String)this.getFormHM().get("sp_flag22");
			...
			String sp_flag11 = (String)this.getFormHM().get("sp_flag11");
			String plan_fields1 = (String)this.getFormHM().get("plan_fields1");
			String summarize_fields1 = (String)this.getFormHM().get("summarize_fields1");
			...
			String sp_flag21 = (String)this.getFormHM().get("sp_flag21");
			...
			String sp_flag0 = (String)this.getFormHM().get("sp_flag0");
			String plan_fields0 = (String)this.getFormHM().get("plan_fields0");
			String summarize_fields0 = (String)this.getFormHM().get("summarize_fields0");
...
//			String time = (String)this.getFormHM().get("time");
	        ...
	        for (int i = 0; i <= 4; i++)
	    	{
		        ...
		        if(i==0){
		        	Rplan.setAttribute("plan_fields", plan_fields0);
		        	Rplan.setAttribute("summarize_fields", summarize_fields0);
		        }
		        if(i==1){
		        	Rplan.setAttribute("plan_fields", plan_fields1);
		        	Rplan.setAttribute("summarize_fields", summarize_fields1);
		        }
		        if(i==2){
		        	Rplan.setAttribute("plan_fields", plan_fields2);
		        	Rplan.setAttribute("summarize_fields", summarize_fields2);
		        }
		        if(i==3){
		        	Rplan.setAttribute("plan_fields", plan_fields3);
		        	Rplan.setAttribute("summarize_fields", summarize_fields3);
		        }
		        if(i==4){
		        	Rplan.setAttribute("plan_fields", plan_fields4);
		        	Rplan.setAttribute("summarize_fields", summarize_fields4);
		        }
		        if(i==0)
		        {
			        ...
			        temp.setAttribute("sp_flag", falseToZero(sp_flag0));
		        ...
		        }else if(i==1)
		        {
				    for (int j = 1; j <= 2; j++)
				    {
					    ...
					    if(j==1)
					    {
					    	...
					    	temp.setAttribute("sp_flag", falseToZero(sp_flag11));
					    ...
					    }else
					    {
					        ...
					        temp.setAttribute("sp_flag", falseToZero(sp_flag21));
		        ...
		        }else if(i==2)
		        {
				    for (int j = 1; j <= 2; j++)
				    {
					    ...
					    if(j==1)
					    {
						    ...
						    temp.setAttribute("sp_flag", falseToZero(sp_flag12));
					    ...
					    }else
					    {
					        ...
					        temp.setAttribute("sp_flag", falseToZero(sp_flag22));
		        ...
		        }else if(i==3)
		        {
				    for (int j = 1; j <= 2; j++)
				    {
					    ...
					    if(j==1)
					    {
						    ...
						    temp.setAttribute("sp_flag", falseToZero(sp_flag13));
					    ...
					    }else
					    {
					        ...
					        temp.setAttribute("sp_flag", falseToZero(sp_flag23));
		        ...
		        }else if(i==4)
		        {
				    for (int j = 1; j <= 2; j++)
				    {
					    ...
					    if(j==1)
					    {
						    ...
						    temp.setAttribute("sp_flag", falseToZero(sp_flag14));
					    ...
					    }else
					    {
					        ...
					        temp.setAttribute("sp_flag", falseToZero(sp_flag24));
