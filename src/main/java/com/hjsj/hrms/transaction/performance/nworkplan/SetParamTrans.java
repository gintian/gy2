...
public class SetParamTrans extends IBusiness 
{
	...
	public void execute() throws GeneralException 
	{
		...
		try
		{
			...
			// 年报 工作计划参数
			String valid14 = "True";
			String sp_flag14 = "True";
			String plan_fields4 = "";
			String summarize_fields4 = "";
			String prior_end14 = "";
			...
			// 季报 工作计划参数
			String valid13 = "True";
			String sp_flag13 = "True";
			String plan_fields3 = "";
			String summarize_fields3 = "";
			String prior_end13 = "";
			...
			// 月报 工作计划参数
			String valid12 = "True";
			String sp_flag12 = "True";
			String plan_fields2 = "";
			String summarize_fields2 = "";
			String prior_end12 = "";
			...
			// 周报 工作计划参数
			String valid11 = "True";
			String sp_flag11 = "True";
			String plan_fields1 = "";
			String summarize_fields1 = "";
			String prior_end11 = "";
			...
			// 日报 工作计划参数
			String valid0 = "True";
			String sp_flag0 = "True";
			String plan_fields0= "";
			String summarize_fields0= "";
		    		...
		    		if (ele != null)
		    		{
	    				...
	    				{   					
	    		    	    ...
	    		    	    {	    							    						
	    						...
	    						if("4".equalsIgnoreCase(cycle))
    		    	    		{
    		    	    			plan_fields4 = isNull(wele.getAttributeValue("plan_fields"));
    		    	    			summarize_fields4 = isNull(wele.getAttributeValue("summarize_fields"));
    		    	    		}
    		    	    		if("3".equalsIgnoreCase(cycle))
    		    	    		{
    		    	    			plan_fields3 = isNull(wele.getAttributeValue("plan_fields"));
    		    	    			summarize_fields3 = isNull(wele.getAttributeValue("summarize_fields"));
    		    	    		}
    		    	    		if("2".equalsIgnoreCase(cycle))
    		    	    		{
    		    	    			plan_fields2 = isNull(wele.getAttributeValue("plan_fields"));
    		    	    			summarize_fields2 = isNull(wele.getAttributeValue("summarize_fields"));
    		    	    		}
    		    	    		if("1".equalsIgnoreCase(cycle))
    		    	    		{
    		    	    			plan_fields1 = isNull(wele.getAttributeValue("plan_fields"));
    		    	    			summarize_fields1 = isNull(wele.getAttributeValue("summarize_fields"));
    		    	    		}
    		    	    		if("0".equalsIgnoreCase(cycle))
    		    	    		{
    		    	    			plan_fields0 = isNull(wele.getAttributeValue("plan_fields"));
    		    	    			summarize_fields0 = isNull(wele.getAttributeValue("summarize_fields"));
    		    	    		}
	    		    	    	/*
	    		    	    	...
	    		    	    	{    	    		    
	    		    	    		...
	    		    	    		{	 	    		    	    			
		    		    	    		...
		    		    	    		if("4".equalsIgnoreCase(cycle) && "1".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag14 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("4".equalsIgnoreCase(cycle) && "2".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag24 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("3".equalsIgnoreCase(cycle) && "1".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag13 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("3".equalsIgnoreCase(cycle) && "2".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag23 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("2".equalsIgnoreCase(cycle) && "1".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag12 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("2".equalsIgnoreCase(cycle) && "2".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag22 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("1".equalsIgnoreCase(cycle) && "1".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag11 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("1".equalsIgnoreCase(cycle) && "2".equalsIgnoreCase(type))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag21 = isNull(temp.getAttributeValue("sp_flag"));
		    		    	    		...
		    		    	    		else if("0".equalsIgnoreCase(cycle))
		    		    	    		{
		    		    	    			...
		    		    	    			sp_flag0 = isNull(temp.getAttributeValue("sp_flag"));
		...
		//	System.out.println("======================"+this.userView.getPrivDbList());
			...
			this.getFormHM().put("sp_flag14",sp_flag14);
			this.getFormHM().put("plan_fields4",plan_fields4);
			this.getFormHM().put("summarize_fields4",summarize_fields4);
			...
			this.getFormHM().put("sp_flag24",sp_flag24);
			...
			this.getFormHM().put("sp_flag13",sp_flag13);
			this.getFormHM().put("plan_fields3",plan_fields3);
			this.getFormHM().put("summarize_fields3",summarize_fields3);
			...
			this.getFormHM().put("sp_flag23",sp_flag23);
			...
			this.getFormHM().put("sp_flag12",sp_flag12);
			this.getFormHM().put("plan_fields2",plan_fields2);
			this.getFormHM().put("summarize_fields2",summarize_fields2);
			...
			this.getFormHM().put("sp_flag22",sp_flag22);
			...
			this.getFormHM().put("sp_flag11",sp_flag11);
			this.getFormHM().put("plan_fields1",plan_fields1);
			this.getFormHM().put("summarize_fields1",summarize_fields1);
			...
			this.getFormHM().put("sp_flag21",sp_flag21);
			...
			this.getFormHM().put("sp_flag0",sp_flag0);
			this.getFormHM().put("plan_fields0",plan_fields0);
			this.getFormHM().put("summarize_fields0",summarize_fields0);
