 ...
 * 
* 
* 类名称：DataApproveTrans   
* 类描述：   
* 创建人：zhaoxg   
* 创建时间：Aug 21, 2013 1:11:27 PM   
* 修改人：zhaoxg   
* 修改时间：Aug 21, 2013 1:11:27 PM   
* 修改备注：   批准
* @version    
*
 */
public class DataApproveTrans extends IBusiness {
	...
	public void execute() throws GeneralException {
		...
		{		
			...
			if(!isHaveItem){
				throw GeneralExceptionHandler.Handle(new Exception("当前用户没有该子集下的全部指标权限，不允许批准!"));
			}
...
//					strwhere+=" "+tempsql+"";
				databo.approve(dao, tablename, state_id, strwhere);
//			}
		}
		catch(Exception ex)
		{
