...
public class RedeployAppForm extends FrameForm {
	...
	private RecordVo ex_vo=new RecordVo("q25");
	private String id;
	...
	{
		if("/kq/app_check_in/redeploy_rest/app_redeploy".equals(arg0.getPath()) && arg1.getParameter("b_approve")!=null)
        {
