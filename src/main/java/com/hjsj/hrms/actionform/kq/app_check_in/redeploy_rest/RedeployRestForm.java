package com.hjsj.hrms.actionform.kq.app_check_in.redeploy_rest;
...
public class RedeployRestForm extends FrameForm {
    ...
    public void outPutFormHM()
	 ...
	 {
		 if("/kq/app_check_in/redeploy_rest/redeploy".equals(arg0.getPath()) && arg1.getParameter("b_search")!=null)
         {
       	   if(this.getPagination()!=null)
		 ...
		 if("/kq/app_check_in/redeploy_rest/redeploydata".equals(arg0.getPath()) && arg1.getParameter("b_search")!=null)
         {
       	   if(this.getPagination()!=null)
 	            this.getPagination().firstPage();       	  
         } 
		 if("/kq/kqself/redeploy_rest/redeploydata".equalsIgnoreCase(arg0.getPath())&&arg1.getParameter("b_approve")!=null)
		 {
				this.getFormHM().put("sp_flag", "02");
		 }	
		 if("/kq/app_check_in/redeploy_rest/redeploydata".equals(arg0.getPath()) && arg1.getParameter("b_choose")!=null)
         {
			 this.getFormHM().clear();   
			 this.setRadio("");
			 this.setResult("");
