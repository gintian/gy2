...
public class SelectFeastForm extends FrameForm{
	...
	{
	    /*if(arg0.getPath().equals("/kq/register/select/selectfiled")&&arg1.getParameter("b_query")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?
	    }
	    if(arg0.getPath().equals("/kq/register/select/sum/selectfiled")&&arg1.getParameter("b_query")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?
	    }*/
