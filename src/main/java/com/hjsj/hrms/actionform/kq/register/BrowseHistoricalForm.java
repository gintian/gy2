...
public class BrowseHistoricalForm extends FrameForm{
    ...
    public void outPutFormHM()
	  {
		  ...
		  this.setError_flag((String)this.getFormHM().get("error_flag"));
		   ...
		   this.setSearchfieldlist((ArrayList)this.getFormHM().get("searchfieldlist"));
...
//		     System.out.println(workcalendar);
	...
	{
		if("/kq/register/historical/dailybrowse".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
		...
		if("/kq/register/historical/dailyorgbrowse".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?	
	        this.setCode("");
		...
		if("/kq/register/historical/dailybrowsedata".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?	        
	    }
		if("/kq/register/historical/dailyorgbrowsedata".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?		        
	    }
		if("/kq/register/historical/sumbrowse".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?	 
	        this.setCode("");
		...
		if("/kq/register/historical/sumorgbrowse".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?	
	        this.setCode("");
		...
		if("/kq/register/historical/sumbrowsedata".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//?	 	        
	    }
		if("/kq/register/historical/sumorgbrowsedata".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	        	this.getPagination().firstPage();//?	        
	    }
		if("/kq/register/history/statfx/statfxdata".equals(arg0.getPath())&&arg1.getParameter("b_search")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//点击树出现的右边页面	        
	    }
		if("/kq/register/history/statfx/statfxname".equals(arg0.getPath())&&arg1.getParameter("b_seename")!=null)
	    {
	        if(this.getPagination()!=null)
	          this.getPagination().firstPage();//点击人数	        
	    }
		if("/kq/register/history/statfx/statfxuserinfo".equals(arg0.getPath())&&arg1.getParameter("b_userinfo")!=null)
	    {
	        if(this.getPagination()!=null)
