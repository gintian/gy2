...
/**
 * NworkplanForm.java
 * Description: 工作计划参数设置
 * Copyright (c) Department of Research and Development/Beijing/北京世纪软件有限公司.
 * All Rights Reserved.
 * @version 1.0  
 * Mar 1, 2013 9:38:53 AM Jianghe created
 */
public class NworkplanForm extends FrameForm
{
    ...
    private ArrayList planFieldsList = new ArrayList(); 
    private ArrayList summarizeFieldList = new ArrayList(); 
    ...
    private String sp_flag24 = "True";
    private String current_end24 = "";
    private String last_start24 = "";
    private String refer_id24 = "";
    private String print_id24 = "";
    private String plan_fields = "";
    private String summarize_fields = "";
    private String plan_fields4 = "";
    private String summarize_fields4 = "";
	// 季报 工作计划参数
    private String valid13 = "True";
    private String sp_flag13 = "True";
    ...
    private String plan_fields3 = "";
    private String summarize_fields3 = "";
	
	// 月报 工作计划参数
    private String valid12 = "True";
    private String sp_flag12 = "True";
    ...
    private String plan_fields2 = "";
    private String summarize_fields2 = "";
	
	// 周报 工作计划参数
    private String valid11 = "True";
    private String sp_flag11 = "True";
    ...
    private String plan_fields0 = "";
    private String summarize_fields0 = "";
    
    // 人员登记表
    private ArrayList personSheetList = new ArrayList();
    
    private String clientName="";
    private String typeflag="";//判断是年季月周日的指标 4,3,2,1,0
    ...
    { 
    	...
    	this.getFormHM().put("sp_flag14", this.getSp_flag14());
    	this.getFormHM().put("plan_fields", this.getPlan_fields());
    	this.getFormHM().put("summarize_fields", this.getSummarize_fields());
    	this.getFormHM().put("plan_fields4", this.getPlan_fields4());
    	this.getFormHM().put("summarize_fields4", this.getSummarize_fields4());
    	this.getFormHM().put("plan_fields3", this.getPlan_fields3());
    	this.getFormHM().put("summarize_fields3", this.getSummarize_fields3());
    	this.getFormHM().put("plan_fields2", this.getPlan_fields2());
    	this.getFormHM().put("summarize_fields2", this.getSummarize_fields2());
    	this.getFormHM().put("plan_fields1", this.getPlan_fields1());
    	this.getFormHM().put("summarize_fields1", this.getSummarize_fields1());
    	this.getFormHM().put("plan_fields0", this.getPlan_fields0());
    	this.getFormHM().put("summarize_fields0", this.getSummarize_fields0());
    	...
    	this.getFormHM().put("sp_flag24", this.getSp_flag24());
    	...
    	this.getFormHM().put("sp_flag13", this.getSp_flag13());
    	...
    	this.getFormHM().put("sp_flag23", this.getSp_flag23());
    	...
    	this.getFormHM().put("sp_flag12", this.getSp_flag12());
    	...
    	this.getFormHM().put("sp_flag22", this.getSp_flag22());
    	...
    	this.getFormHM().put("sp_flag11", this.getSp_flag11());
    	...
    	this.getFormHM().put("sp_flag21", this.getSp_flag21());
    	...
    	this.getFormHM().put("sp_flag0", this.getSp_flag0());
    ...
    public void outPutFormHM()
    {
    	...
    	this.setTypeflag((String)this.getFormHM().get("typeflag"));
    	this.setPlan_fields((String)this.getFormHM().get("plan_fields"));
    	this.setSummarize_fields((String)this.getFormHM().get("summarize_fields"));
    	this.setPlan_fields4((String)this.getFormHM().get("plan_fields4"));
    	this.setSummarize_fields4((String)this.getFormHM().get("summarize_fields4"));
    	this.setPlan_fields3((String)this.getFormHM().get("plan_fields3"));
    	this.setSummarize_fields3((String)this.getFormHM().get("summarize_fields3"));
    	this.setPlan_fields2((String)this.getFormHM().get("plan_fields2"));
    	this.setSummarize_fields2((String)this.getFormHM().get("summarize_fields2"));
    	this.setPlan_fields1((String)this.getFormHM().get("plan_fields1"));
    	this.setSummarize_fields1((String)this.getFormHM().get("summarize_fields1"));
    	this.setPlan_fields0((String)this.getFormHM().get("plan_fields0"));
    	this.setSummarize_fields0((String)this.getFormHM().get("summarize_fields0"));
    	this.setValid14((String)this.getFormHM().get("valid14"));
    	this.setSp_flag14((String)this.getFormHM().get("sp_flag14"));
    	...
    	this.setSp_flag24((String)this.getFormHM().get("sp_flag24"));
    	...
    	this.setSp_flag13((String)this.getFormHM().get("sp_flag13"));
    	...
    	this.setSp_flag23((String)this.getFormHM().get("sp_flag23"));
    	...
    	this.setSp_flag12((String)this.getFormHM().get("sp_flag12"));
    	...
    	this.setSp_flag22((String)this.getFormHM().get("sp_flag22"));
    	...
    	this.setSp_flag11((String)this.getFormHM().get("sp_flag11"));
    	...
    	this.setSp_flag21((String)this.getFormHM().get("sp_flag21"));
    	...
    	this.setSp_flag0((String)this.getFormHM().get("sp_flag0"));
    	...
    	this.setPlanFieldsList((ArrayList)this.getFormHM().get("planFieldsList"));
    	this.setSummarizeFieldList((ArrayList)this.getFormHM().get("summarizeFieldList"));
    }
	...
	public String getSp_flag14() {
		return sp_flag14;
	}

	public void setSp_flag14(String sp_flag14) {
		this.sp_flag14 = sp_flag14;
	}

	public String getSp_flag24() {
		return sp_flag24;
	}

	public void setSp_flag24(String sp_flag24) {
		this.sp_flag24 = sp_flag24;
	}

	public String getSp_flag13() {
		return sp_flag13;
	}

	public void setSp_flag13(String sp_flag13) {
		this.sp_flag13 = sp_flag13;
	}

	public String getSp_flag23() {
		return sp_flag23;
	}

	public void setSp_flag23(String sp_flag23) {
		this.sp_flag23 = sp_flag23;
	}

	public String getSp_flag12() {
		return sp_flag12;
	}

	public void setSp_flag12(String sp_flag12) {
		this.sp_flag12 = sp_flag12;
	}

	public String getSp_flag22() {
		return sp_flag22;
	}

	public void setSp_flag22(String sp_flag22) {
		this.sp_flag22 = sp_flag22;
	}

	public String getSp_flag11() {
		return sp_flag11;
	}

	public void setSp_flag11(String sp_flag11) {
		this.sp_flag11 = sp_flag11;
	}

	public String getSp_flag21() {
		return sp_flag21;
	}

	public void setSp_flag21(String sp_flag21) {
		this.sp_flag21 = sp_flag21;
	}

	public String getSp_flag0() {
		return sp_flag0;
	}

	public void setSp_flag0(String sp_flag0) {
		this.sp_flag0 = sp_flag0;
	}
	...
	public String getPlan_fields4() {
		return plan_fields4;
	}

	public void setPlan_fields4(String plan_fields4) {
		this.plan_fields4 = plan_fields4;
	}

	public String getSummarize_fields4() {
		return summarize_fields4;
	}

	public void setSummarize_fields4(String summarize_fields4) {
		this.summarize_fields4 = summarize_fields4;
	}

	public String getPlan_fields3() {
		return plan_fields3;
	}

	public void setPlan_fields3(String plan_fields3) {
		this.plan_fields3 = plan_fields3;
	}

	public String getSummarize_fields3() {
		return summarize_fields3;
	}

	public void setSummarize_fields3(String summarize_fields3) {
		this.summarize_fields3 = summarize_fields3;
	}

	public String getPlan_fields2() {
		return plan_fields2;
	}

	public void setPlan_fields2(String plan_fields2) {
		this.plan_fields2 = plan_fields2;
	}

	public String getSummarize_fields2() {
		return summarize_fields2;
	}

	public void setSummarize_fields2(String summarize_fields2) {
		this.summarize_fields2 = summarize_fields2;
	}

	public String getPlan_fields1() {
		return plan_fields1;
	}

	public void setPlan_fields1(String plan_fields1) {
		this.plan_fields1 = plan_fields1;
	}

	public String getSummarize_fields1() {
		return summarize_fields1;
	}

	public void setSummarize_fields1(String summarize_fields1) {
		this.summarize_fields1 = summarize_fields1;
	}

	public String getPlan_fields0() {
		return plan_fields0;
	}

	public void setPlan_fields0(String plan_fields0) {
		this.plan_fields0 = plan_fields0;
	}

	public String getSummarize_fields0() {
		return summarize_fields0;
	}

	public void setSummarize_fields0(String summarize_fields0) {
		this.summarize_fields0 = summarize_fields0;
	}

	public ArrayList getPlanFieldsList() {
		return planFieldsList;
	}

	public void setPlanFieldsList(ArrayList planFieldsList) {
		this.planFieldsList = planFieldsList;
	}

	public ArrayList getSummarizeFieldList() {
		return summarizeFieldList;
	}

	public void setSummarizeFieldList(ArrayList summarizeFieldList) {
		this.summarizeFieldList = summarizeFieldList;
	}
	...
	public String getPlan_fields() {
		return plan_fields;
	}

	public void setPlan_fields(String plan_fields) {
		this.plan_fields = plan_fields;
	}

	public String getSummarize_fields() {
		return summarize_fields;
	}

	public void setSummarize_fields(String summarize_fields) {
		this.summarize_fields = summarize_fields;
	}
