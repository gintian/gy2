...
public class DocumentParamForm extends FrameForm {
	/**记录集名称*/
    ...
    private ArrayList bz_privlist = new ArrayList();
    private String law_file_priv;
    ...
    public void outPutFormHM() {
		...
		this.setBz_privlist((ArrayList)this.getFormHM().get("bz_privlist"));
		this.setLaw_file_priv((String)this.getFormHM().get("law_file_priv"));
	}
	@Override
    public void inPutTransHM() {
		...
		this.getFormHM().put("bz_privlist", this.getBz_privlist());
		this.getFormHM().put("law_file_priv", this.getLaw_file_priv());
	}
	...
	public void setBz_privlist(ArrayList bz_privlist) {
		this.bz_privlist = bz_privlist;
	}
	public String getLaw_file_priv() {
		return law_file_priv;
	}
	public void setLaw_file_priv(String law_file_priv) {
		this.law_file_priv = law_file_priv;
	}
