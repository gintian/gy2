 ...
 * <p>Description:</p>
 * <p>Company:hjsj</p>
 * <p>create time:2005-6-16:15:10:24</p>
 * @author luangaojiong
 * @version 1.0
 * 
 */
public class TeacherForm extends FrameForm {
    ...
    private PaginationForm teacherForm=new PaginationForm();     
    ...
    public void outPutFormHM() {
        this.getTeacherForm().setList((ArrayList)this.getFormHM().get("teacherlist"));
    ...
    /**
     * @return Returns the teacherForm.
     */
    public PaginationForm getTeacherForm() {
        return teacherForm;
    }
    /**
     * @param teacherForm The teacherForm to set.
     */
    public void setTeacherForm(PaginationForm teacherForm) {
